...
SUBCOMMANDS = {
    "generate_resource_ids": {
        "desc": "Extract resource_ids from terraform state file",
        "help": "Extract resource_ids from terraform state file",
    }
}
