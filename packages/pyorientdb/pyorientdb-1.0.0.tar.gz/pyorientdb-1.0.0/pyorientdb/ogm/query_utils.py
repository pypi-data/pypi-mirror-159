import pyorientdb.ogm.property

from .element import GraphElement

import pyorientdb.ogm.what
...
class ArgConverter(object):
    ...
    def convert_to(conversion, arg, for_query):
        if conversion is ArgConverter.Label:
            return '{}'.format(pyorientdb.ogm.property.PropertyEncoder.encode_value(arg))
            ...
            if isinstance(arg, pyorientdb.ogm.property.Property):
                return arg.context_name()
            elif isinstance(arg, GraphElement):
                return arg.registry_name
            elif isinstance(arg, pyorientdb.ogm.what.What):
            ...
            if isinstance(arg, pyorientdb.ogm.property.Property):
                ...
                return pyorientdb.ogm.property.PropertyEncoder.encode_value(arg)
        elif conversion is ArgConverter.Boolean:
            if isinstance(arg, pyorientdb.ogm.what.What):
                return for_query.build_what(arg)
            else:
                return 'true' if arg else 'false'
        elif conversion is ArgConverter.Name:
            return pyorientdb.ogm.property.PropertyEncoder.encode_name(arg)
