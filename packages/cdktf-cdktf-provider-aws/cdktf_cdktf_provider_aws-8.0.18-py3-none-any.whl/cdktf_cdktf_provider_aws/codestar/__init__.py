...
class CodestarconnectionsHost(
    ...
    def __init__(
        ...
        *,
        ...
        id: typing.Optional[builtins.str] = None,
        timeouts: typing.Optional["CodestarconnectionsHostTimeouts"] = None,
...
class CodestarnotificationsNotificationRule(
    ...
    def put_target(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence["CodestarnotificationsNotificationRuleTarget"]],
    ) -> None:
        '''
        :param value: -
        '''
