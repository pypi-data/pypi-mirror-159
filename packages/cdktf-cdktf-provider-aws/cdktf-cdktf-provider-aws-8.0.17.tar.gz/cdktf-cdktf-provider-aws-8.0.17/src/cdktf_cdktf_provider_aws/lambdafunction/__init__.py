...
class LambdaEventSourceMapping(
    ...
    def put_source_access_configuration(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence["LambdaEventSourceMappingSourceAccessConfiguration"]],
    ) -> None:
        '''
        :param value: -
        '''
...
class LambdaEventSourceMappingFilterCriteriaOutputReference(
    ...
    def put_filter(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[LambdaEventSourceMappingFilterCriteriaFilter]],
    ) -> None:
        '''
        :param value: -
        '''
