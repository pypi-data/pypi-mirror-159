...
class AppautoscalingPolicyStepScalingPolicyConfigurationOutputReference(
    ...
    def put_step_adjustment(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence["AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment"]],
    ) -> None:
        '''
        :param value: -
        '''
...
class AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationCustomizedMetricSpecificationOutputReference(
    ...
    def put_dimensions(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationCustomizedMetricSpecificationDimensions]],
    ) -> None:
        '''
        :param value: -
        '''
