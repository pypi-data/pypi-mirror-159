...
class ElasticsearchDomain(
    ...
    def put_log_publishing_options(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence["ElasticsearchDomainLogPublishingOptions"]],
    ) -> None:
        '''
        :param value: -
        '''
...
class ElasticsearchDomainAutoTuneOptionsOutputReference(
    ...
    def put_maintenance_schedule(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[ElasticsearchDomainAutoTuneOptionsMaintenanceSchedule]],
    ) -> None:
        '''
        :param value: -
        '''
