...
class AmplifyApp(
    ...
    def put_custom_rule(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence["AmplifyAppCustomRule"]],
    ) -> None:
        '''
        :param value: -
        '''
...
class AmplifyDomainAssociation(
    ...
    def put_sub_domain(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence["AmplifyDomainAssociationSubDomain"]],
    ) -> None:
        '''
        :param value: -
        '''
