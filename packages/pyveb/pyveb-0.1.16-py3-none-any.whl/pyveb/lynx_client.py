...
class lynxClient():
    ...
    def query_fetch_single_value(self, query: str):
        """
    ...
    def stream_to_s3_parquet(self, query:str, batch_size:int, s3_bucket:str, s3_prefix:str, s3_filename:str):
        """
    ...
    def _stream_results(self, query, batch_size):
        cursor = self.conn.cursor()
    ...
    def _df_to_parquet_s3(self, df, s3_bucket, s3_prefix, file_name):
