...
class Network3Medusa():
    ...
    def add_file_to_hedera(self, parsed_json):
        ...
        resp = tran.setKeys("302a300506032b65700321008f9bbdbcc4f69f0ee6f7b8bd6154b30d429a4ae120c178c1646d97044aa660da").setContents(parsed_json).setMaxTransactionFee(Hbar(2)).execute(client)
