...
class HTTPStatus(IntEnum):
    ...
    PERSON_THRESH_TYPE_ERR = (450008, "PersonThresh 字段不符合规范", "PersonThresh 字段不符合规范，请参考接口文档说明")
    # 人脸检测 FaceDetect
    FACE_THRESH_FLOAT_TYPE_ERR = (450009, "FaceThresh 字段类型错误", "FaceThresh 字段应该是 float 类型")
    FACE_THRESH_TYPE_ERR = (450010, "FaceThresh 字段不符合规范", "FaceThresh 字段不符合规范，请参考接口文档说明")
    # 明火烟雾检测 FireDetect
    FIRE_THRESH_FLOAT_TYPE_ERR = (450011, "FireThresh 字段类型错误", "FireThresh 字段应该是 float 类型")
    FIRE_THRESH_TYPE_ERR = (450012, "FireThresh 字段不符合规范", "FireThresh 字段不符合规范，请参考接口文档说明")
    SMOKE_THRESH_FLOAT_TYPE_ERR = (450013, "SmokeThresh 字段类型错误", "SmokeThresh 字段应该是 float 类型")
    SMOKE_THRESH_TYPE_ERR = (450014, "SmokeThresh 字段不符合规范", "SmokeThresh 字段不符合规范，请参考接口文档说明")
    # 车辆检测
    CAR_THRESH_FLOAT_TYPE_ERR = (450015, "CarThresh 字段类型错误", "CarThresh 字段应该是 float 类型")
    CAR_THRESH_TYPE_ERR = (450016, "CarThresh 字段不符合规范", "CarThresh 字段不符合规范，请参考接口文档说明")
