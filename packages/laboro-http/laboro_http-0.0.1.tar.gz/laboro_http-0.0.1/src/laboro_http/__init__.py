...
class Http(Module):
  ...
  def request(self, url, method="GET", params=None, data=None, headers=None,
    ...
    Arguments:
      ...
      ``auth``: Tuple. Optional. A tuple composed of username and password to be used as Basic/Digest/Custom HTTP Authentication.
    ...
    """
    logging.info(f"Sending request to: {method} {url}")
