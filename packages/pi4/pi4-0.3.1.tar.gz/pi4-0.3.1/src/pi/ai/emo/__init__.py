...
face_classifier = cv2.CascadeClassifier(ROOT + '/haarcascade_frontalface_default.xml')
...
def detect_emotion(input_img):

    rect, face, image = face_detector_video(input_img)
