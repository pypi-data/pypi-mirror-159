...
curl -L https://github.com/PyO3/maturin/releases/download/v0.13.0/maturin-x86_64-unknown-linux-musl.tar.gz | tar -xz -C /usr/local/bin
...
echo "::endgroup::"
maturin build --release --sdist -o dist --target x86_64-unknown-linux-gnu