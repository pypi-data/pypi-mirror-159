...
# 实现任意纬度分类的函数
def score(df, method, s = None,g=None,gll_dict = None,plot = None,**kwargs):
    '''
    ...
    if len(g) == 1:
        ...
        for i in range(len(gll)):
            score_array,_ = score(df1_list[i], method,g = g_left, gll_dict = gll_dict,plot = None)
