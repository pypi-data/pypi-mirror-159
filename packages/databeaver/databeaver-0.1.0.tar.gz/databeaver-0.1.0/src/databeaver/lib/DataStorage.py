...
class DataStorage(Object):
    ...
    def get_schema(self, schema_name):
        ...
        """
        schema = Schema(schema_name, system=self)
        return schema

    def table_exists(self, schema=None, table_object: Table = None):
    ...
    def table_exists(self, schema=None, table_object: Table = None):
        ...
        :return:
        """
        return self.table_exists(schema=schema, table_name=table_object.name)
