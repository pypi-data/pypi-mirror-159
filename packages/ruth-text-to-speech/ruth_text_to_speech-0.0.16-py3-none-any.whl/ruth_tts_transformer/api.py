...
class TTS:
    def __init__(self):
        ...
        BUILTIN_LATENT_DIR = os.path.join(os.path.dirname(os.path.realpath(__file__)), "data")

        with open(os.path.join(BUILTIN_LATENT_DIR, 'latents.pkl'), 'rb') as f:
            self.conditioning_latent_reading = pickle.load(f)
