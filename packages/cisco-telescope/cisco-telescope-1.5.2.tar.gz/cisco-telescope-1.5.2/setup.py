...
['Flask>=2.1.2,<3.0.0',
 ...
 'opentelemetry-distro<1.0.0',
 'opentelemetry-exporter-otlp-proto-grpc>=1.0.0,<2.0.0',
 'opentelemetry-exporter-otlp-proto-http>=1.0.0,<2.0.0',
 'opentelemetry-exporter-otlp>=1.0.0,<2.0.0',
 'opentelemetry-instrumentation-aiohttp-client<1.0.0',
 'opentelemetry-instrumentation-fastapi<1.0.0',
 'opentelemetry-instrumentation-flask<1.0.0',
 'opentelemetry-instrumentation-grpc<1.0.0',
 'opentelemetry-instrumentation-kafka-python<1.0.0',
 'opentelemetry-instrumentation-pymongo<1.0.0',
 'opentelemetry-instrumentation-requests<1.0.0',
 'opentelemetry-sdk>=1.0.0,<2.0.0',
 'opentelemetry-util-http<1.0.0',
 'packaging>=21.3,<22.0',
