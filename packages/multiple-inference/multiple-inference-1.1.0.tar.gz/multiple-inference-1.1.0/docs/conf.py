...
import os
import sys
sys.path.insert(0, os.path.abspath('../src')) # necessary to run `make doctest` in `docs` folder instead of root
...
htmlhelp_basename = 'conditional_inferencedoc'
