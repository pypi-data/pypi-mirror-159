...
class PutSessionMetricCollector(OutboundService):
    ...
    request_serialiser_map = {
        16: "session-metric-collector",
        22: "session-metric-collector",
    }
    response_serialiser_map = {16: "error-report-list", 22: "error-report-list"}
...
class ListSessionMetricCollectors(OutboundService):
    ...
    request_serialiser_map = {16: "void", 22: "void"}
    response_serialiser_map = {
        16: "session-metric-collectors",
        22: "session-metric-collectors",
    }
...
class PutTopicMetricCollector(OutboundService):
    ...
    request_serialiser_map = {
        16: "topic-metric-collector",
        22: "topic-metric-collector",
    }
    response_serialiser_map = {16: "void", 22: "void"}
...
class ListTopicMetricCollectors(OutboundService):
    ...
    request_serialiser_map = {16: "void", 22: "void"}
    response_serialiser_map = {
        16: "topic-metric-collectors",
        22: "topic-metric-collectors",
    }
    request_serialiser = get_serialiser("void")
