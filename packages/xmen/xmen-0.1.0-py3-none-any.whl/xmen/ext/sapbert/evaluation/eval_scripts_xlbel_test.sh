...
DATA_DIR="./xmen/xlbel_v0.0/de_1k_test_query.txt"
DICT_PATH="./xmen/umls_onto_all_lang_cased_wikimed_only_399931.txt" # you need to download this from dropbox, see readme
