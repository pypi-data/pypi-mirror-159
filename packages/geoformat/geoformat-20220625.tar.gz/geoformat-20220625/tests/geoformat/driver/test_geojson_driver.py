...
json_object_to_feature_generator_parameters = {
    0: {
        # FeatureCollection
        "json_object": {"features": [{"geometry": {"coordinates": [1.643, -19.12], "type": "Point"}, "properties": {}, "type": "Feature"}, {"geometry": {"coordinates": [-80.23, -22.53], "type": "Point"}, "properties": {}, "type": "Feature"}], "type": "FeatureCollection"},
        "return_value": ({'geometry': {'coordinates': [1.643, -19.12], 'type': 'Point'}}, {'geometry': {'coordinates': [-80.23, -22.53], 'type': 'Point'}})
    },
    1: {
        # Feature geometry only
        "json_object": {"geometry": {"coordinates": [-3.68, 40.4], "type": "Point"}, "properties": {}, "type": "Feature"},
        "return_value": ({"geometry": {"coordinates": [-3.68, 40.4], "type": "Point"}},)
    },
    2: {
        # Feature attributes only
        "json_object": {"properties": {"country": "Spain"}, "type": "Feature"},
        "return_value": ({"attributes": {"country": "Spain"}},)
    },
    3: {
        # Feature geometry and attributes only
        "json_object": {"geometry": {"coordinates": [-3.68, 40.4], "type": "Point"}, "properties": {"country": "Spain"}, "type": "Feature"},
        "return_value": ({"geometry": {"coordinates": [-3.68, 40.4], "type": "Point"}, "attributes": {"country": "Spain"}},)
    },
    4: {
        # Feature geometry and attributes + id tag
        "json_object": {"geometry": {"coordinates": [-3.68, 40.4], "type": "Point"}, "id": 27, "properties": {"country": "Spain"}, "type": "Feature"},
        "return_value": ({"geometry": {"coordinates": [-3.68, 40.4], "type": "Point"}, "attributes": {"country": "Spain"}},)
    },
    5: {
        # geometry Point
        "json_object": {"coordinates": [-115.8, 37.2], "type": "Point"},
        "return_value": ({"geometry": {"coordinates": [-115.8, 37.2], "type": "Point"}},)
    },
    6: {
        # geometry LineString
        "json_object": {"coordinates": [[8.91, 44.407], [8.92, 44.407]], "type": "LineString"},
        "return_value": ({"geometry": {"coordinates": [[8.91, 44.407], [8.92, 44.407]], "type": "LineString"}},)
    },
    7: {
        # geometry Polygon
        "json_object": {"coordinates": [[[2.3, 57.32], [23.19, -20.2], [-120.4, 19.1]]], "type": "Polygon"},
        "return_value": ({"geometry": {"coordinates": [[[2.3, 57.32], [23.19, -20.2], [-120.4, 19.1]]], "type": "Polygon"}},)
    },
    8: {
        # geometry Polygon with holes
        "json_object": {"coordinates": [[[2.3, 57.32], [23.19, -20.2], [-120.4, 19.1]], [[-5.2, 23.5], [15.2, -10.8], [-20.5, 1.5], [-5.2, 23.5]]], "type": "Polygon"},
        "return_value": ({"geometry": {"coordinates": [[[2.3, 57.32], [23.19, -20.2], [-120.4, 19.1]], [[-5.2, 23.5], [15.2, -10.8], [-20.5, 1.5], [-5.2, 23.5]]], "type": "Polygon"}},),
    },
    9: {
        # geometry MultiPoint
        "json_object": {"coordinates": [[-155.5, 19.6], [-156.2, 20.7], [-157.9, 21.4]], "type": "MultiPoint"},
        "return_value":  ({"geometry": {"coordinates": [[-155.5, 19.6], [-156.2, 20.7], [-157.9, 21.4]], "type": "MultiPoint"}},),
    },
    10: {
        # geometry MultiLineString
        "json_object": {"coordinates": [[[3.7, 9.2], [-130.9, 1.52]], [[23.1, -34.2], [-1.3, -4.6], [3.4, 77.9]]], "type": "MultiLineString"},
        "return_value":  ({"geometry": {"coordinates": [[[3.7, 9.2], [-130.9, 1.52]], [[23.1, -34.2], [-1.3, -4.6], [3.4, 77.9]]], "type": "MultiLineString"}},),
    },
    11: {
        # geometry MultiPolygon
        "json_object": {"coordinates": [[[[3.7, 9.2], [-130.9, 1.5], [35.1, 72.23]]], [[[23.1, -34.2], [-1.3, -4.6], [3.4, 77.9]]]], "type": "MultiPolygon"},
        "return_value": ({"geometry": {"coordinates": [[[[3.7, 9.2], [-130.9, 1.5], [35.1, 72.23]]], [[[23.1, -34.2], [-1.3, -4.6], [3.4, 77.9]]]], "type": "MultiPolygon"}},),
    },
    12: {
        # geometry GeometryCollection
        "json_object": {"geometries": [{"coordinates": [23.53, -63.1], "type": "Point"}, {"coordinates": [[-152.6, 51.2], [5.2, 10.6]], "type": "LineString"}], "type": "GeometryCollection"},
        "return_value": ({"geometry": {"geometries": [{"coordinates": [23.53, -63.1], "type": "Point"}, {"coordinates": [[-152.6, 51.2], [5.2, 10.6]], "type": "LineString"}], "type": "GeometryCollection"}},)
    }
}

feature_attributes_to_properties_parameters = {
    0: {
        "attributes": {},
        "recast_field_mapping": None,
        "return_value": {}
    },
    1: {
        "attributes": feature_attributes_only.get('attributes'),
        "recast_field_mapping": None,
        "return_value": {'field_integer': 586, 'field_integer_list': [5879, 8557], 'field_real': 8789.97568, 'field_real_list': [89798.3654, 8757.97568], 'field_string': 'salut', 'field_string_list': ['bonjour', 'monsieur'], 'field_none': None, 'field_date': datetime.date(2020, 3, 31), 'field_time': datetime.time(11, 22, 10, 999), 'field_datetime': datetime.datetime(2020, 3, 31, 11, 22, 10, 999), 'field_binary': b'\x00\x00\x00\x00\x04\x00\x00\x00\x02\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01?\xf0\x00\x00\x00\x00\x00\x00?\xf0\x00\x00\x00\x00\x00\x00', 'field_boolean': True},
    },
    2: {
        "attributes": feature_dpt_data_only_a.get('attributes'),
        "recast_field_mapping": None,
        "return_value": {'CODE_DEPT': '53', 'NOM_DEPT': 'MAYENNE'},
    },
    3: {
        "attributes": feature_dpt_geometry_only_a.get('attributes'),
        "recast_field_mapping": None,
        "return_value": {},
    },
    4: {
        "attributes": feature_dpt_data_and_geometry_a.get('attributes'),
        "recast_field_mapping": None,
        "return_value": {'CODE_DEPT': '53', 'NOM_DEPT': 'MAYENNE'}
    },
    5: {
        ...
        "return_value": {'field_integer': 586, 'field_integer_list': [5879, 8557], 'field_real': 8789.97568,
                         'field_real_list': [89798.3654, 8757.97568], 'field_string': 'salut',
                         'field_string_list': ['bonjour', 'monsieur'], 'field_none': None,
    ...
    6: {
        ...
        "return_value": {'field_integer': 586, 'field_integer_list': [5879, 8557], 'field_real': 8789.97568,
                         'field_real_list': [89798.3654, 8757.97568], 'field_string': 'salut',
                         'field_string_list': ['bonjour', 'monsieur'], 'field_none': None,
                         'field_date': str(datetime.date(2020, 3, 31)),
                         'field_time': str(datetime.time(11, 22, 10, 999)),
                         'field_datetime': str(datetime.datetime(2020, 3, 31, 11, 22, 10, 999)),
                         'field_binary': b'\x00\x00\x00\x00\x04\x00\x00\x00\x02\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01?\xf0\x00\x00\x00\x00\x00\x00?\xf0\x00\x00\x00\x00\x00\x00'.hex(),
                         'field_boolean': True},
    },
}

geoformat_feature_to_geojson_feature_parameters = {
    0: {
...
def test_all():
    # geolayer_to_geojson
    print(test_function(geolayer_to_geojson, geolayer_to_geojson_parameters))

    # load_json_data
    print(test_function(load_json_data, load_json_data_parameters))

    # from_geojson_get_features_list
    print(
        test_function(
            from_geojson_get_features_list, from_geojson_get_features_list_parameters
        )
    )

    # geojson_to_geolayer_parameters
    print(test_function(geojson_to_geolayer, geojson_to_geolayer_parameters))

    # json_object_to_feature_generator
    print(test_function(json_object_to_feature_generator, json_object_to_feature_generator_parameters))

    # feature_attributes_to_properties
    print(test_function(feature_attributes_to_properties, feature_attributes_to_properties_parameters))

    # geoformat_feature_to_geojson_feature
    print(test_function(geoformat_feature_to_geojson_feature, geoformat_feature_to_geojson_feature_parameters))
