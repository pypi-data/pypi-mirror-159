...
get_field_name_list_ordered_by_i_field_parameters = {
    0: {
        ...
        "return_value": ['field_integer', 'field_integer_list', 'field_real', 'field_real_list', 'field_string',
                         'field_string_list', 'field_date', 'field_time', 'field_datetime', 'field_binary',
                         'field_boolean']
    },
    1: {
...
def test_all():
    ...
    # get_field_name_list_ordered_by_i_field
    print(test_function(get_field_name_list_ordered_by_i_field, get_field_name_list_ordered_by_i_field_parameters))
