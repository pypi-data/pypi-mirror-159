...
class JSONParseEvaluator:
    """
    Calculate n-TED(Normalized Tree Edit Distance) between parsed(predicted) json and gold json.
    n-TED, TED-based accuracy which measures how significant the parsed output is compared to empty json, is
    ...
    def cal_acc(self, pred, answer):
        ...
        3) Divide distance with GT tree size.(it is nTED)
