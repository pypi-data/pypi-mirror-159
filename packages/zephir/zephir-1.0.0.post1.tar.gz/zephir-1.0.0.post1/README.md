...
> *WARNING*: Current install builds may not properly compile the annotator. 
> Install ZephIR in **development mode** if you run into a "404 Error" with the annotator.
