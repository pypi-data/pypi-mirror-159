...
from runml_checks.utils.distribution.drift import calc_drift_and_plot, drift_condition
from runml_checks.vision import Batch, Context, TrainTestCheck
from runml_checks.vision.utils.label_prediction_properties import (DEFAULT_CLASSIFICATION_PREDICTION_PROPERTIES,
...
class TrainTestPredictionDrift(TrainTestCheck):
    ...
    def update(self, context: Context, batch: Batch, dataset_kind):
        ...
        if dataset_kind == DatasetKind.TRAIN:
            ...
            raise runml_checksNotSupportedError(f'Unsupported dataset kind {dataset_kind}')
