# ----------------------------------------------------------------------------
# Copyright (C) 2021 runml_checks (https://www.runml_checks.com)
#
...
from runml_checks import CheckResult, ConditionResult
...
from runml_checks.utils.strings import format_percent, split_camel_case
from runml_checks.vision import Batch, Context, SingleDatasetCheck, VisionData
from runml_checks.vision.metrics_utils import calculate_metrics, get_scorers_list, metric_results_to_df
from runml_checks.vision.utils.image_functions import ImageInfo, draw_bboxes, prepare_thumbnail
from runml_checks.vision.utils.transformations import AbstractTransformations
from runml_checks.vision.utils.validation import set_seeds
...
def augmentation_name(aug):
    if isinstance(aug, imgaug.augmenters.Augmenter):
        ...
        raise runml_checksValueError(f'Unsupported augmentation type {type(aug)}')
