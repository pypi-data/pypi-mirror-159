...
.. deprecated:: 0.7.0
        ...
        Use `runml_checks.vision.checks.train_test_validation` instead.
"""
import warnings
...
warnings.warn(
    'runml_checks.vision.checks.methodology is deprecated. Use runml_checks.vision.checks.train_test_validation instead.',
    DeprecationWarning
)
