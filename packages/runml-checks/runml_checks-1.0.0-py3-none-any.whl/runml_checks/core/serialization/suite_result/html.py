...
from runml_checks.core.serialization.common import (Html, aggregate_conditions, create_failures_dataframe,
...
class SuiteResultSerializer(HtmlSerializer['suite.SuiteResult']):
    ...
    def prepare_summary(self, output_id: t.Optional[str] = None, **kwargs) -> str:
        ...
        suite_creation_example_link = (
            'https://docs.runml_checks.com/en/stable/examples/guides/create_a_custom_suite.html'
