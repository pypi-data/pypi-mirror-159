...
from runml_checks.core.serialization.suite_result.html import SuiteResultSerializer as SuiteResultHtmlSerializer
from runml_checks.core.serialization.suite_result.ipython import SuiteResultSerializer as SuiteResultIPythonSerializer
from runml_checks.core.serialization.suite_result.json import SuiteResultSerializer as SuiteResultJsonSerializer
from runml_checks.core.serialization.suite_result.widget import SuiteResultSerializer as SuiteResultWidgetSerializer
from runml_checks.utils.strings import get_random_string, widget_to_html_string
...
class SuiteResult(DisplayableResult):
    ...
    def to_wandb(
        ...
        **kwargs
        ...
        from runml_checks.core.serialization.suite_result.wandb import SuiteResultSerializer as WandbSerializer
...
class BaseSuite:
    ...
    def __getitem__(self, index):
        ...
        if index not in self.checks:
            raise runml_checksValueError(f'No index {index} in suite')
