...
from runml_checks.utils.features import calculate_feature_importance
...
def model_error_contribution(train_dataset: pd.DataFrame,
    ...
    if error_model_score < min_error_model_score:
        raise runml_checksProcessError(f'Unable to train meaningful error model '
...
def error_model_display(error_fi: pd.Series,
    ...
    error_col_name = 'runml_checks model error'
