...
.. deprecated:: 0.7.0
        `runml_checks.tabular.checks.performance is deprecated and will be removed in runml_checks 0.8 version.
        Use `runml_checks.tabular.checks.model_evaluation` instead.
"""
import warnings
...
warnings.warn(
                'runml_checks.tabular.checks.performance is deprecated. Use runml_checks.tabular.checks.model_evaluation '
                'instead.',
                DeprecationWarning
            )
