...
from runml_checks.core.check_utils.feature_label_correlation_utils import get_pps_figure, pd_series_to_trace
...
pps_url = 'https://docs.runml_checks.com/en/stable/checks_gallery/tabular/' \
