...
from runml_checks.utils.distribution.preprocessing import ScaledNumerics
from runml_checks.utils.metrics import get_gain
from runml_checks.utils.simple_models import RandomModel
    ...
    def _create_simple_model(self, train_ds: Dataset, task_type: TaskType):
        ...
        if self.simple_model_type == 'random':
            ...
            if task_type == TaskType.REGRESSION:
                ...
                raise runml_checksValueError(f'Unknown task type - {task_type}')
