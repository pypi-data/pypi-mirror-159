...
from runml_checks.core.errors import runml_checksValueError, ModelValidationError
from runml_checks.tabular import Context, TrainTestCheck
from runml_checks.utils.model import get_model_of_pipeline
    ...
    def __init__(
        ...
        **kwargs
        ...
        if not isinstance(self.num_steps, int) or self.num_steps < 2:
            raise runml_checksValueError('num_steps must be an integer larger than 1')
