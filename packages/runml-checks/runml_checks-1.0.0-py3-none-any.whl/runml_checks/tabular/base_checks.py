...
from runml_checks.core.checks import (BaseCheck, DatasetKind, ModelOnlyBaseCheck, SingleDatasetBaseCheck,
                                    TrainTestBaseCheck)
from runml_checks.core.errors import runml_checksNotSupportedError
from runml_checks.tabular import deprecation_warnings  # pylint: disable=unused-import # noqa: F401
...
from runml_checks.tabular.model_base import ModelComparisonContext
...
class ModelOnlyCheck(ModelOnlyBaseCheck):
    ...
    def _get_unsupported_failure(cls, check, msg):
        return CheckFailure(check, runml_checksNotSupportedError(msg))
