...
def load_data(data_format: str = 'Dataset', as_train_test: bool = True) -> \
    ...
    Returns
    -------
    dataset : Union[runml_checks.Dataset, pd.DataFrame]
        the data object, corresponding to the data_format attribute.
    train_data, test_data : Tuple[Union[runml_checks.Dataset, pd.DataFrame],Union[runml_checks.Dataset, pd.DataFrame]
