...
from runml_checks.tabular import Suite
from runml_checks.tabular.checks import (BoostingOverfit, CalibrationScore, CategoryMismatchTrainTest, ConflictingLabels,
...
def single_dataset_integrity(**kwargs) -> Suite:
    ...
    .. deprecated:: 0.7.0
            `single_dataset_integrity` is deprecated and will be removed in runml_checks 0.8 version, it is replaced by
...
def data_integrity(columns: Union[Hashable, List[Hashable]] = None,
    ...
    List of Checks:
        .. list-table:: List of Checks
           ...
           * - :ref:`plot_tabular_is_single_value`
             - :class:`~runml_checks.tabular.checks.data_integrity.IsSingleValue`
           * - :ref:`plot_tabular_special_chars`
             - :class:`~runml_checks.tabular.checks.data_integrity.SpecialCharacters`
           * - :ref:`plot_tabular_mixed_nulls`
             - :class:`~runml_checks.tabular.checks.data_integrity.MixedNulls`
           * - :ref:`plot_tabular_mixed_data_types`
             - :class:`~runml_checks.tabular.checks.data_integrity.MixedDataTypes`
           * - :ref:`plot_tabular_string_mismatch`
             - :class:`~runml_checks.tabular.checks.data_integrity.StringMismatch`
           * - :ref:`plot_tabular_data_duplicates`
             - :class:`~runml_checks.tabular.checks.data_integrity.DataDuplicates`
           * - :ref:`plot_tabular_string_length_out_of_bounds`
             - :class:`~runml_checks.tabular.checks.data_integrity.StringLengthOutOfBounds`
           * - :ref:`plot_tabular_conflicting_labels`
             - :class:`~runml_checks.tabular.checks.data_integrity.ConflictingLabels`
           * - :ref:`plot_tabular_outlier_sample_detection`
             - :class:`~runml_checks.tabular.checks.data_integrity.OutlierSampleDetection`
           * - :ref:`plot_tabular_feature_label_correlation`
             - :class:`~runml_checks.tabular.checks.data_integrity.FeatureLabelCorrelation`
    ...
    **kwargs : dict
    ...
    Examples
    --------
    >>> from runml_checks.tabular.suites import data_integrity
...
def train_test_leakage(**kwargs) -> Suite:
    ...
    .. deprecated:: 0.7.0
        `train_test_leakage` is deprecated and will be removed in runml_checks 0.8 version, it is replaced by
...
def train_test_validation(columns: Union[Hashable, List[Hashable]] = None,
    ...
    List of Checks:
        .. list-table:: List of Checks
           ...
           * - :ref:`plot_tabular_datasets_size_comparison`
             - :class:`~runml_checks.tabular.checks.train_test_validation.DatasetsSizeComparison`
           * - :ref:`plot_tabular_new_label`
             - :class:`~runml_checks.tabular.checks.train_test_validation.NewLabelTrainTest`
           * - :ref:`plot_tabular_new_category`
             - :class:`~runml_checks.tabular.checks.train_test_validation.CategoryMismatchTrainTest`
           * - :ref:`plot_tabular_string_mismatch_comparison`
             - :class:`~runml_checks.tabular.checks.train_test_validation.StringMismatchComparison`
           * - :ref:`plot_tabular_date_train_test_validation_leakage_duplicates`
             - :class:`~runml_checks.tabular.checks.train_test_validation.DateTrainTestLeakageDuplicates`
           ...
           * - :ref:`plot_tabular_index_leakage`
             - :class:`~runml_checks.tabular.checks.train_test_validation.IndexTrainTestLeakage`
           * - :ref:`plot_tabular_train_test_samples_mix`
             - :class:`~runml_checks.tabular.checks.train_test_validation.TrainTestSamplesMix`
           * - :ref:`plot_tabular_feature_label_correlation_change`
             - :class:`~runml_checks.tabular.checks.train_test_validation.FeatureLabelCorrelationChange`
           * - :ref:`plot_tabular_train_test_feature_drift`
             - :class:`~runml_checks.tabular.checks.train_test_validation.TrainTestFeatureDrift`
           * - :ref:`plot_tabular_train_test_label_drift`
             - :class:`~runml_checks.tabular.checks.train_test_validation.TrainTestLabelDrift`
           * - :ref:`plot_tabular_whole_dataset_drift`
             - :class:`~runml_checks.tabular.checks.train_test_validation.WholeDatasetDrift`
    ...
    **kwargs : dict
    ...
    Examples
    --------
    >>> from runml_checks.tabular.suites import train_test_validation
...
def model_evaluation(alternative_scorers: Dict[str, Callable] = None,
    ...
    List of Checks:
        .. list-table:: List of Checks
           ...
           * - :ref:`plot_tabular_performance_report`
             - :class:`~runml_checks.tabular.checks.model_evaluation.PerformanceReport`
           * - :ref:`plot_tabular_roc_report`
             - :class:`~runml_checks.tabular.checks.model_evaluation.RocReport`
           ...
           * - :ref:`plot_tabular_segment_performance`
             - :class:`~runml_checks.tabular.checks.model_evaluation.SegmentPerformance`
           * - :ref:`plot_tabular_train_test_prediction_drift`
             - :class:`~runml_checks.tabular.checks.model_evaluation.TrainTestPredictionDrift`
           * - :ref:`plot_tabular_simple_model_comparison`
             - :class:`~runml_checks.tabular.checks.model_evaluation.SimpleModelComparison`
           * - :ref:`plot_tabular_model_error_analysis`
             - :class:`~runml_checks.tabular.checks.model_evaluation.ModelErrorAnalysis`
           * - :ref:`plot_tabular_calibration_score`
             - :class:`~runml_checks.tabular.checks.model_evaluation.CalibrationScore`
           * - :ref:`plot_tabular_regression_systematic_error`
             - :class:`~runml_checks.tabular.checks.model_evaluation.RegressionSystematicError`
           * - :ref:`plot_tabular_regression_error_distribution`
             - :class:`~runml_checks.tabular.checks.model_evaluation.RegressionErrorDistribution`
           * - :ref:`plot_tabular_unused_features`
             - :class:`~runml_checks.tabular.checks.model_evaluation.UnusedFeatures`
           * - :ref:`plot_tabular_boosting_overfit`
             - :class:`~runml_checks.tabular.checks.model_evaluation.BoostingOverfit`
           * - :ref:`plot_tabular_model_inference_time`
             - :class:`~runml_checks.tabular.checks.model_evaluation.ModelInferenceTime`
    ...
    **kwargs : dict
    ...
    Examples
    --------
    >>> from runml_checks.tabular.suites import model_evaluation
