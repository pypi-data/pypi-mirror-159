...
warnings.filterwarnings(
    action='once',
    message=r'runml_checks\.tabular\.checks\.performance is deprecated.*',
    category=DeprecationWarning,
    module=r'runml_checks.*'
)
...
warnings.filterwarnings(
    action='once',
    message=r'runml_checks.tabular.checks.overview is deprecated.*',
    category=DeprecationWarning,
    module=r'runml_checks.*'
)
...
warnings.filterwarnings(
    action='once',
    message=r'runml_checks.tabular.checks.methodology is deprecated.*',
    category=DeprecationWarning,
...
warnings.filterwarnings(
    action='once',
    message=r'runml_checks.tabular.checks.distribution is deprecated.*',
    category=DeprecationWarning,
    module=r'runml_checks.*'
)
