...
class BaseFactory:
    ...
    def __call__(self, data, key: str, **kwargs) -> Tuple[Any, str | None]:
...
class BaseField:
    ...
    def __call__(self, data, key, *args, **kwargs) -> Tuple[Any, str | None]:
...
class IterableField(Field):
    ...
    def __call__(self, *args, **kwargs):
        data_iterable, custom_name = super().__call__(*args, **kwargs)

        if data_iterable == Undefined:
            return Undefined, custom_name
...
class ObjectField(Field):
    ...
    def __call__(self, *args, **kwargs):
        ...
        return self._origin_factory(*args, **kwargs), custom_name
