...
class RecognizeDomainSpecificContent(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="RecognizeDomainSpecificContent_dfbe938a5f51_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        model=None,
        modelCol=None,
        outputCol="RecognizeDomainSpecificContent_dfbe938a5f51_output",
        ...
        self._setDefault(errorCol="RecognizeDomainSpecificContent_dfbe938a5f51_error")
        self._setDefault(outputCol="RecognizeDomainSpecificContent_dfbe938a5f51_output")
