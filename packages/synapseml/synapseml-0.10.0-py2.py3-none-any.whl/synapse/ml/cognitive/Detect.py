...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Detect_6c52e58b27fe_error",
        handler=None,
        outputCol="Detect_6c52e58b27fe_output",
        ...
        self._setDefault(errorCol="Detect_6c52e58b27fe_error")
        self._setDefault(outputCol="Detect_6c52e58b27fe_output")
