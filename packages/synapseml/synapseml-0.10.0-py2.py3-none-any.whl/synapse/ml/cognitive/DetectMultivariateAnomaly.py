...
class DetectMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    ...
    def __init__(
        ...
        endTime=None,
        endpoint=None,
        errorCol="DetectMultivariateAnomaly_6b72f7876761_error",
        initialPollingDelay=300,
        inputCols=None,
        intermediateSaveDir=None,
        maxPollingRetries=1000,
        modelId=None,
        outputCol="DetectMultivariateAnomaly_6b72f7876761_output",
        pollingDelay=300,
        sasToken=None,
        startTime=None,
        storageKey=None,
        ...
        self._setDefault(errorCol="DetectMultivariateAnomaly_6b72f7876761_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="DetectMultivariateAnomaly_6b72f7876761_output")
