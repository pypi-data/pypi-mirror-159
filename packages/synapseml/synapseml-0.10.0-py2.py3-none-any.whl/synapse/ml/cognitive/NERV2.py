...
class NERV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="NERV2_d28f20c51338_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="NERV2_d28f20c51338_output",
        ...
        self._setDefault(errorCol="NERV2_d28f20c51338_error")
        self._setDefault(outputCol="NERV2_d28f20c51338_output")
