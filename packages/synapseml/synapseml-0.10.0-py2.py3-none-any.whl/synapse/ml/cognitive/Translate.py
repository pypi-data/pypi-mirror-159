...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Translate_c337497e9040_error",
        fromLanguage=None,
        ...
        outputCol="Translate_c337497e9040_output",
        ...
        self._setDefault(errorCol="Translate_c337497e9040_error")
        self._setDefault(outputCol="Translate_c337497e9040_output")
