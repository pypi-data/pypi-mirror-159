...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GroupFaces_df9adff31ea8_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_df9adff31ea8_output",
        ...
        self._setDefault(errorCol="GroupFaces_df9adff31ea8_error")
        self._setDefault(outputCol="GroupFaces_df9adff31ea8_output")
