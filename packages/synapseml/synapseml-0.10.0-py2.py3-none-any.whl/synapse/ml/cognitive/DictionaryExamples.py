...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryExamples_2d3e5d9ef121_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_2d3e5d9ef121_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_2d3e5d9ef121_error")
        self._setDefault(outputCol="DictionaryExamples_2d3e5d9ef121_output")
