...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GenerateThumbnails_b3cdfd07730d_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_b3cdfd07730d_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_b3cdfd07730d_error")
        self._setDefault(outputCol="GenerateThumbnails_b3cdfd07730d_output")
