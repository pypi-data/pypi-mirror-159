...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_b077c36ce5fd_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_b077c36ce5fd_output",
        ...
        self._setDefault(errorCol="OCR_b077c36ce5fd_error")
        self._setDefault(outputCol="OCR_b077c36ce5fd_output")
