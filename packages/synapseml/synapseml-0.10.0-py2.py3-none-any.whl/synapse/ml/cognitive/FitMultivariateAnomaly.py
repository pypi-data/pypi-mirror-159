...
class FitMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    def __init__(
        ...
        endTime=None,
        endpoint=None,
        errorCol="FitMultivariateAnomaly_c67b7915e0a7_error",
        fillNAMethod=None,
        initialPollingDelay=300,
        inputCols=None,
        intermediateSaveDir=None,
        maxPollingRetries=1000,
        outputCol="FitMultivariateAnomaly_c67b7915e0a7_output",
        paddingValue=None,
        pollingDelay=300,
        sasToken=None,
        slidingWindow=None,
        ...
        self._setDefault(errorCol="FitMultivariateAnomaly_c67b7915e0a7_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="FitMultivariateAnomaly_c67b7915e0a7_output")
