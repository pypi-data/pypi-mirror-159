...
class _BingImageSearch(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        count=None,
        countCol=None,
        errorCol="BingImageSearch_217182b1c42f_error",
        freshness=None,
        freshnessCol=None,
        handler=None,
        height=None,
        ...
        offset=None,
        offsetCol=None,
        outputCol="BingImageSearch_217182b1c42f_output",
        q=None,
        qCol=None,
        size=None,
        sizeCol=None,
        ...
        self._setDefault(errorCol="BingImageSearch_217182b1c42f_error")
        self._setDefault(outputCol="BingImageSearch_217182b1c42f_output")
