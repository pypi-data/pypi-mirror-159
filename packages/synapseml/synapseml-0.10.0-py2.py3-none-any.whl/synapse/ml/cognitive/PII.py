...
class PII(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="PII_ae9b3a3cc040_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="PII_ae9b3a3cc040_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="PII_ae9b3a3cc040_error")
        self._setDefault(outputCol="PII_ae9b3a3cc040_output")
