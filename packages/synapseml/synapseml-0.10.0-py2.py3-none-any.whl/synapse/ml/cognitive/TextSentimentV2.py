...
class TextSentimentV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextSentimentV2_5a241590ee53_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="TextSentimentV2_5a241590ee53_output",
        ...
        self._setDefault(errorCol="TextSentimentV2_5a241590ee53_error")
        self._setDefault(outputCol="TextSentimentV2_5a241590ee53_output")
