...
class EntityDetectorV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="EntityDetectorV2_c9139cad4fe7_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="EntityDetectorV2_c9139cad4fe7_output",
        ...
        self._setDefault(errorCol="EntityDetectorV2_c9139cad4fe7_error")
        self._setDefault(outputCol="EntityDetectorV2_c9139cad4fe7_output")
