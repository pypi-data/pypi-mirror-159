...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectFace_efd49c1227fa_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_efd49c1227fa_output",
        ...
        self._setDefault(errorCol="DetectFace_efd49c1227fa_error")
        self._setDefault(outputCol="DetectFace_efd49c1227fa_output")
