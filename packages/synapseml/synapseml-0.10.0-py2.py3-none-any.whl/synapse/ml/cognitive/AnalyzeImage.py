...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_7c6304713cb2_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_7c6304713cb2_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_7c6304713cb2_error")
        self._setDefault(outputCol="AnalyzeImage_7c6304713cb2_output")
