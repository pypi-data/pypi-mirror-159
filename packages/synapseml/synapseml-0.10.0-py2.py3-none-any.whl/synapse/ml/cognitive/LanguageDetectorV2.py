...
class LanguageDetectorV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="LanguageDetectorV2_b9d24b67bd68_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="LanguageDetectorV2_b9d24b67bd68_output",
        ...
        self._setDefault(errorCol="LanguageDetectorV2_b9d24b67bd68_error")
        self._setDefault(outputCol="LanguageDetectorV2_b9d24b67bd68_output")
