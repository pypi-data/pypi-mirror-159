...
class DictionaryLookup(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryLookup_de12c032fac2_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryLookup_de12c032fac2_output",
        ...
        self._setDefault(errorCol="DictionaryLookup_de12c032fac2_error")
        self._setDefault(outputCol="DictionaryLookup_de12c032fac2_output")
