...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TagImage_4b57e3ffa797_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_4b57e3ffa797_output",
        ...
        self._setDefault(errorCol="TagImage_4b57e3ffa797_error")
        self._setDefault(outputCol="TagImage_4b57e3ffa797_output")
