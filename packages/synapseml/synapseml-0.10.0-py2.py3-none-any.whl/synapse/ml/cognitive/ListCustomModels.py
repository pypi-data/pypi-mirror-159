...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ListCustomModels_d4b1f27d9497_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_d4b1f27d9497_output",
        ...
        self._setDefault(errorCol="ListCustomModels_d4b1f27d9497_error")
        self._setDefault(outputCol="ListCustomModels_d4b1f27d9497_output")
