...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAPICompletion_e456696996ef_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAPICompletion_e456696996ef_output",
        ...
        self._setDefault(errorCol="OpenAPICompletion_e456696996ef_error")
        self._setDefault(outputCol="OpenAPICompletion_e456696996ef_output")
