...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="IdentifyFaces_c38fbcc45765_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_c38fbcc45765_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_c38fbcc45765_error")
        self._setDefault(outputCol="IdentifyFaces_c38fbcc45765_output")
