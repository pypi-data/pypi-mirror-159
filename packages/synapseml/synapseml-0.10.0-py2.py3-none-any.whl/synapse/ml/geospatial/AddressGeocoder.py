...
class AddressGeocoder(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AddressGeocoder_3a2ac666efc9_error",
        initialPollingDelay=300,
        maxPollingRetries=1000,
        outputCol="AddressGeocoder_3a2ac666efc9_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AddressGeocoder_3a2ac666efc9_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AddressGeocoder_3a2ac666efc9_output")
