...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_bf1272f621f8_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_bf1272f621f8_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_bf1272f621f8_error")
        self._setDefault(outputCol="CheckPointInPolygon_bf1272f621f8_output")
