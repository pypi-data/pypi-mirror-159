...
class Project(AbstractApiClass):
    ...
    def train_model(self, name: str = None, training_config: dict = None, feature_group_ids: list = None, refresh_schedule: str = None, custom_algorithms_only: bool = False, cpu_size: str = None, memory: int = None):
        """
        ...
        """
        return self.client.train_model(self.project_id, name, training_config, feature_group_ids, refresh_schedule, custom_algorithms_only, cpu_size, memory)
