...
class ApiClient(ReadOnlyClient):
    ...
    def train_model(self, project_id: str, name: str = None, training_config: dict = None, feature_group_ids: list = None, refresh_schedule: str = None, custom_algorithms_only: bool = False, cpu_size: str = None, memory: int = None) -> Model:
        ...
        return self._call_api('trainModel', 'POST', query_params={}, body={'projectId': project_id, 'name': name, 'trainingConfig': training_config, 'featureGroupIds': feature_group_ids, 'refreshSchedule': refresh_schedule, 'customAlgorithmsOnly': custom_algorithms_only, 'cpuSize': cpu_size, 'memory': memory}, parse_type=Model)
