        ...
        for key, val in self._reports.items():
            reports.append(
                (
                    ...
                    r'{:.3f}'.format(sum(val.success) / len(val.success) if len(val.success) > 0 else 0),
                    r'{:.3f}'.format(min(val.success) if len(val.success) > 0 else 0),
                    r'{:.3f}'.format(max(val.success) if len(val.success) > 0 else 0),
                )
            )
