...
class Stage_2:
    ...
    def __init__(self, Locp, grid_density, psi0_dic, allmin=None, allmax=None, To_plot=False,Nt = 500, dt = 0.01 ,multi_left = 2, multi_right = 2, is2d = False, Has_interface = True,limits_for_itself=None):
        '''**Initilization**:
        ...
        To_plot : bool, optional, defualt: False
        ...
        multi_left : int, optional, defualt: 2
        ...
        multi_right : int, optional, defualt: 2
        ...
        Has_interface : bool, optional, defualt: True
        ...
        limits_for_itself : list [float, float], optional, defualt: None
        ...
        self.update_converged_spacial_grid(update_converged_vec=True,update_interface=True)
        self.psi0 = None
    ...
    def elongate_interface_potential(self, from_iteslf = False,side_from_itself = 'both',interface_position = None, manual = False, z_in = None, v_in = None, multi_manual = 1,
        ...
        z_in : np.array, array_like, optional, default: None
                ...
                he should supplied also ``z_in`` and ``v_in`` as the spacial grid\coordinates vector and the local potential vector
                respectively.
        v_in : np.array, array_like, optional, default: None
                When the user decides on elongating manually its locpot vector's system,
                he should supplied also ``z_in`` and ``v_in`` as the spacial grid\coordinates vector and the local potential vector
                respectively.
        multi_manual : int, optional, defualt: 1
                When the user decides on elongating manually its locpot vector's system,
        ...
        locpot_vector : `numpy.ndarray`, (N, 2), optional, defualt: None
                The first column is the spacial grid/coordinates vector, and the second vector is local potential.
                It enables to elongate a locpot vector that is not related
                to the class instance attributes.
        To_update : bool, optional, defualt: True
        ...
        Elongated locpot_vec : numpy.ndarray, (N, 2)
                It consists of 2 columns. First column is the spacial coordinates, the second column is the local potential values.
        """
        if not self.is2d:
            if not from_iteslf:
                if not manual:
                    if self.Has_interface:
                        ...
                        if pos_to_insert is None:
                            elongated_locpot_vec = self.locp.elongate_locpot( manual=True, pos_to_insert = self.current_locpot_vec[:,0][-1], z_to_insert_manual = self.current_locpot_vec[:,0], v_to_insert_manual = self.current_locpot_vec[:,1])
                        else:
                            elongated_locpot_vec = self.locp.elongate_locpot(manual=True, pos_to_insert=
                            pos_to_insert, z_to_insert_manual=self.current_locpot_vec[:, 0],
                                                                             v_to_insert_manual=self.current_locpot_vec[:, 1])
                    if To_update:
                        self.elongated_locpot_vec = elongated_locpot_vec
                        self.elongated_locpot_vec = self.update_converged_spacial_grid(vecor_to_update=self.elongated_locpot_vec,update_converged_vec= False, update_interface=False)
                        if self.Has_interface:
                        ...
                        elongated_locpot_vec = self.update_converged_spacial_grid(
                    ...
                    if z_in is None or v_in is None:
                        ...
                        if To_update:
                            ...
                            self.elongated_locpot_vec = self.update_converged_spacial_grid(
                ...
                # Namely - does not have an interface, handling manually, elongating from itself:
                    ...
                    # Performimg the elongation on a region within the system, defined by limits for allocating the desired range to look for bulk like locpot.
                        ...
                        z = cons.A2m(z)
                        v = cons.eV2J(v)
                        elongated_locpot_vec= self.locp.elongate_locpot(manual=True, pos_to_insert=start_position,
                            multi_manual=multi_manual,z_to_insert_manual=z, v_to_insert_manual=v,locpot_vec=to_2_column_mat(self.current_locpot_vec))
    ...
    def update_converged_spacial_grid(self, vecor_to_update = None, update_converged_vec = True,update_interface = False):
        '''
        **Calculate spacial grid applying the converged grid density, for the interface system.**

        Parameters
        ----------
        vecor_to_update : `numpy.ndarray`, (N, 2), optional, defualt: None
                This is a 2 column matrix. First colmn is ``z``, the spacial coordinates vector and second is ``v``, the local potential vector.
                If we wish apply this method on not related vector, not an object attribute.
        update_converged_vec : bool, optional, defualt: True
                A flag indicates whether to update the instance attribute with the new converged
                vector we obatin through this method.
        update_interface : bool, optional, defualt: False
    ...
    def find_initial_position_to_center_psi0(self, init_side = 'Left', manual = False,manual_pos = None, index = False ):
        ...
        manual : int or float, optional, defualt: None
                ...
                Also it assume that it is given as a spacial position.
        index : bool, optional, defualt: False
                If it is ``True``, then the manual argument will be read as index instead of spacial position.
        Returns
        -------
    ...
    def initialize_psi0(self,init_side = 'Left',manual_center = False,manual_z0 = None, manual_z = None, manual_v = None,To_update = True, manual_psi_dic=None):
        ...
        manual_z, manual_v : np.array, array_like, optional, defualt: None
        ...
        manual_psi_dic : dict, optional, defualt: None
        ...
        locpot : numpy.ndarray, (N,2)
                The corresponding spacial coordinates vector
        '''
    ...
    def get_most_relevant_z_coordinate_vec(self):
        ...
        '''
        # This function aims to return the latest and most updated/relevant lopot vector (local potential and spacial
    ...
    def calculate_E0(self, psi = None, z_in = None, v_in = None):
        ...
        v_in : np.array, optional, defualt: None
        ...
        dz = np.diff(to_1D_vec(z))[0] # Getting dz (or the difference at each consecutive spacial grid points).
    ...
    def propagate_psi(self, psi = None, Nt = None,dt = None, z_in = None, v_in = None, path_to_save = None):
        ...
        psi : np.array, optional, defualt: None
                If not supplied, the default is the wave-function vector attribute of `Stage_2` instance.
        Nt : int, optional, defualt: None
                If not supplied, the default is the wave-function vector attribute of `Stage_2` instance.
                The number of time-steps.
        dt : float, optional, defualt: None
                If not supplied, the default is the wave-function vector attribute of `Stage_2` instance
        ...
        if self.To_plot :
            ...
            time_text = ax.text(0.8, 0.8, '', fontsize=15,
            ...
            if self.Has_interface:
                if not self.new_interface is None:
                    ...
                    ax.annotate('Interface position', xy=(self.original_interface + 0.5, 0.5),  xycoords='data',transform=ax.transAxes)
            ax2 = axes[1]

            # Plotting the local potential vs the spacial grid/coordinates below the plot of the wave-function propagation
            ...
            if path_to_save is None:
                ani.save('ani.gif', writer='pillow', fps=my_fps, dpi=100)
            else:
                ani.save("/".join(
                list(os.path.join(path_to_save, 'Propagation Animation.gif').split(
                    "\\"))), writer='pillow', fps=my_fps, dpi=100,savefig_kwargs={'transparent':True})
    ...
    def cumulative_probabilty_through_interface(self,psi = None, Nt = None,dt = None, z_in = None, v_in = None,  check_pos = None, path_to_save = None):
        ...
        v_in : np.array, optional, defualt: None
                If not supplied, the default is taken from `locpot_vec[:,1]` attribute of `Stage_2` instance.
                Vector of the local potential.
        check_pos : float, optional, defualt: None
    ...
    def converge_system_size(self ,psi = None, Nt = None,dt = None, z_in = None, v_in = None, To_update = True,
        ...
        converged_z : np.array
                The converged vector of the spacial grid. (spacial coordinates)
    ...
    def converge_time_step(self,psi = None, Nt = None,dt = None,time_sim = None, z_in = None, v_in = None, To_update = True, To_plot = False, iterations = 8, check_pos = None, tol = 0.005,path_to_save = None):
        ...
        dt : float, optional, defualt: None
                If not supplied, the default is the wave-function vector attribute of `Stage_2` instance
                The size of each time step the wave-function is propagated.
        time_sim : float, optional, defualt: None
        ...
        iterations : int, optional, defualt: 40
    ...
    # def transmision_coefficient(self,psi = None, Nt = None,dt = None, z_in = None, v_in = None,  check_pos = None) :
    #     '''
    #
    #     Parameters
    #     ----------
    ...
    #     -------
    #     np.float
    #         The value of the transmission coefficent at the interface or at the reference point.
    #         It also plots the probabilty curent through the propagation simulation
    #     '''
    #     # input verification
    #     #---------------------------------------------------------
    #     if Nt is None:
