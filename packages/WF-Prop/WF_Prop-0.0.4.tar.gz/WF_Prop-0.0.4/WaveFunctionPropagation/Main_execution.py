...
if __name__ == '__main__':
    ...
    layout = [[sg.Menu(menu_def, tearoff=False)],
              [sg.Text('Wave Function propagation Gui', size=(70, 1), justification='center', font=("Helvetica", 25), relief=sg.RELIEF_RIDGE)],
              ...
              [sg.Submit(), sg.Cancel()]]
    column = [[sg.Column(layout,scrollable=True,key='Column',size=(1000,3000))]]
    window = sg.Window('Propagate wave-function Menu ', column,resizable=True, size=(10000,5000))
