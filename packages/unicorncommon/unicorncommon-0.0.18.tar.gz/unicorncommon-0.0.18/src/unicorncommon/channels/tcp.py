...
class TCPServer:
    def __init__(self, *, server_endpoint, server_config, server_secret_key_filename, client_key_path):
        ...
        logger.info("    server_endpoint: {server_endpoint}")
        logger.info("    server_config: {server_config}")
        logger.info("    server_secret_key_filename: {server_secret_key_filename}")
        logger.info("    client_key_path: {client_key_path}")
...
class TCPClient:
    def __init__(self, *, server_endpoint, client_config, server_public_key_filename, client_secret_key_filename):
        ...
        logger.info("    server_public_key_filename: {server_public_key_filename}")
        logger.info("    client_secret_key_filename: {client_secret_key_filename}")
