...
class TCPServer:
    def __init__(self, * server_endpoint, server_config, server_secret_key_filename=None, client_key_path=None):
...
class TCPClient:
    def __init__(self, *, server_endpoint, client_config, server_public_key_filename, client_secret_key_filename):
        ...
        self.server_public_key_filename = client_config['server_public_key_filename']
        self.client_secret_key_filename = server_config['client_secret_key_filename']
