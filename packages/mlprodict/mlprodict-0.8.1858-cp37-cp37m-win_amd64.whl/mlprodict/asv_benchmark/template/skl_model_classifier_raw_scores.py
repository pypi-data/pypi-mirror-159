...
from sklearn.linear_model import LogisticRegression  # pylint: disable=C0411

from mlprodict.asv_benchmark import _CommonAsvSklBenchmarkClassifierRawScore  # pylint: disable=C0412
...
class TemplateBenchmarkClassifierRawScore(_CommonAsvSklBenchmarkClassifierRawScore):
    """
