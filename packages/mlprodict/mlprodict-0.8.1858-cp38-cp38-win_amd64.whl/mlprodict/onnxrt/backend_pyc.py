...
"""
from .backend import OnnxInferenceBackendPyC

is_compatible = OnnxInferenceBackendPyC.is_compatible
prepare = OnnxInferenceBackendPyC.prepare
run = OnnxInferenceBackendPyC.run_model
supports_device = OnnxInferenceBackendPyC.supports_device
