    ...
    def BuildAPIURL(self):
        ...
        if self.AuthToken :
            ...
            if self.DateFrom and self.DateTo:
                url = f"{url}?dateFrom={self.DateFrom}&dateTo={self.DateTo}&recordPerPage={self.RecordsPerPage}&page={self.Page}"
            else :
                url = f"{url}?timePeriod={self.TimePeriod}&recordPerPage={self.RecordsPerPage}&page={self.Page}"
