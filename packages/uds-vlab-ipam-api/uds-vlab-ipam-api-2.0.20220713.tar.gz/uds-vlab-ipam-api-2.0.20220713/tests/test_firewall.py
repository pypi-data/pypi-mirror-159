# -*- coding: UTF-8 -*-
"""A suite of unit tests for the uds_vlab_ipam_api.lib.firewall module"""
import textwrap
import unittest
from unittest.mock import patch, MagicMock, mock_open

from uds_vlab_ipam_api.lib import firewall
...
@patch('uds_vlab_ipam_api.lib.firewall.run_cmd')
class TestFireWall(unittest.TestCase):
    ...
    def test_save_rules_file(self, fake_run_cmd):
        ...
        the_file, mode = args
        expected_file = '/etc/sysconfig/iptables'
        expected_mode = 'w'
