# -*- coding: UTF-8 -*-
"""
Unit tests for the uds_vlab_ipam_api.lib.database module
"""
import types
import unittest
...
from uds_vlab_ipam_api.lib import database


class TestDatabase(unittest.TestCase):
    """A suite of tests for the uds_vlab_ipam_api.lib.database module"""

    def setUp(self):
        """Runs before every test case"""
        # mock away the psycopg2 module
        self.patcher = patch('uds_vlab_ipam_api.lib.database.psycopg2.connect')
