# -*- coding: UTF-8 -*-
"""This module creates a simpler way to work with the UDS vlab IPAM database"""
import random

import psycopg2

from uds_vlab_ipam_api.lib import const
from uds_vlab_ipam_api.lib.exceptions import DatabaseError
...
class Database(object):
    ...
    """
    def __init__(self, user='postgres', dbname='uds_vlab_ipam'):
