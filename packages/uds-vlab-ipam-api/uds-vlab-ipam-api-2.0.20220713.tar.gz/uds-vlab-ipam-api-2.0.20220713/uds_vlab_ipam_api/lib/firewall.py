...
from uds_vlab_ipam_api.lib.shell import run_cmd, CliResult
from uds_vlab_ipam_api.lib.exceptions import CliError
...
class FireWall(object):
    ...
    def save_rules(self):
        ...
        with self:
            ...
            with open('/etc/sysconfig/iptables', 'w') as the_file:
