...
class Manager:
  ...
  def _set_vault(self, vault):
    ...
    logging.getLogger("laboro.main").set_vault(vault)
  ...
  def set_log_level(self, level):
    ...
    """
    logging.getLogger("laboro.main").setLevel(level)
  ...
  def add_file_handler(self, logdir, workflow, session):
    ...
    logging.getLogger("laboro.main").addHandler(self.handlers[session])
  ...
  def remove_file_handler(self, session):
    ...
    """
    logging.getLogger("laboro.main").removeHandler(self.handlers[session])
