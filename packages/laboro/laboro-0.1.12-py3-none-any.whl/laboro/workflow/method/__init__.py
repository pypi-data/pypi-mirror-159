...
class Method:
  ...
  def _get_method_args(self):
    if self.args is not None:
      interpolated = copy.deepcopy(self.args)
  ...
  def run(self):
    for item in self.iterable:
      ...
      if self.runnable:
        logging.getLogger("laboro.main").log_section("METHOD",
                                        f"{self.name}")
        ...
        logging.getLogger("laboro.main").log_section("METHOD", msg, level=logging.WARNING)
