...
class Instant(GenericItem):
    ...
    def foregrounds(self):
        assert self.download_flags & DownloadFlags.WITH_FOREGROUND_MASK_FILE, \
            "Provided flag doesn't contain 'foregrounds'. Recreate your dataset with appropriate DownloadFlags"
        try:
