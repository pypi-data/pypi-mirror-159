"""https://www.zabbix.com/documentation/5.4/en/manual/api/reference/hostprototype/object"""
...
class HostPrototypeStatus(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.4/en/manual/api/reference/hostprototype/object#host-prototype
...
class CustomInterfaceMain(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.4/en/manual/api/reference/hostprototype/object#custom-interface
...
class CustomInterfaceDetailsVersion(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.4/en/manual/api/reference/hostprototype/object#custom-interface-details
