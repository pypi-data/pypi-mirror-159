"""https://www.zabbix.com/documentation/5.2/en/manual/api/reference/housekeeping/object"""
...
class HousekeepingHKEventsMode(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/housekeeping/object#housekeeping
