...
class WeatherApi(object):
    ...
    def list_all1(self, tenant_type, x_api_key, **kwargs):  # noqa: E501
        ...
        :param str plot_id: Unique identifier for plot, e.g. boundaryId = 4d35861
        ...
        :param str external_id: ExternalId is a unique id to identify plot, e.g. externalIds= 4d35861 or 4d35861,61e6c83
    ...
    def list_all1_with_http_info(self, tenant_type, x_api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['tenant_type', 'x_api_key', 'org_id', 'page', 'size', 'sort_by', 'order_by', 'ids', 'plot_id', '_date', 'date_from', 'date_to', 'external_id']  # noqa: E501
