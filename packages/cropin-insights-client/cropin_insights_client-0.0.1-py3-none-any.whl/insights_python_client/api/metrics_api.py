...
class MetricsApi(object):
    ...
    def list_all2(self, tenant_type, x_api_key, **kwargs):  # noqa: E501
        ...
        :param str boundary_id: Unique identifier for plot, e.g. boundaryId = 4d35861
        :param str captured_date_time: Indicates satellite indices captured date, e.g. capturedDateTime = 2021-12-23T00:00:00Z
