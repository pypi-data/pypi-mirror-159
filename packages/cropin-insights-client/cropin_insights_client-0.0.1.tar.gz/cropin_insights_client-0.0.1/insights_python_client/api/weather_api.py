...
class WeatherApi(object):
    ...
    def list_all1(self, tenant_type, x_api_key, **kwargs):  # noqa: E501
        ...
        :param str plot_id: Unique identifier for plot e.g. plotId = 4d35861
        :param str _date: Indicates captured satellite date, e.g. date = 2021-12-23T00:00:00Z
        ...
        :param str external_id: ExternalId is a unique id to identify plot, e.g. externalId = ebc3251
