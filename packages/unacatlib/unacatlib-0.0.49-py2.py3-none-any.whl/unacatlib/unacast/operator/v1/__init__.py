...
# sources: unacast/operator/v1/index_job_operator_service.proto, unacast/operator/v1/dimension_operator_service.proto, unacast/operator/v1/address_component_operator_service.proto, unacast/operator/v1/index_job.proto, unacast/operator/v1/catalog_operator_service.proto, unacast/operator/v1/map_operator_service.proto, unacast/operator/v1/metric_operator_service.proto
...
class IndexJobOperatorServiceStub(betterproto.ServiceStub):
    """
    * This is the service used for operators to administrate the index jobs in
    Unacat
    """
