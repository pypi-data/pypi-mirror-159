...
@dataclass(eq=False, repr=False)
class AppendToUnacatMetricRequest(betterproto.Message):
    billing_context: str = betterproto.string_field(1)
    catalog_id: str = betterproto.string_field(2)
    report_id: str = betterproto.string_field(3)
    big_query_table_id: str = betterproto.string_field(5)
    period: "Period" = betterproto.message_field(6)
...
@dataclass(eq=False, repr=False)
class AppendToUnacatMetricResponse(betterproto.Message):
    metric_id: str = betterproto.string_field(1)
    unacat_ref: str = betterproto.string_field(2)
