...
class PackageOptions(abc.ABC):
    ...
    def _from_engine_spec(
        ...
        if not engine_spec:
            return None
        engine = getattr(engine_spec, engine_spec.WhichOneof("engine_spec"))
...
class TVMPackageOptions(PackageOptions):
    ...
    def _apply_to_spec(self, package_spec: package_pb2.PackageStageSpec):
        ...
        tvm_engine_spec.relay_opt_lvl = self.relay_opt_lvl
...
class OnnxPackageOptions(PackageOptions):
    ...
    def _apply_to_spec(self, package_spec: package_pb2.PackageStageSpec):
        ...
        onnx_engine_spec = engine_pb2.ONNXRuntimeEngineSpec()
        engine_spec.onnxruntime_engine_spec.CopyFrom(onnx_engine_spec)
...
class ModelVariant:
    ...
    def benchmark(
        ...
        if untuned_tvm or self.format == ModelVariantFormat.RELAY:
            ...
            engine_spec.onnxruntime_engine_spec.CopyFrom(
                engine_pb2.ONNXRuntimeEngineSpec()
            )
    ...
    def accelerate(  # noqa: C901
        ...
        tuning_options: typing.Optional[
            typing.Union[AutoTVMOptions, AutoschedulerOptions]
        ] = None,
        ...
        :param tuning_options: options to control the autotuning search. Provide either
            AutoTVMOptions or AutoschedulerOptions.
        ...
        # use AutoTVM. Otherwise use Autoscheduler defaults.
        if (
            ...
            if self.proto.quantized:
                # Autoscheduler does not currently support quantized models
                tuning_options = AutoTVMOptions()
            else:
    ...
    def package(
        ...
        if relay_opt_lvl is not None:
            ...
            package_options = TVMPackageOptions(relay_opt_lvl=relay_opt_lvl)
    ...
    def _package_spec_helper(
        ...
        # TODO: OCTO-2095, get rid of package_type specification after SDK break
        # since nothing will use it at this point.
        package_spec.package_type = package_pb2.ALL_AVAILABLE_PACKAGES
