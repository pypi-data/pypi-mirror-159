...
def localhost_mode_cli(ctx):
    """GPULab client version 3.7.0 (in LOCALHOST_MODE!)
    ...
    job_request = Job2.from_dict({
        ...
        "request": {
            "docker": {
                "image": docker_image,
                "command": command,
                "storage": [{"mountPath": "PROJECT_SHARE_AUTO", "containerPath": "/project"}]
            },
            "resources": {
