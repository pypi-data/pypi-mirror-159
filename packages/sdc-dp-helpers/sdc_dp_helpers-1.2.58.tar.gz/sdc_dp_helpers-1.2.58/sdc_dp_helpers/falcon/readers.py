...
class CustomFalconReader:
    ...
    def _get_channel_ids(self) -> list:
        """
        ...
        while True:
            req = requests.Request(
                ...
                json={
                    ...
                    "since": date,
                    "until": date,
                    "postsSince": self._config.get("postSince", date),
                    "postsUntil": self._config.get("postUntil", date),
    ...
    def _published_posts_by_channel_id(self, date: str, channel_id: str) -> list:
        ...
        while endpoint_url:
            ...
            if response.status_code == 200:
                ...
                if results.get("next"):
                    endpoint_url = results["next"].get("href", None)
                    # print(endpoint_url)
            elif reason == "Not Found" and status_code == 404:
                print(f"No data for channel id: {channel_id}, skipping.\n")
                break
