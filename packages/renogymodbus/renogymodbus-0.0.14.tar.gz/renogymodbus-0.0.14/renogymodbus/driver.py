...
class RenogyChargeController(minimalmodbus.Instrument):
    ...
    def get_battery_temperature(self):
        ...
        battery_temperature = register_value & 0b0000000011111110
        battery_temperature_sign = register_value & 0b0000000000000001
    ...
    def get_controller_temperature(self):
        ...
        register_value = self.read_register(0x0103, 0, 3)
        controller_temperature = register_value & 0b1111111000000000 >> 8
        controller_temperature_sign = register_value & 0b0000000100000000 >> 8
