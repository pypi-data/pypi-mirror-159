...
class RenogyChargeController(minimalmodbus.Instrument):
    ...
    def get_battery_temperature(self):
        ...
        battery_temperature_sign = extract_bits(register_value, 15, 1)
        battery_temperature = extract_bits(register_value, 8, 7)
    ...
    def get_controller_temperature(self):
        ...
        controller_temperature = extract_bits(register_value, 0, 7)
        controller_temperature_sign = extract_bits(register_value, 7, 1)
