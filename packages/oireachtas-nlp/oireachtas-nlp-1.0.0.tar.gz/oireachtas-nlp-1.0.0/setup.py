...
setup(
    ...
    version='1.0.0',
    python_requires='>=3.6',
    description='nlp on data from the oireachtas api relating to members / partiies',
    long_description='nlp on data from the oireachtas api relating to members / partiies',
    author='Robert Lucey',
