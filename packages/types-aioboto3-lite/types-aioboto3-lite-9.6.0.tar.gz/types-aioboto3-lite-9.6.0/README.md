...
Once the `conda-forge` channel has been enabled, `types-aioboto3-lite` and
`types-aioboto3-lite-essential` can be installed with:

```bash
conda install types-aioboto3-lite types-aioboto3-lite-essential
```

It is possible to list all of the versions of `types-aioboto3-lite` available
on your platform with:

```bash
conda search types-aioboto3-lite --channel conda-forge
```
...
- `types-aioboto3-lite[all]` - Type annotations for all 310 services.
