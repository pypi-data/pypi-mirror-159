...
from runml_infuse.models.tensorflow import PixelCNN
...
from runml_infuse.utils.saving import load_detector  # type: ignore
...
def fetch_tf_model(dataset: str, model: str) -> tf.keras.Model:
    ...
    """
    url = 'https://storage.googleapis.com/seldon-models/runml-infuse/classifier/'
...
def fetch_detector(filepath: Union[str, os.PathLike],
    ...
    url = 'https://storage.googleapis.com/seldon-models/runml-infuse/'
