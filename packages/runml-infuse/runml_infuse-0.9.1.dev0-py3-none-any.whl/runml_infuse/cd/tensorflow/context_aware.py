...
from runml_infuse.cd.base import BaseContextMMDDrift
from runml_infuse.utils.tensorflow.kernels import GaussianRBF
from runml_infuse.cd._domain_clf import _SVCDomainClf
...
def _sigma_median_diag(x: tf.Tensor, y: tf.Tensor, dist: tf.Tensor) -> tf.Tensor:
    """
    Private version of the bandwidth estimation function :py:func:`~runml_infuse.utils.tensorflow.kernels.sigma_median`,
