...
from runml_infuse.utils.pytorch.kernels import GaussianRBF
...
def _sigma_median_diag(x: torch.Tensor, y: torch.Tensor, dist: torch.Tensor) -> torch.Tensor:
    """
    Private version of the bandwidth estimation function :py:func:`~runml_infuse.utils.pytorch.kernels.sigma_median`,
