...
if has_pytorch:
    from runml_infuse.cd.pytorch.mmd_online import MMDDriftOnlineTorch

if has_tensorflow:
    from runml_infuse.cd.tensorflow.mmd_online import MMDDriftOnlineTF
    ...
    def __init__(
        ...
        if kernel is None:
            if backend == 'tensorflow':
                ...
                from runml_infuse.utils.pytorch.kernels import GaussianRBF  # type: ignore
