...
function GetOciCommandsToLongParams_opsi() {
    $ociCommandsToLongParams = @{
        ...
        'opsi host-insights summarize-top-processes-usage-trend' = 'analysis-time-interval compartment-id from-json help id limit page resource-metric time-interval-end time-interval-start'
