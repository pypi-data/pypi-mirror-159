...
class BasePipeline:
    ...
    def execute(self):
        ...
        for i, slug in enumerate(self.components):
            t1 = get_time()
            logging.info("{}: component {}/{}".format(self.pipeline_slug, i + 1, len(self.components)))
            ...
            logging.info("{}: component {}/{} completed in {}".format(self.pipeline_slug, i + 1, len(self.components),
                                                                      elapsed(t1)))
