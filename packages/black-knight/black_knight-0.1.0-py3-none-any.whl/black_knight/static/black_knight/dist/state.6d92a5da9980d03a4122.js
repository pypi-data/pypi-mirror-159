...
var Logout = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, (0, utils_1.REQUEST)('/api/logout/')];
            case 1:
                response = _a.sent();
                if (response.ok)
                    location.assign('/');
...
var Login = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, (0, utils_1.REQUEST)('/api/login/', 'POST', undefined, data)];
            case 1:
                response = _a.sent();
...
var AdminAtom = (0, jotai_1.atom)(function (get) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, (0, utils_1.REQUEST)('api/index/')];
            case 1:
                response = _a.sent();
                if (response.ok)
...
var store_1 = __webpack_require__(4167);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, (0, state_1.REQUEST)("api/".concat(app_model, "/brace-info/"), 'GET', BraceInfoController.signal)];
            case 1:
                response = _a.sent();
                if (response.ok) {
                    info = get(store_1.Info);
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                set(store_1.Select, []);
                return [4, (0, state_1.REQUEST)("api/".concat(app_model, "/brace-result/"), 'POST', BraceResultController.signal, opt)];
            case 1:
                response = _b.sent();
                if (response.ok) {
                    results = get(store_1.Result);
...
var _1 = __webpack_require__(5159);
var jotai_1 = __webpack_require__(1131);
var store_1 = __webpack_require__(4167);
...
__exportStar(__webpack_require__(5159), exports);
...
var LogAtom = (0, jotai_1.atom)(function (get) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, (0, utils_1.REQUEST)('api/log/')];
            case 1:
                response = _a.sent();
                if (response.ok)
...
var UserAtom = (0, jotai_1.atom)(function (get) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, (0, utils_1.REQUEST)('api/user/')];
            case 1:
                response = _a.sent();
                if (response.ok)
...
__exportStar(__webpack_require__(9308), exports);
...
var REQUEST = function (url, method, signal, data) { return __awaiter(void 0, void 0, void 0, function () {
    var body, headers, response, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 2: return [2, (_a.data = _b.sent(), _a)];
            case 3:
                error_1 = _b.sent();
...
//# sourceMappingURL=source_maps/state.6d92a5da9980d03a4122.js.map