...
class User(QuickRestoObject):
    ...
    def __init__(self, version: int, serverRegisterTime: str, userKind: str, lastName: str, login: str, language: dict, deleted: bool, hidden: bool, lastLoginTime: str, tokens: list, **kwargs):
        class_name = ""
