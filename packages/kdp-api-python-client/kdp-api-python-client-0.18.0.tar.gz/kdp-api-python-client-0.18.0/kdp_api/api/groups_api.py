...
class GroupsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.groups_id_delete_endpoint = _Endpoint(
            settings={
                'response_type': (Group,),
                'auth': [
                    'Bearer'
        ...
        self.groups_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (Group,),
                'auth': [
                    'Bearer'
        ...
        self.groups_id_patch_endpoint = _Endpoint(
            settings={
                'response_type': (Group,),
                'auth': [
                    'Bearer'
        ...
        self.groups_id_put_endpoint = _Endpoint(
            settings={
                'response_type': (Group,),
                'auth': [
                    'Bearer'
        ...
        self.groups_post_endpoint = _Endpoint(
            settings={
                'response_type': (Group,),
                'auth': [
                    'Bearer'
    ...
    def groups_id_delete(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.groups_id_delete_endpoint.call_with_http_info(**kwargs)
    ...
    def groups_id_get(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.groups_id_get_endpoint.call_with_http_info(**kwargs)
    ...
    def groups_id_patch(
        ...
        **kwargs
        ...
        >>> thread = api.groups_id_patch(id, group3, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['group3'] = \
            group3
        return self.groups_id_patch_endpoint.call_with_http_info(**kwargs)
    ...
    def groups_id_put(
        ...
        **kwargs
        ...
        >>> thread = api.groups_id_put(id, group2, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['group2'] = \
            group2
        return self.groups_id_put_endpoint.call_with_http_info(**kwargs)
    ...
    def groups_post(
        ...
        **kwargs
        ...
        >>> thread = api.groups_post(group1, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['group1'] = \
            group1
        return self.groups_post_endpoint.call_with_http_info(**kwargs)
