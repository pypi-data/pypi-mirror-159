...
class gdo_drow:
    ...
    def get_same_user(user: str) -> str:
		...
		"viewport-width": "1366"}
    	res = requests.get(f'https://www.instagram.com/web/search/topsearch/?context=blended&query={user}',headers=head).json()
    	user_list = []
    	full_list = []
    	try:
    		se = 0
