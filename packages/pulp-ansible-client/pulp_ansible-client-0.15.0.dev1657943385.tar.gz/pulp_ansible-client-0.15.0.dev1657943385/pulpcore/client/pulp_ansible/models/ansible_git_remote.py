...
class AnsibleGitRemote(object):
    ...
    def __init__(self, proxy_username=None, proxy_password=None, download_concurrency=None, rate_limit=None, sock_connect_timeout=None, ca_cert=None, max_retries=None, pulp_labels=None, username=None, total_timeout=None, password=None, tls_validation=None, url=None, sock_read_timeout=None, proxy_url=None, name=None, connect_timeout=None, client_cert=None, headers=None, client_key=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
