...
class AnsibleGitRemote(object):
    ...
    def __init__(self, client_key=None, client_cert=None, proxy_username=None, url=None, sock_connect_timeout=None, pulp_labels=None, sock_read_timeout=None, connect_timeout=None, headers=None, tls_validation=None, max_retries=None, proxy_password=None, ca_cert=None, name=None, proxy_url=None, username=None, download_concurrency=None, password=None, total_timeout=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
