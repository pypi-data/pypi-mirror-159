...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, client_cert=None, pulp_href=None, url=None, sock_connect_timeout=None, pulp_created=None, pulp_labels=None, sock_read_timeout=None, pulp_last_updated=None, connect_timeout=None, headers=None, tls_validation=None, max_retries=None, ca_cert=None, name=None, proxy_url=None, download_concurrency=None, total_timeout=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
