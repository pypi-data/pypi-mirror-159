...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, ca_cert=None, tls_validation=None, sock_connect_timeout=None, name=None, proxy_username=None, rate_limit=None, proxy_url=None, pulp_labels=None, connect_timeout=None, url=None, client_cert=None, download_concurrency=None, total_timeout=None, sock_read_timeout=None, client_key=None, headers=None, username=None, max_retries=None, proxy_password=None, password=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
