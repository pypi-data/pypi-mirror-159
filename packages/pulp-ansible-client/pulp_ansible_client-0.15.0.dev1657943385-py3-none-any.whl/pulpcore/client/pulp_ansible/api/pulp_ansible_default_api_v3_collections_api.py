...
class PulpAnsibleDefaultApiV3CollectionsApi(object):
    ...
    def update(self, name, namespace, body, **kwargs):  # noqa: E501
        """update  # noqa: E501

        Legacy v3 endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(name, namespace, body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(name, namespace, body, **kwargs)  # noqa: E501

    def update_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        """update  # noqa: E501

        Legacy v3 endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(name, namespace, body, async_req=True)
        >>> result = thread.get()
