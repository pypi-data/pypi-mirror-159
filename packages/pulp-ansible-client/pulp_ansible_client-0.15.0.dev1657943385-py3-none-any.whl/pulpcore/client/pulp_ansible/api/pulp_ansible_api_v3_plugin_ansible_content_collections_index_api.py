...
class PulpAnsibleApiV3PluginAnsibleContentCollectionsIndexApi(object):
    ...
    def update(self, distro_base_path, name, namespace, path, body, **kwargs):  # noqa: E501
        """update  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(distro_base_path, name, namespace, path, body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(distro_base_path, name, namespace, path, body, **kwargs)  # noqa: E501

    def update_with_http_info(self, distro_base_path, name, namespace, path, body, **kwargs):  # noqa: E501
        """update  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(distro_base_path, name, namespace, path, body, async_req=True)
        >>> result = thread.get()
