...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, download_concurrency=None, rate_limit=None, sock_connect_timeout=None, ca_cert=None, max_retries=None, pulp_href=None, pulp_labels=None, pulp_last_updated=None, pulp_created=None, total_timeout=None, tls_validation=None, url=None, sock_read_timeout=None, proxy_url=None, name=None, connect_timeout=None, client_cert=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
