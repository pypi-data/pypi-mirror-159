...
def get_delivery_order_family_dic():
    return {
        1: "Entrega",
        2: "Retorno"        
    }
...
def get_delivery_order_status_description_dic():
    return {
        4: "Recibida por el tren logístico",
...
def get_family(delivery_order):
    family = get_delivery_order_family_dic()
    return family[delivery_order['family']] if 'family' in delivery_order else family[1]
