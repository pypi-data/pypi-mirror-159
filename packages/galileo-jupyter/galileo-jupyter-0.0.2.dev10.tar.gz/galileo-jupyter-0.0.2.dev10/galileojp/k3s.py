...
if __name__ == '__main__':
    ...
    df = gw.get_replica_schedule_statistics(exp_id, 'mobilenet', per_second=False)
    df = df.sort_values(by='cluster')
    g = sns.lineplot(x='ts', y='cluster_total', data=df.reset_index(), style='cluster', hue='cluster', markers=False,
