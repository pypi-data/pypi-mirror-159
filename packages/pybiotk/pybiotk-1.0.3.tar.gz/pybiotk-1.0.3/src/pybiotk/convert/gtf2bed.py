...
def main(
        ...
        outformat: Literal["bed12", "bed6", "intron", "gene_info", "trans_info"] = "bed12"):
...
def run():
    ...
    parser.add_argument('--outformat', dest='outformat', default='bed12',
