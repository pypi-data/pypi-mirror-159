...
default_spline_params = cvar.default_spline_params
...
default_gsl_params = cvar.default_gsl_params
...
class f2d_t(object):
    ...
    extrap_in_log = property(_ccllib.f2d_t_extrap_in_log_get, _ccllib.f2d_t_extrap_in_log_set, doc=r"""extrap_in_log : int""")
...
def f2d_t_new(na, a_arr, nk, lk_arr, fka_arr, fk_arr, fa_arr, is_factorizable, extrap_order_lok, extrap_order_hik, extrap_linear_growth, is_fka_log, extrap_in_log, growth_factor_0, growth_exponent, interp_type, status):
    r"""f2d_t_new(int na, double * a_arr, int nk, double * lk_arr, double * fka_arr, double * fk_arr, double * fa_arr, int is_factorizable, int extrap_order_lok, int extrap_order_hik, ccl_f2d_extrap_growth_t extrap_linear_growth, int is_fka_log, int extrap_in_log, double growth_factor_0, int growth_exponent, ccl_f2d_interp_t interp_type, int * status) -> f2d_t"""


    return _ccllib.f2d_t_new(na, a_arr, nk, lk_arr, fka_arr, fk_arr, fa_arr, is_factorizable, extrap_order_lok, extrap_order_hik, extrap_linear_growth, is_fka_log, extrap_in_log, growth_factor_0, growth_exponent, interp_type, status)
...
def set_pk2d_new_from_arrays(lkarr, aarr, pkarr, order_lok, order_hik, is_logp, extrap_in_log, status):
    r"""set_pk2d_new_from_arrays(double * lkarr, double * aarr, double * pkarr, int order_lok, int order_hik, int is_logp, int extrap_in_log, int * status) -> f2d_t"""


    return _ccllib.set_pk2d_new_from_arrays(lkarr, aarr, pkarr, order_lok, order_hik, is_logp, extrap_in_log, status)
...
def einasto_norm(rs, rd, al, nout, status):
    r"""einasto_norm(double * rs, double * rd, double * al, int nout, int * status)"""
    ...
    return _ccllib.einasto_norm(rs, rd, al, nout, status)

def hernquist_norm(rs, rd, nout, status):
    r"""hernquist_norm(double * rs, double * rd, int nout, int * status)"""
    ...
    return _ccllib.hernquist_norm(rs, rd, nout, status)
