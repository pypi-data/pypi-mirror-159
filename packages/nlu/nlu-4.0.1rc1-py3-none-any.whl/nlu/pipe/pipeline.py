...
class NLUPipeline(dict):
    ...
    def pythonify_spark_dataframe(self, processed,
        ...
        print('_________DEBUG: EXPLODING')
        # meta_ner_chunk_doc_sentence what is ???  ---> entities_ner_chunk_origin_sentence COLLISON
        #  after substitute meta_ner_chunk_sentence --> entities_ner_chunk_origin_sentence
        print('\n'.join(same_level))
    ...
    def predict(self,
        ...
        return __predict__(self, data, output_level, positions, keep_stranger_features, metadata, multithread,
                           drop_irrelevant_cols, return_spark_df, get_embeddings,reset_index)
