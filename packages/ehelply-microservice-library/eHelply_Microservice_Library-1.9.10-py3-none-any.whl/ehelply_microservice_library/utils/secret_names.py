...
def secret_name_auth_dynamo():
    """
    AWS ASM secret name for access to auth dynamo encryption

    Returns:
        None

    """
    return "ehelply-all.microservices.auth-dynamos.vault".format(environment=_get_environment_name())
