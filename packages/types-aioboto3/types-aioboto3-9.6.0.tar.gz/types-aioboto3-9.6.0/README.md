...
[![PyPI - Downloads](https://img.shields.io/pypi/dm/types-aioboto3?color=blue)](https://pypistats.org/packages/types-aioboto3)
...
Once the `conda-forge` channel has been enabled, `types-aioboto3` and
`types-aioboto3-essential` can be installed with:

```bash
conda install types-aioboto3 types-aioboto3-essential
```

It is possible to list all of the versions of `types-aioboto3` available on
your platform with:
...
- `types-aioboto3[all]` - Type annotations for all 310 services.
