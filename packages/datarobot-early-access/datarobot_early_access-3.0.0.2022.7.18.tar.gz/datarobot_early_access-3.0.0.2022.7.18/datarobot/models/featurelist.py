...
from typing import cast, List, Optional, TYPE_CHECKING, TypeVar
...
class Featurelist(BaseFeaturelist):
    ...
    def __init__(
        ...
        if isinstance(id, dict):  # type: ignore[unreachable]
    ...
    @classmethod
    def from_data(cls, data: "ServerDataDictType") -> TFeaturelist:  # type: ignore[override]
    ...
    @classmethod
    def get(cls, project_id: str, featurelist_id: str) -> TFeaturelist:
...
class ModelingFeaturelist(BaseFeaturelist):
    ...
    @classmethod
    def get(cls, project_id: str, featurelist_id: str) -> TModelingFeaturelist:
...
class DatasetFeaturelist(APIObject):
    ...
    @classmethod
    def get(cls, dataset_id: str, featurelist_id: str) -> TDatasetFeaturelist:
