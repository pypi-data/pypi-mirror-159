...
class Build:
    ...
    def __init__(self, toolchain=None, version=None):
    ...
    def compile(self):
        ...
        print(icon_rocket, " Requesting CC compile to Sabana")
        ...
        try:
            ...
            if "program" in res.keys() and "objdump" in res.keys():
                ...
                print_up(icon_confetti, "CC Compilation successful using Sabana")
                return result
            else:
