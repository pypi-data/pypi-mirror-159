...
class Student(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, identifiers, name_prefixes, surname, forenames, affiliations, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, identifiers, name_prefixes, surname, forenames, affiliations, *args, **kwargs):  # noqa: E501
        """Student - a model defined in OpenAPI
