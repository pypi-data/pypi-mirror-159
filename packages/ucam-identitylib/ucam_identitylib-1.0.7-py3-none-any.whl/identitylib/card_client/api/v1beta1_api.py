    ...
    def v1beta1_available_barcodes_create(
        ...
        **kwargs
        ...
        """Creates a single available barcode  # noqa: E501
          ...
          ## Create an available barcode  This method allows the client to create a single available barcode. Typically, the batch creation endpoint would be used to import a batch of barcodes all at once, rather than multiple calls to this endpoint.  ### Permissions  Only Principals with the `CARD_CREATOR` permission will be able to create available barcodes.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def v1beta1_cards_update(
        ...
        **kwargs
        ...
        """Update the card  # noqa: E501
          ...
          ## Update the card  This method allows a client to submit an action in the request body and optional note for a given card.  For the `cancel` action, the client can optionally append a `note` describing the reason for cancelling the card.  ### Permissions  Principals with the `CARD_CREATOR` permission will be able to affect this endpoint.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
