...
class Affiliation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, value, status, scheme, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            start (date): The start date of this affiliation. May not be populated if not known.. [optional]  # noqa: E501
            end (date): The end date of this affiliation. May not be populated if the affiliation is open-ended.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, value, status, scheme, *args, **kwargs):  # noqa: E501
        """Affiliation - a model defined in OpenAPI
