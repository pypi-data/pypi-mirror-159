...
class TYPES(Enum):
    ...
    def dict(cls):
        return {
            'LIMIT': cls.NORMAL.name,
            'MARKET': cls.QUICK.name
        }
...
class STATUS(Enum):
    ...
    def dict(cls):
        return {
            'CREATED': cls.CREATED.name,
            'ORDERING': cls.ORDERING.name,
            'ORDERED': cls.ORDERED.name,
            'FAILED': cls.FAILED.name,
            'FINISHED': cls.FINISHED.name,
            'CANCELING': cls.CANCELING.name,
            'CANCELED': cls.CANCELED.name
        }
