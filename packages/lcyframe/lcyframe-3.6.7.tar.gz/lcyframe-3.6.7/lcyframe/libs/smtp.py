...
class SmtpServer(object):
    def __init__(self, **kwargs):
        ...
        self.smtp_email = kwargs.get("smtp_email", "")                    # "发件人的昵称<123220663@qq.com>"

        if smtp_ssl:
            connection_class = smtplib.SMTP_SSL(self.smtp_host, self.smtp_post, local_hostname, keyfile, certfile, timeout, source_address, context)
        else:
        ...
        # self.smtp.connect(host, port)  # 25 为 SMTP 端口号
...
if __name__ == "__main__":
    ...
    # 发件人邮箱
    smtp_email = "发件人的昵称<123220663@qq.com>"
