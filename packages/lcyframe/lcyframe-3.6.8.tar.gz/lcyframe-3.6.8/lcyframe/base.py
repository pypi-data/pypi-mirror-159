...
class BaseHandler(RequestHandler):
    ...
    def write_error(self, status_code, **kwargs):
        ...
        if status_code == 404:
            ...
            logging.error("请求参数: " + (json.dumps(utils.check2json(utils.pparams(self.request, self.params))) if hasattr(self, "params") else str(utils.pparams(self.request, self.request.arguments) or {})))
