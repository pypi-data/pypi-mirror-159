...
- API version: v3
- Package version: 0.1.0b10.dev1658289575
...
version = 'version_example' # str | version of the cookbook (optional)
    ...
    try:
        ...
        api_response = api_instance.create(name, artifact=artifact, upload=upload, file=file, repository=repository, version=version)
        pprint(api_response)
