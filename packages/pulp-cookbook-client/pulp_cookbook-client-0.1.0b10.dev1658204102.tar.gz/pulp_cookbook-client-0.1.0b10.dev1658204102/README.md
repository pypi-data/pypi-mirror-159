...
- API version: v3
- Package version: 0.1.0b10.dev1658204102
...
version = 'version_example' # str | version of the cookbook (optional)
    ...
    try:
        ...
        api_response = api_instance.create(name, upload=upload, artifact=artifact, repository=repository, file=file, version=version)
        pprint(api_response)
