...
* suspended """
    ...
    """audit_event_selector,comment,encryption,policy,protection_status,qos_policy.max_throughput_iops,qos_policy.max_throughput_mbps,qos_policy.min_throughput_iops,qos_policy.min_throughput_mbps,qos_policy.name,qos_policy.uuid,size,svm.name,svm.uuid,versioning_state,volume.name,volume.uuid,"""
