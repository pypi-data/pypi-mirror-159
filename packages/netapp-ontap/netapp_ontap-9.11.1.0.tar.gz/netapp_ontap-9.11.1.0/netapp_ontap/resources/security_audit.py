...
class SecurityAuditSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    r""" Enable auditing of SNMP GET operations. Valid in PATCH """
    ...
    if RECLINE_INSTALLED:
        ...
        def security_audit_show(
            ...
            Args:
                ...
                snmp: Enable auditing of SNMP GET operations. Valid in PATCH
            """
    ...
    if RECLINE_INSTALLED:
        ...
        async def security_audit_modify(
            ...
            Args:
                ...
                snmp: Enable auditing of SNMP GET operations. Valid in PATCH
                query_snmp: Enable auditing of SNMP GET operations. Valid in PATCH
            """
            ...
            if query_snmp is not None:
                kwargs["snmp"] = query_snmp
