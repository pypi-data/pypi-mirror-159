...
class PerformanceMonitoredFilesMetric(Resource):
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="performance monitored files metric show")
    ...
    def count_collection(
        ...
        **kwargs
        ...
        """Returns a count of all PerformanceMonitoredFilesMetric resources that match the provided query"""
