...
`/api/svm/peers/{peer[uuid]}/protocols/s3/services`| <a title="netapp_ontap.resources.xc_s3_service.XcS3Service" href="../resources/xc_s3_service.html"><code>XcS3Service</code></a>
...
`/api/svm/peers/{peer[uuid]}/storage/snapshot-policies`| <a title="netapp_ontap.resources.xc_snapshot_policy.XcSnapshotPolicy" href="../resources/xc_snapshot_policy.html"><code>XcSnapshotPolicy</code></a>
...
`/api/cluster/peers/{peer[uuid]}/network/ethernet/broadcast-domains`| <a title="netapp_ontap.resources.xc_broadcast_domain.XcBroadcastDomain" href="../resources/xc_broadcast_domain.html"><code>XcBroadcastDomain</code></a>
...
`/api/cluster/peers/{peer[uuid]}/cluster/nodes`| <a title="netapp_ontap.resources.xc_node.XcNode" href="../resources/xc_node.html"><code>XcNode</code></a>
...
`/api/security/certificate-authorities`| <a title="netapp_ontap.resources.security_certificate_authority.SecurityCertificateAuthority" href="../resources/security_certificate_authority.html"><code>SecurityCertificateAuthority</code></a>
...
`/api/cluster/peers/{peer[uuid]}/snapmirror/relationships`| <a title="netapp_ontap.resources.xc_snapmirror_relationship.XcSnapmirrorRelationship" href="../resources/xc_snapmirror_relationship.html"><code>XcSnapmirrorRelationship</code></a>
...
`/api/cluster/peers/{peer[uuid]}/security`| <a title="netapp_ontap.resources.xc_security_config.XcSecurityConfig" href="../resources/xc_security_config.html"><code>XcSecurityConfig</code></a>
...
`/api/svm/peers/{peer[uuid]}/network/ip/interfaces`| <a title="netapp_ontap.resources.svm_ip_interface.SvmIpInterface" href="../resources/svm_ip_interface.html"><code>SvmIpInterface</code></a>
...
`/api/security/svm/accounts`| <a title="netapp_ontap.resources.svm_account.SvmAccount" href="../resources/svm_account.html"><code>SvmAccount</code></a>
...
`/api/svm/peers/{peer[uuid]}/storage/volumes/{volume[uuid]}/snapshots`| <a title="netapp_ontap.resources.xc_snapshot.XcSnapshot" href="../resources/xc_snapshot.html"><code>XcSnapshot</code></a>
...
`/api/svm/peers/{peer[uuid]}/network/fc/interfaces`| <a title="netapp_ontap.resources.xc_fc_interface.XcFcInterface" href="../resources/xc_fc_interface.html"><code>XcFcInterface</code></a>
...
`/api/svm/peers/{peer[uuid]}/snapmirror/policies`| <a title="netapp_ontap.resources.xc_snapmirror_policy.XcSnapmirrorPolicy" href="../resources/xc_snapmirror_policy.html"><code>XcSnapmirrorPolicy</code></a>
...
`/api/cluster/peers/{peer[uuid]}/cluster/schedules`| <a title="netapp_ontap.resources.xc_schedule.XcSchedule" href="../resources/xc_schedule.html"><code>XcSchedule</code></a>
...
`/api/cluster/peers/{peer[uuid]}/security/key-managers`| <a title="netapp_ontap.resources.xc_security_key_manager.XcSecurityKeyManager" href="../resources/xc_security_key_manager.html"><code>XcSecurityKeyManager</code></a>
`/api/name-services/netgroups`| <a title="netapp_ontap.resources.netgroup.Netgroup" href="../resources/netgroup.html"><code>Netgroup</code></a>
`/api/svm/peers/{peer[uuid]}/protocols/cifs/services`| <a title="netapp_ontap.resources.xc_cifs_service.XcCifsService" href="../resources/xc_cifs_service.html"><code>XcCifsService</code></a>
...
`/api/network/ip/options`| <a title="netapp_ontap.resources.network_ip_options.NetworkIpOptions" href="../resources/network_ip_options.html"><code>NetworkIpOptions</code></a>
...
`/api/private/cluster/nodes`| <a title="netapp_ontap.resources.node_private.NodePrivate" href="../resources/node_private.html"><code>NodePrivate</code></a>
...
`/api/security/certificate-authorities/{security_certificate_authority[uuid]}/issued-certificates`| <a title="netapp_ontap.resources.issued_certificate.IssuedCertificate" href="../resources/issued_certificate.html"><code>IssuedCertificate</code></a>
...
`/api/cluster/agent/connections`| <a title="netapp_ontap.resources.agent_connection.AgentConnection" href="../resources/agent_connection.html"><code>AgentConnection</code></a>
...
`/api/private/cli`| <a title="netapp_ontap.resources.cli_request.CliRequest" href="../resources/cli_request.html"><code>CliRequest</code></a>
...
`/api/private/manage/event-remediations`| <a title="netapp_ontap.resources.event_remediations.EventRemediations" href="../resources/event_remediations.html"><code>EventRemediations</code></a>
...
`/api/cluster/peers/{peer[uuid]}/network/ip/interfaces`| <a title="netapp_ontap.resources.xc_ip_interface.XcIpInterface" href="../resources/xc_ip_interface.html"><code>XcIpInterface</code></a>
`/api/svm/peers/{peer[uuid]}/storage/volumes`| <a title="netapp_ontap.resources.xc_volume.XcVolume" href="../resources/xc_volume.html"><code>XcVolume</code></a>
...
`/api/private/cluster/select-pre-expansion`| <a title="netapp_ontap.resources.select_pre_expansion.SelectPreExpansion" href="../resources/select_pre_expansion.html"><code>SelectPreExpansion</code></a>
...
`/api/cluster/licensing/access-tokens`| <a title="netapp_ontap.resources.access_token_request.AccessTokenRequest" href="../resources/access_token_request.html"><code>AccessTokenRequest</code></a>
`/api/cluster/web/statistics`| <a title="netapp_ontap.resources.web_statistics.WebStatistics" href="../resources/web_statistics.html"><code>WebStatistics</code></a>
`/api/security/accounts`| <a title="netapp_ontap.resources.account.Account" href="../resources/account.html"><code>Account</code></a>
`/api/cluster/peers/{peer[uuid]}/storage/aggregates`| <a title="netapp_ontap.resources.xc_aggregate.XcAggregate" href="../resources/xc_aggregate.html"><code>XcAggregate</code></a>
...
`/api/support/ems/alerts`| <a title="netapp_ontap.resources.ems_alert.EmsAlert" href="../resources/ems_alert.html"><code>EmsAlert</code></a>
...
`/api/svm/peers/{peer[uuid]}/svm/peers`| <a title="netapp_ontap.resources.xc_svm_peer.XcSvmPeer" href="../resources/xc_svm_peer.html"><code>XcSvmPeer</code></a>
...
`/api/cluster/peers/{peer[uuid]}/application/consistency-groups`| <a title="netapp_ontap.resources.xc_consistency_group.XcConsistencyGroup" href="../resources/xc_consistency_group.html"><code>XcConsistencyGroup</code></a>
...
`/api/cluster/peers/{peer[uuid]}/cluster/licensing/licenses`| <a title="netapp_ontap.resources.xc_license_package.XcLicensePackage" href="../resources/xc_license_package.html"><code>XcLicensePackage</code></a>
`/api/snapmirror/object-stores/{object_store[uuid]}/endpoints`| <a title="netapp_ontap.resources.object_store_endpoint_info.ObjectStoreEndpointInfo" href="../resources/object_store_endpoint_info.html"><code>ObjectStoreEndpointInfo</code></a>
...
`/api/private/support/alerts`| <a title="netapp_ontap.resources.alert.Alert" href="../resources/alert.html"><code>Alert</code></a>
...
`/api/security/keystore-certificates`| <a title="netapp_ontap.resources.security_keystore_certificate.SecurityKeystoreCertificate" href="../resources/security_keystore_certificate.html"><code>SecurityKeystoreCertificate</code></a>
`/api/storage/volumes/{volume[uuid]}/snapdiff/sessions`| <a title="netapp_ontap.resources.snapdiff_session.SnapdiffSession" href="../resources/snapdiff_session.html"><code>SnapdiffSession</code></a>
...
`/api/security/truststore-certificates`| <a title="netapp_ontap.resources.security_truststore_certificate.SecurityTruststoreCertificate" href="../resources/security_truststore_certificate.html"><code>SecurityTruststoreCertificate</code></a>
...
`/api/test/fijis`| <a title="netapp_ontap.resources.fiji.Fiji" href="../resources/fiji.html"><code>Fiji</code></a>
...
`/api/security/cluster/accounts`| <a title="netapp_ontap.resources.cluster_account.ClusterAccount" href="../resources/cluster_account.html"><code>ClusterAccount</code></a>
...
`/api/cluster/cloud-portals`| <a title="netapp_ontap.resources.cloud_portal.CloudPortal" href="../resources/cloud_portal.html"><code>CloudPortal</code></a>
...
`/api/cluster/peers/{peer[uuid]}/svm/svms`| <a title="netapp_ontap.resources.svm_expanded.SvmExpanded" href="../resources/svm_expanded.html"><code>SvmExpanded</code></a>
...
`/api/private/cluster/licensing/license-managers`| <a title="netapp_ontap.resources.private_license_manager.PrivateLicenseManager" href="../resources/private_license_manager.html"><code>PrivateLicenseManager</code></a>
...
`/api/cluster/peers/{peer[uuid]}/cluster`| <a title="netapp_ontap.resources.xc_cluster.XcCluster" href="../resources/xc_cluster.html"><code>XcCluster</code></a>
`/api/security/cluster/roles`| <a title="netapp_ontap.resources.cloned_role.ClonedRole" href="../resources/cloned_role.html"><code>ClonedRole</code></a>
`/api/svm/peers/{peer[uuid]}/application/applications`| <a title="netapp_ontap.resources.xc_application.XcApplication" href="../resources/xc_application.html"><code>XcApplication</code></a>
...
`/api/cluster/peers/{peer[uuid]}/support/ems/events`| <a title="netapp_ontap.resources.xc_ems_event.XcEmsEvent" href="../resources/xc_ems_event.html"><code>XcEmsEvent</code></a>
...
`/api/private/cluster/licensing/capacity-pools`| <a title="netapp_ontap.resources.capacity_pool_with_optional_node_serials.CapacityPoolWithOptionalNodeSerials" href="../resources/capacity_pool_with_optional_node_serials.html"><code>CapacityPoolWithOptionalNodeSerials</code></a>
...
`/api/security/svm/roles`| <a title="netapp_ontap.resources.cloned2_role.Cloned2Role" href="../resources/cloned2_role.html"><code>Cloned2Role</code></a>
...
`/api/test/smnext`| <a title="netapp_ontap.resources.smnext.Smnext" href="../resources/smnext.html"><code>Smnext</code></a>
`/api/svm/peers/{peer[uuid]}/protocols/s3/buckets`| <a title="netapp_ontap.resources.xc_s3_bucket.XcS3Bucket" href="../resources/xc_s3_bucket.html"><code>XcS3Bucket</code></a>
...
`/api/cluster/cloud-portals`| <a title="netapp_ontap.resources.cloud_portal_registration.CloudPortalRegistration" href="../resources/cloud_portal_registration.html"><code>CloudPortalRegistration</code></a>
...
`/api/private/protocols/audit/audit-log-redirect`| <a title="netapp_ontap.resources.audit_log_redirect.AuditLogRedirect" href="../resources/audit_log_redirect.html"><code>AuditLogRedirect</code></a>
...
`/api/cluster/licensing/leases`| <a title="netapp_ontap.resources.capacity_lease.CapacityLease" href="../resources/capacity_lease.html"><code>CapacityLease</code></a>
...
`/api/svm/peers/{peer[uuid]}/storage/luns`| <a title="netapp_ontap.resources.xc_lun.XcLun" href="../resources/xc_lun.html"><code>XcLun</code></a>
...
`/api/renames`| <a title="netapp_ontap.resources.rename.Rename" href="../resources/rename.html"><code>Rename</code></a>
`/api/private/cluster/usage`| <a title="netapp_ontap.resources.usage_list.UsageList" href="../resources/usage_list.html"><code>UsageList</code></a>
...
`/api/host/hosts/{uuid}/report`| <a title="netapp_ontap.resources.host_ems.HostEms" href="../resources/host_ems.html"><code>HostEms</code></a>
`/api/snapmirror/object-stores/{object_store[uuid]}/endpoints/{endpoint[uuid]}/snapshots`| <a title="netapp_ontap.resources.snapmirror_object_store_endpoint_snapshot.SnapmirrorObjectStoreEndpointSnapshot" href="../resources/snapmirror_object_store_endpoint_snapshot.html"><code>SnapmirrorObjectStoreEndpointSnapshot</code></a>
...
`/api/private/cluster/notes`| <a title="netapp_ontap.resources.note.Note" href="../resources/note.html"><code>Note</code></a>
...
from netapp_ontap.resources.xc_s3_service import XcS3Service
...
from netapp_ontap.resources.xc_snapshot_policy import XcSnapshotPolicy
...
from netapp_ontap.resources.xc_broadcast_domain import XcBroadcastDomain
...
from netapp_ontap.resources.xc_node import XcNode
from netapp_ontap.resources.wwpn_alias import WwpnAlias
from netapp_ontap.resources.local_cifs_user import LocalCifsUser
from netapp_ontap.resources.security_certificate_authority import SecurityCertificateAuthority
...
from netapp_ontap.resources.xc_snapmirror_relationship import XcSnapmirrorRelationship
...
from netapp_ontap.resources.xc_security_config import XcSecurityConfig
...
from netapp_ontap.resources.svm_ip_interface import SvmIpInterface
...
from netapp_ontap.resources.svm_account import SvmAccount
...
from netapp_ontap.resources.xc_snapshot import XcSnapshot
...
from netapp_ontap.resources.xc_fc_interface import XcFcInterface
...
from netapp_ontap.resources.xc_snapmirror_policy import XcSnapmirrorPolicy
...
from netapp_ontap.resources.xc_schedule import XcSchedule
...
from netapp_ontap.resources.xc_security_key_manager import XcSecurityKeyManager
from netapp_ontap.resources.netgroup import Netgroup
from netapp_ontap.resources.xc_cifs_service import XcCifsService
...
from netapp_ontap.resources.network_ip_options import NetworkIpOptions
...
from netapp_ontap.resources.node_private import NodePrivate
...
from netapp_ontap.resources.issued_certificate import IssuedCertificate
...
from netapp_ontap.resources.agent_connection import AgentConnection
...
from netapp_ontap.resources.cli_request import CliRequest
...
from netapp_ontap.resources.event_remediations import EventRemediations
...
from netapp_ontap.resources.xc_ip_interface import XcIpInterface
from netapp_ontap.resources.xc_volume import XcVolume
...
from netapp_ontap.resources.select_pre_expansion import SelectPreExpansion
...
from netapp_ontap.resources.access_token_request import AccessTokenRequest
from netapp_ontap.resources.web_statistics import WebStatistics
from netapp_ontap.resources.account import Account
from netapp_ontap.resources.xc_aggregate import XcAggregate
...
from netapp_ontap.resources.ems_alert import EmsAlert
...
from netapp_ontap.resources.xc_svm_peer import XcSvmPeer
...
from netapp_ontap.resources.xc_consistency_group import XcConsistencyGroup
...
from netapp_ontap.resources.xc_license_package import XcLicensePackage
from netapp_ontap.resources.object_store_endpoint_info import ObjectStoreEndpointInfo
...
from netapp_ontap.resources.alert import Alert
from netapp_ontap.resources.metrocluster_operation import MetroclusterOperation
from netapp_ontap.resources.security_keystore_certificate import SecurityKeystoreCertificate
from netapp_ontap.resources.snapdiff_session import SnapdiffSession
...
from netapp_ontap.resources.security_truststore_certificate import SecurityTruststoreCertificate
...
from netapp_ontap.resources.fiji import Fiji
from netapp_ontap.resources.s3_user import S3User
from netapp_ontap.resources.cluster_account import ClusterAccount
...
from netapp_ontap.resources.cloud_portal import CloudPortal
...
from netapp_ontap.resources.svm_expanded import SvmExpanded
...
from netapp_ontap.resources.private_license_manager import PrivateLicenseManager
from netapp_ontap.resources.snaplock_litigation_file import SnaplockLitigationFile
from netapp_ontap.resources.xc_cluster import XcCluster
from netapp_ontap.resources.cloned_role import ClonedRole
from netapp_ontap.resources.xc_application import XcApplication
...
from netapp_ontap.resources.xc_ems_event import XcEmsEvent
...
from netapp_ontap.resources.capacity_pool_with_optional_node_serials import CapacityPoolWithOptionalNodeSerials
...
from netapp_ontap.resources.cloned2_role import Cloned2Role
from netapp_ontap.resources.coredump import Coredump
from netapp_ontap.resources.smnext import Smnext
from netapp_ontap.resources.xc_s3_bucket import XcS3Bucket
...
from netapp_ontap.resources.cloud_portal_registration import CloudPortalRegistration
...
from netapp_ontap.resources.audit_log_redirect import AuditLogRedirect
...
from netapp_ontap.resources.capacity_lease import CapacityLease
from netapp_ontap.resources.volume_metrics import VolumeMetrics
from netapp_ontap.resources.xc_lun import XcLun
...
from netapp_ontap.resources.rename import Rename
from netapp_ontap.resources.usage_list import UsageList
...
from netapp_ontap.resources.host_ems import HostEms
from netapp_ontap.resources.snapmirror_object_store_endpoint_snapshot import SnapmirrorObjectStoreEndpointSnapshot
from netapp_ontap.resources.security_audit_log import SecurityAuditLog
from netapp_ontap.resources.aws_kms import AwsKms
from netapp_ontap.resources.note import Note
...
__all__ = [
    ...
    "QuotaReport",
    "SecurityAssociation",
    "CapacityPoolWithOptionalNodeSerials",
    "WebSvm",
    "StoragePool",
    ...
    "CifsOpenFile",
    "HostEms",
    "SnapmirrorObjectStoreEndpointSnapshot",
    "SecurityAuditLog",
    "AwsKms",
    "Note",
    "SecurityAudit",
