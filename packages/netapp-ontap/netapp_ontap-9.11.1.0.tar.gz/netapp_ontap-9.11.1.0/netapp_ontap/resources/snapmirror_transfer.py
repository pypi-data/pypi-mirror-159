...
class SnapmirrorTransferSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    archive_retrieval_priority = fields.Str(
        data_key="archive_retrieval_priority",
        validate=enum_validation(['standard', 'high', 'low']),
    )
    r""" This is supported for transfer of restore relationship only. Priority level at which objects are restored from the archival storage. The value can be high, standard or low. The cloud provider's lowest priority will be used as the default. It is only supported for object store SnapMirror relationships. If the objects were not archived, the property will be ignored.
...
Example: 4ea7a442-86d1-11e0-ae1c-123478563412 """
    ...
    """links,archive_retrieval_priority,bytes_transferred,checkpoint_size,end_time,error_info,relationship,snapshot,state,throttle,total_duration,uuid,"""
    ...
    """archive_retrieval_priority,error_info,relationship,state,throttle,"""
    ...
    """archive_retrieval_priority,error_info,files,relationship,snapshot_retention_period,source_snapshot,storage_efficiency_enabled,throttle,"""
...
"""
    ...
    if RECLINE_INSTALLED:
        ...
        def snapmirror_transfer_show(
            relationship_uuid,
            archive_retrieval_priority: Choices.define(_get_field_list("archive_retrieval_priority"), cache_choices=True, inexact=True)=None,
            ...
            snapshot_retention_period: Choices.define(_get_field_list("snapshot_retention_period"), cache_choices=True, inexact=True)=None,
            ...
            fields: List[Choices.define(["archive_retrieval_priority", "bytes_transferred", "checkpoint_size", "end_time", "snapshot", "snapshot_retention_period", "source_snapshot", "state", "storage_efficiency_enabled", "throttle", "total_duration", "uuid", "*"])]=None,
        ) -> ResourceTable:
            """Fetch a list of SnapmirrorTransfer resources

            Args:
                archive_retrieval_priority: This is supported for transfer of restore relationship only. Priority level at which objects are restored from the archival storage. The value can be high, standard or low. The cloud provider's lowest priority will be used as the default. It is only supported for object store SnapMirror relationships. If the objects were not archived, the property will be ignored.
                ...
                snapshot_retention_period: Specifies the duration for which the Snapshot copy specified in the 'source_snapshot' property is locked in the object store. The retention period value represents a duration and must be specified in the ISO-8601 duration format. The retention period can be in years, months, or days. A period specified for years, months, or days is represented in the ISO-8601 format as \"P<num>Y\", \"P<num>M\", or \"P<num>D\" respectively. For example, \"P10Y\" represents a duration of 10 years. The period string must contain only a single time element, that is, either years, months, or days. A duration which combines different periods is not supported, for example \"P1Y10M\" is not supported. Years, if specified, must be less than or equal to 100. Months, if specified, must be less than or equal to 1200. Days, if specified, must be between and including 30 and 36500. This property is valid only if the 'source_snapshot' property is specified and when the property 'snapshot_lock_mode' in the policy associated with the SnapMirror relationship is set to enterprise or compliance. If this property is not specified and the source Snapshot copy being transferred does not match a policy rule, then a default retention period of \"P30D\" is set. This property is supported only for non-restore transfers and for object store SnapMirror relationships.
            ...
            kwargs = {}
            if archive_retrieval_priority is not None:
                kwargs["archive_retrieval_priority"] = archive_retrieval_priority
            ...
            if snapshot_retention_period is not None:
                kwargs["snapshot_retention_period"] = snapshot_retention_period
...
"""
    ...
    if RECLINE_INSTALLED:
        ...
        async def snapmirror_transfer_create(
            relationship_uuid,
            links: dict = None,
            archive_retrieval_priority: str = None,
            ...
            snapshot: str = None,
            snapshot_retention_period: str = None,
...
"""
    ...
    if RECLINE_INSTALLED:
        ...
        async def snapmirror_transfer_modify(
            relationship_uuid,
            archive_retrieval_priority: str = None,
            query_archive_retrieval_priority: str = None,
            bytes_transferred: Size = None,
            ...
            snapshot_retention_period: str = None,
            query_snapshot_retention_period: str = None,
            source_snapshot: str = None,
            ...
            Args:
                archive_retrieval_priority: This is supported for transfer of restore relationship only. Priority level at which objects are restored from the archival storage. The value can be high, standard or low. The cloud provider's lowest priority will be used as the default. It is only supported for object store SnapMirror relationships. If the objects were not archived, the property will be ignored.
                query_archive_retrieval_priority: This is supported for transfer of restore relationship only. Priority level at which objects are restored from the archival storage. The value can be high, standard or low. The cloud provider's lowest priority will be used as the default. It is only supported for object store SnapMirror relationships. If the objects were not archived, the property will be ignored.
                bytes_transferred: Bytes transferred
                ...
                snapshot_retention_period: Specifies the duration for which the Snapshot copy specified in the 'source_snapshot' property is locked in the object store. The retention period value represents a duration and must be specified in the ISO-8601 duration format. The retention period can be in years, months, or days. A period specified for years, months, or days is represented in the ISO-8601 format as \"P<num>Y\", \"P<num>M\", or \"P<num>D\" respectively. For example, \"P10Y\" represents a duration of 10 years. The period string must contain only a single time element, that is, either years, months, or days. A duration which combines different periods is not supported, for example \"P1Y10M\" is not supported. Years, if specified, must be less than or equal to 100. Months, if specified, must be less than or equal to 1200. Days, if specified, must be between and including 30 and 36500. This property is valid only if the 'source_snapshot' property is specified and when the property 'snapshot_lock_mode' in the policy associated with the SnapMirror relationship is set to enterprise or compliance. If this property is not specified and the source Snapshot copy being transferred does not match a policy rule, then a default retention period of \"P30D\" is set. This property is supported only for non-restore transfers and for object store SnapMirror relationships.
                query_snapshot_retention_period: Specifies the duration for which the Snapshot copy specified in the 'source_snapshot' property is locked in the object store. The retention period value represents a duration and must be specified in the ISO-8601 duration format. The retention period can be in years, months, or days. A period specified for years, months, or days is represented in the ISO-8601 format as \"P<num>Y\", \"P<num>M\", or \"P<num>D\" respectively. For example, \"P10Y\" represents a duration of 10 years. The period string must contain only a single time element, that is, either years, months, or days. A duration which combines different periods is not supported, for example \"P1Y10M\" is not supported. Years, if specified, must be less than or equal to 100. Months, if specified, must be less than or equal to 1200. Days, if specified, must be between and including 30 and 36500. This property is valid only if the 'source_snapshot' property is specified and when the property 'snapshot_lock_mode' in the policy associated with the SnapMirror relationship is set to enterprise or compliance. If this property is not specified and the source Snapshot copy being transferred does not match a policy rule, then a default retention period of \"P30D\" is set. This property is supported only for non-restore transfers and for object store SnapMirror relationships.
                source_snapshot: Specifies the Snapshot copy on the source to be transferred to the destination.
            ...
            kwargs = {}
            changes = {}
            if query_archive_retrieval_priority is not None:
                kwargs["archive_retrieval_priority"] = query_archive_retrieval_priority
            ...
            if query_snapshot_retention_period is not None:
                kwargs["snapshot_retention_period"] = query_snapshot_retention_period
            ...
            if archive_retrieval_priority is not None:
                changes["archive_retrieval_priority"] = archive_retrieval_priority
            if bytes_transferred is not None:
            ...
            if snapshot_retention_period is not None:
                changes["snapshot_retention_period"] = snapshot_retention_period
            if source_snapshot is not None:
