...
__all__ = ["XcConsistencyGroupResponseRecordsConsistencyGroupsVolumes", "XcConsistencyGroupResponseRecordsConsistencyGroupsVolumesSchema"]
__pdoc__ = {
    "XcConsistencyGroupResponseRecordsConsistencyGroupsVolumesSchema.resource": False,
    "XcConsistencyGroupResponseRecordsConsistencyGroupsVolumesSchema.opts": False,
    "XcConsistencyGroupResponseRecordsConsistencyGroupsVolumes": False,
}


class XcConsistencyGroupResponseRecordsConsistencyGroupsVolumesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
...
Example: vol_cs_dept """
    ...
    r""" The provisioning_options field of the xc_consistency_group_response_records_consistency_groups_volumes. """

    qos = fields.Nested("netapp_ontap.models.consistency_group_qos.ConsistencyGroupQosSchema", unknown=EXCLUDE, data_key="qos")
    r""" The qos field of the xc_consistency_group_response_records_consistency_groups_volumes. """
    ...
    r""" The space field of the xc_consistency_group_response_records_consistency_groups_volumes. """
    ...
    r""" The tiering field of the xc_consistency_group_response_records_consistency_groups_volumes. """
...
Example: 028baa66-41bd-11e9-81d5-00a0986138f7 """
    ...
    @property
    def resource(self):
        return XcConsistencyGroupResponseRecordsConsistencyGroupsVolumes
    ...
    """comment,language,name,qos,snapshot_policy.links,snapshot_policy.name,snapshot_policy.uuid,space,tiering,uuid,"""
    ...
    """comment,name,provisioning_options,qos,snapshot_policy.name,snapshot_policy.uuid,space,tiering,"""
    ...
    """comment,language,name,provisioning_options,qos,snapshot_policy.name,snapshot_policy.uuid,space,tiering,"""


class XcConsistencyGroupResponseRecordsConsistencyGroupsVolumes(Resource):

    _schema = XcConsistencyGroupResponseRecordsConsistencyGroupsVolumesSchema
