...
* windows """
    ...
    subsystem_map = fields.List(fields.Nested("netapp_ontap.models.consistency_group_namespace_subsystem_map1.ConsistencyGroupNamespaceSubsystemMap1Schema", unknown=EXCLUDE), data_key="subsystem_map")
