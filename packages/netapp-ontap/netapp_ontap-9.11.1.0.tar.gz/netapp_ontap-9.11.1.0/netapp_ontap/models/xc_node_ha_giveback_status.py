...
__all__ = ["XcNodeHaGivebackStatus", "XcNodeHaGivebackStatusSchema"]
__pdoc__ = {
    "XcNodeHaGivebackStatusSchema.resource": False,
    "XcNodeHaGivebackStatusSchema.opts": False,
    "XcNodeHaGivebackStatus": False,
}


class XcNodeHaGivebackStatusSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcNodeHaGivebackStatus object"""

    aggregate = fields.Nested("netapp_ontap.resources.aggregate.AggregateSchema", unknown=EXCLUDE, data_key="aggregate")
    r""" The aggregate field of the xc_node_ha_giveback_status. """
    ...
    r""" The error field of the xc_node_ha_giveback_status. """
...
class XcNodeHaGivebackStatus(Resource):

    _schema = XcNodeHaGivebackStatusSchema
