...
* windows """
    ...
    subsystem_map = fields.List(fields.Nested("netapp_ontap.models.consistency_group_consistency_groups_namespaces_subsystem_map.ConsistencyGroupConsistencyGroupsNamespacesSubsystemMapSchema", unknown=EXCLUDE), data_key="subsystem_map")
