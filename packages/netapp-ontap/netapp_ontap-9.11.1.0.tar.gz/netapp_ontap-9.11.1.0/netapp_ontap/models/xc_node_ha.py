...
__all__ = ["XcNodeHa", "XcNodeHaSchema"]
__pdoc__ = {
    "XcNodeHaSchema.resource": False,
    "XcNodeHaSchema.opts": False,
    "XcNodeHa": False,
}


class XcNodeHaSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcNodeHa object"""
    ...
    giveback = fields.Nested("netapp_ontap.models.xc_node_ha_giveback.XcNodeHaGivebackSchema", unknown=EXCLUDE, data_key="giveback")
    r""" The giveback field of the xc_node_ha. """
    ...
    r""" The interconnect field of the xc_node_ha. """

    partners = fields.List(fields.Nested("netapp_ontap.models.xc_cluster_nodes_ha_partners.XcClusterNodesHaPartnersSchema", unknown=EXCLUDE), data_key="partners")
    ...
    r""" The ports field of the xc_node_ha. """
    ...
    r""" The takeover field of the xc_node_ha. """
...
class XcNodeHa(Resource):

    _schema = XcNodeHaSchema
