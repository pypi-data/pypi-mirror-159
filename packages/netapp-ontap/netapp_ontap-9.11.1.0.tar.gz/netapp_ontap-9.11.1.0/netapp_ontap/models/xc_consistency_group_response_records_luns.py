...
__all__ = ["XcConsistencyGroupResponseRecordsLuns", "XcConsistencyGroupResponseRecordsLunsSchema"]
__pdoc__ = {
    "XcConsistencyGroupResponseRecordsLunsSchema.resource": False,
    "XcConsistencyGroupResponseRecordsLunsSchema.opts": False,
    "XcConsistencyGroupResponseRecordsLuns": False,
}


class XcConsistencyGroupResponseRecordsLunsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcConsistencyGroupResponseRecordsLuns object"""
    ...
    r""" The clone field of the xc_consistency_group_response_records_luns. """
...
Example: 2018-06-04T19:00:00Z """
    ...
    lun_maps = fields.List(fields.Nested("netapp_ontap.models.xc_consistency_group_response_records_consistency_groups_luns_lun_maps.XcConsistencyGroupResponseRecordsConsistencyGroupsLunsLunMapsSchema", unknown=EXCLUDE), data_key="lun_maps")
...
* xen """
    ...
    r""" The provisioning_options field of the xc_consistency_group_response_records_luns. """

    qos = fields.Nested("netapp_ontap.models.consistency_group_qos.ConsistencyGroupQosSchema", unknown=EXCLUDE, data_key="qos")
    r""" The qos field of the xc_consistency_group_response_records_luns. """
    ...
    r""" The space field of the xc_consistency_group_response_records_luns. """
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    @property
    def resource(self):
        return XcConsistencyGroupResponseRecordsLuns
...
class XcConsistencyGroupResponseRecordsLuns(Resource):

    _schema = XcConsistencyGroupResponseRecordsLunsSchema
