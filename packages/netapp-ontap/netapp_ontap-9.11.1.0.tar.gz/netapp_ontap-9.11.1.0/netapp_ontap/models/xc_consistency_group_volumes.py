...
__all__ = ["XcConsistencyGroupVolumes", "XcConsistencyGroupVolumesSchema"]
__pdoc__ = {
    "XcConsistencyGroupVolumesSchema.resource": False,
    "XcConsistencyGroupVolumesSchema.opts": False,
    "XcConsistencyGroupVolumes": False,
}


class XcConsistencyGroupVolumesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcConsistencyGroupVolumes object"""
...
Example: vol_cs_dept """
    ...
    r""" The provisioning_options field of the xc_consistency_group_volumes. """

    qos = fields.Nested("netapp_ontap.models.consistency_group_qos.ConsistencyGroupQosSchema", unknown=EXCLUDE, data_key="qos")
    r""" The qos field of the xc_consistency_group_volumes. """
    ...
    r""" The space field of the xc_consistency_group_volumes. """
    ...
    r""" The tiering field of the xc_consistency_group_volumes. """
...
Example: 028baa66-41bd-11e9-81d5-00a0986138f7 """
    ...
    @property
    def resource(self):
        return XcConsistencyGroupVolumes
...
class XcConsistencyGroupVolumes(Resource):

    _schema = XcConsistencyGroupVolumesSchema
