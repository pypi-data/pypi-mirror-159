...
__all__ = ["XcConsistencyGroupConsistencyGroups", "XcConsistencyGroupConsistencyGroupsSchema"]
__pdoc__ = {
    "XcConsistencyGroupConsistencyGroupsSchema.resource": False,
    "XcConsistencyGroupConsistencyGroupsSchema.opts": False,
    "XcConsistencyGroupConsistencyGroups": False,
}


class XcConsistencyGroupConsistencyGroupsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcConsistencyGroupConsistencyGroups object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", unknown=EXCLUDE, data_key="_links")
    r""" The links field of the xc_consistency_group_consistency_groups. """
...
An NVMe namespace must be mapped to an NVMe subsystem to grant access to the subsystem's hosts. Hosts can then access the NVMe namespace and perform I/O using the NVMe over Fabrics protocol. """
    ...
    r""" The parent_consistency_group field of the xc_consistency_group_consistency_groups. """
    ...
    r""" The provisioning_options field of the xc_consistency_group_consistency_groups. """

    qos = fields.Nested("netapp_ontap.models.consistency_group_qos.ConsistencyGroupQosSchema", unknown=EXCLUDE, data_key="qos")
    r""" The qos field of the xc_consistency_group_consistency_groups. """
    ...
    r""" The restore_to field of the xc_consistency_group_consistency_groups. """
...
This is the dedicated consistency group Snapshot copy policy, not an aggregation of the volume granular Snapshot copy policy. """
    ...
    r""" The space field of the xc_consistency_group_consistency_groups. """

    svm = fields.Nested("netapp_ontap.resources.svm.SvmSchema", unknown=EXCLUDE, data_key="svm")
    r""" The svm field of the xc_consistency_group_consistency_groups. """
    ...
    r""" The tiering field of the xc_consistency_group_consistency_groups. """
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    volumes = fields.List(fields.Nested("netapp_ontap.models.consistency_group_response_records_volumes.ConsistencyGroupResponseRecordsVolumesSchema", unknown=EXCLUDE), data_key="volumes")
...
The total number of volumes across all child consistency groups contained in a consistency group is constrained by the same limit. """
    ...
    @property
    def resource(self):
        return XcConsistencyGroupConsistencyGroups
...
class XcConsistencyGroupConsistencyGroups(Resource):

    _schema = XcConsistencyGroupConsistencyGroupsSchema
