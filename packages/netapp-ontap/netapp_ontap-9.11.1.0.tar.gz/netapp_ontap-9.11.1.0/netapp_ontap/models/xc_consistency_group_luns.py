...
__all__ = ["XcConsistencyGroupLuns", "XcConsistencyGroupLunsSchema"]
__pdoc__ = {
    "XcConsistencyGroupLunsSchema.resource": False,
    "XcConsistencyGroupLunsSchema.opts": False,
    "XcConsistencyGroupLuns": False,
}


class XcConsistencyGroupLunsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcConsistencyGroupLuns object"""
    ...
    r""" The clone field of the xc_consistency_group_luns. """
...
Example: 2018-06-04T19:00:00Z """
    ...
    lun_maps = fields.List(fields.Nested("netapp_ontap.models.xc_consistency_group_consistency_groups_luns_lun_maps.XcConsistencyGroupConsistencyGroupsLunsLunMapsSchema", unknown=EXCLUDE), data_key="lun_maps")
...
* xen """
    ...
    r""" The space field of the xc_consistency_group_luns. """
...
class XcConsistencyGroupLuns(Resource):

    _schema = XcConsistencyGroupLunsSchema
