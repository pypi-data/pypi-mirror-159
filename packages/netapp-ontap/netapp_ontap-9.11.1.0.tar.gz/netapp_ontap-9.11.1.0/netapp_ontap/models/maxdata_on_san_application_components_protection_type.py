...
__pdoc__ = {
    ...
    "MaxdataOnSanApplicationComponentsProtectionTypeSchema.opts": False,
    "MaxdataOnSanApplicationComponentsProtectionType": False,
}


class MaxdataOnSanApplicationComponentsProtectionTypeSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
