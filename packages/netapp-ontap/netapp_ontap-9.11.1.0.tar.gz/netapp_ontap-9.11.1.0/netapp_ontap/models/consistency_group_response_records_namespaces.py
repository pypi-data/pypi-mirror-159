...
* windows """
    ...
    subsystem_map = fields.List(fields.Nested("netapp_ontap.models.consistency_group_response_records_consistency_groups_namespaces_subsystem_map.ConsistencyGroupResponseRecordsConsistencyGroupsNamespacesSubsystemMapSchema", unknown=EXCLUDE), data_key="subsystem_map")
