...
__all__ = ["XcConsistencyGroupNamespaces", "XcConsistencyGroupNamespacesSchema"]
__pdoc__ = {
    "XcConsistencyGroupNamespacesSchema.resource": False,
    "XcConsistencyGroupNamespacesSchema.opts": False,
    "XcConsistencyGroupNamespaces": False,
}


class XcConsistencyGroupNamespacesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcConsistencyGroupNamespaces object"""
...
* windows """
    ...
    r""" The provisioning_options field of the xc_consistency_group_namespaces. """

    subsystem_map = fields.List(fields.Nested("netapp_ontap.models.xc_consistency_group_consistency_groups_namespaces_subsystem_map.XcConsistencyGroupConsistencyGroupsNamespacesSubsystemMapSchema", unknown=EXCLUDE), data_key="subsystem_map")
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    @property
    def resource(self):
        return XcConsistencyGroupNamespaces
...
class XcConsistencyGroupNamespaces(Resource):

    _schema = XcConsistencyGroupNamespacesSchema
