...
__all__ = ["XcLicensePackageLicenses", "XcLicensePackageLicensesSchema"]
__pdoc__ = {
    "XcLicensePackageLicensesSchema.resource": False,
    "XcLicensePackageLicensesSchema.opts": False,
    "XcLicensePackageLicenses": False,
}


class XcLicensePackageLicensesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcLicensePackageLicenses object"""
    ...
    r""" The capacity field of the xc_license_package_licenses. """
    ...
    r""" The compliance field of the xc_license_package_licenses. """
...
Example: 2019-02-02T19:00:00Z """
    ...
    @property
    def resource(self):
        return XcLicensePackageLicenses
...
class XcLicensePackageLicenses(Resource):

    _schema = XcLicensePackageLicensesSchema
