...
Example: 1 """
    ...
    holes = fields.List(fields.Nested("netapp_ontap.models.file_hole.FileHoleSchema", unknown=EXCLUDE), data_key="holes")
    r""" List of hole ranges in the file. """
...
Example: 755 """
    ...
    """links,accessed_time,analytics,bytes_used,changed_time,constituent,creation_time,fill_enabled,group_id,hard_links_count,holes,inode_generation,inode_number,is_empty,is_junction,is_snapshot,is_vm_aligned,modified_time,name,overwrite_enabled,owner_id,path,qos_policy,size,target,type,unique_bytes,unix_permissions,volume.links,volume.name,volume.uuid,"""
    ...
    """analytics,constituent,fill_enabled,holes,is_empty,name,overwrite_enabled,path,qos_policy,size,target,unix_permissions,volume.name,volume.uuid,"""
    ...
    """analytics,constituent,holes,is_empty,name,path,target,type,unix_permissions,volume.name,volume.uuid,"""
    ...
    if RECLINE_INSTALLED:
        ...
        async def file_info_create(
            ...
            Args:
                ...
                group_id: The integer ID of the group of the file owner.
                hard_links_count: The number of hard links to the file.
                holes: List of hole ranges in the file.
                inode_generation: Inode generation number.
                inode_number: The file inode number.
                is_empty: Specifies whether or not a directory is empty. A directory is considered empty if it only contains entries for \".\" and \"..\". This element is present if the file is a directory. In some special error cases, such as when the volume goes offline or when the directory is moved while retrieving this info, this field might not get set.
                is_junction: Returns \"true\" if the directory is a junction.
