    ...
    if RECLINE_INSTALLED:
        ...
        async def node_modify(
            ...
            Args:
                ...
                is_all_flash_optimized: Specifies whether the node is all flash optimized.
                query_is_all_flash_optimized: Specifies whether the node is all flash optimized.
                is_all_flash_select_optimized: Specifies whether the node is all flash select optimized.
                query_is_all_flash_select_optimized: Specifies whether the node is all flash select optimized.
                is_capacity_optimized: Specifies whether the node is capacity optimized.
                query_is_capacity_optimized: Specifies whether the node is capacity optimized.
                is_performance_optimized: Specifies whether the node is performance optimized.
                query_is_performance_optimized: Specifies whether the node is performance optimized.
                is_spares_low: Specifies whether or not the node is in spares low condition.
            ...
            if query_is_all_flash_optimized is not None:
                kwargs["is_all_flash_optimized"] = query_is_all_flash_optimized
            if query_is_all_flash_select_optimized is not None:
                kwargs["is_all_flash_select_optimized"] = query_is_all_flash_select_optimized
            if query_is_capacity_optimized is not None:
                kwargs["is_capacity_optimized"] = query_is_capacity_optimized
            if query_is_performance_optimized is not None:
                kwargs["is_performance_optimized"] = query_is_performance_optimized
            ...
            if date is not None:
                changes["date"] = date
            if is_all_flash_optimized is not None:
                changes["is_all_flash_optimized"] = is_all_flash_optimized
            if is_all_flash_select_optimized is not None:
                changes["is_all_flash_select_optimized"] = is_all_flash_select_optimized
            if is_capacity_optimized is not None:
                changes["is_capacity_optimized"] = is_capacity_optimized
            if is_performance_optimized is not None:
                changes["is_performance_optimized"] = is_performance_optimized
            if is_spares_low is not None:
