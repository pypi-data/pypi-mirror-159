...
class EmsEventSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    r""" The action field of the ems_event. """
...
Example: 1 """
    ...
    parameters = fields.List(fields.Nested("netapp_ontap.models.ems_alert_response_records_parameters.EmsAlertResponseRecordsParametersSchema", unknown=EXCLUDE), data_key="parameters")
