...
__all__ = ["XcConsistencyGroupConsistencyGroupsNamespaces", "XcConsistencyGroupConsistencyGroupsNamespacesSchema"]
__pdoc__ = {
    "XcConsistencyGroupConsistencyGroupsNamespacesSchema.resource": False,
    "XcConsistencyGroupConsistencyGroupsNamespacesSchema.opts": False,
    "XcConsistencyGroupConsistencyGroupsNamespaces": False,
}


class XcConsistencyGroupConsistencyGroupsNamespacesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcConsistencyGroupConsistencyGroupsNamespaces object"""
...
* windows """
    ...
    r""" The provisioning_options field of the xc_consistency_group_consistency_groups_namespaces. """

    subsystem_map = fields.List(fields.Nested("netapp_ontap.models.consistency_group_response_records_namespaces_subsystem_map.ConsistencyGroupResponseRecordsNamespacesSubsystemMapSchema", unknown=EXCLUDE), data_key="subsystem_map")
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    @property
    def resource(self):
        return XcConsistencyGroupConsistencyGroupsNamespaces
...
class XcConsistencyGroupConsistencyGroupsNamespaces(Resource):

    _schema = XcConsistencyGroupConsistencyGroupsNamespacesSchema
