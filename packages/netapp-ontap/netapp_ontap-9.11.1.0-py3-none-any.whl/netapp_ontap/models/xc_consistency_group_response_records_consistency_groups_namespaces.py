...
__all__ = ["XcConsistencyGroupResponseRecordsConsistencyGroupsNamespaces", "XcConsistencyGroupResponseRecordsConsistencyGroupsNamespacesSchema"]
__pdoc__ = {
    "XcConsistencyGroupResponseRecordsConsistencyGroupsNamespacesSchema.resource": False,
    "XcConsistencyGroupResponseRecordsConsistencyGroupsNamespacesSchema.opts": False,
    "XcConsistencyGroupResponseRecordsConsistencyGroupsNamespaces": False,
}


class XcConsistencyGroupResponseRecordsConsistencyGroupsNamespacesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
...
* windows """
    ...
    r""" The provisioning_options field of the xc_consistency_group_response_records_consistency_groups_namespaces. """

    subsystem_map = fields.List(fields.Nested("netapp_ontap.models.xc_consistency_group_namespaces_subsystem_map.XcConsistencyGroupNamespacesSubsystemMapSchema", unknown=EXCLUDE), data_key="subsystem_map")
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    @property
    def resource(self):
        return XcConsistencyGroupResponseRecordsConsistencyGroupsNamespaces
    ...
    """auto_delete,comment,create_time,enabled,name,os_type,subsystem_map,uuid,"""
    ...
    """auto_delete,comment,provisioning_options,subsystem_map,"""
    ...
    """auto_delete,comment,name,os_type,provisioning_options,subsystem_map,"""


class XcConsistencyGroupResponseRecordsConsistencyGroupsNamespaces(Resource):

    _schema = XcConsistencyGroupResponseRecordsConsistencyGroupsNamespacesSchema
