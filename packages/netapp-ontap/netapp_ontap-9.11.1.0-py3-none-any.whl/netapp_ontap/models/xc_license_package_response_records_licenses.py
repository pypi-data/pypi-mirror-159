...
__all__ = ["XcLicensePackageResponseRecordsLicenses", "XcLicensePackageResponseRecordsLicensesSchema"]
__pdoc__ = {
    "XcLicensePackageResponseRecordsLicensesSchema.resource": False,
    "XcLicensePackageResponseRecordsLicensesSchema.opts": False,
    "XcLicensePackageResponseRecordsLicenses": False,
}


class XcLicensePackageResponseRecordsLicensesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcLicensePackageResponseRecordsLicenses object"""
    ...
    r""" The capacity field of the xc_license_package_response_records_licenses. """
    ...
    r""" The compliance field of the xc_license_package_response_records_licenses. """
...
Example: 2019-02-02T19:00:00Z """
    ...
    @property
    def resource(self):
        return XcLicensePackageResponseRecordsLicenses
...
class XcLicensePackageResponseRecordsLicenses(Resource):

    _schema = XcLicensePackageResponseRecordsLicensesSchema
