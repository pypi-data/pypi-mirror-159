...
__all__ = ["XcClusterNodesHaGivebackStatus", "XcClusterNodesHaGivebackStatusSchema"]
__pdoc__ = {
    "XcClusterNodesHaGivebackStatusSchema.resource": False,
    "XcClusterNodesHaGivebackStatusSchema.opts": False,
    "XcClusterNodesHaGivebackStatus": False,
}


class XcClusterNodesHaGivebackStatusSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcClusterNodesHaGivebackStatus object"""

    aggregate = fields.Nested("netapp_ontap.resources.aggregate.AggregateSchema", unknown=EXCLUDE, data_key="aggregate")
    r""" The aggregate field of the xc_cluster_nodes_ha_giveback_status. """
    ...
    r""" The error field of the xc_cluster_nodes_ha_giveback_status. """
...
* running_checks """
    ...
    @property
    def resource(self):
        return XcClusterNodesHaGivebackStatus
...
class XcClusterNodesHaGivebackStatus(Resource):

    _schema = XcClusterNodesHaGivebackStatusSchema
