...
__all__ = ["CapacityPoolWithOptionalNodeSerialsNodes", "CapacityPoolWithOptionalNodeSerialsNodesSchema"]
__pdoc__ = {
    "CapacityPoolWithOptionalNodeSerialsNodesSchema.resource": False,
    "CapacityPoolWithOptionalNodeSerialsNodesSchema.opts": False,
    "CapacityPoolWithOptionalNodeSerialsNodes": False,
}


class CapacityPoolWithOptionalNodeSerialsNodesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
...
Example: 99939000010000000011 """
    ...
    r""" The node field of the capacity_pool_with_optional_node_serials_nodes. """

    @property
    def resource(self):
        return CapacityPoolWithOptionalNodeSerialsNodes
...
class CapacityPoolWithOptionalNodeSerialsNodes(Resource):

    _schema = CapacityPoolWithOptionalNodeSerialsNodesSchema
