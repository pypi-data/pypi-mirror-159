...
__all__ = ["XcConsistencyGroupConsistencyGroupsVolumes", "XcConsistencyGroupConsistencyGroupsVolumesSchema"]
__pdoc__ = {
    "XcConsistencyGroupConsistencyGroupsVolumesSchema.resource": False,
    "XcConsistencyGroupConsistencyGroupsVolumesSchema.opts": False,
    "XcConsistencyGroupConsistencyGroupsVolumes": False,
}


class XcConsistencyGroupConsistencyGroupsVolumesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcConsistencyGroupConsistencyGroupsVolumes object"""
...
Example: vol_cs_dept """
    ...
    r""" The provisioning_options field of the xc_consistency_group_consistency_groups_volumes. """

    qos = fields.Nested("netapp_ontap.models.consistency_group_qos.ConsistencyGroupQosSchema", unknown=EXCLUDE, data_key="qos")
    r""" The qos field of the xc_consistency_group_consistency_groups_volumes. """
    ...
    r""" The space field of the xc_consistency_group_consistency_groups_volumes. """
    ...
    r""" The tiering field of the xc_consistency_group_consistency_groups_volumes. """
...
Example: 028baa66-41bd-11e9-81d5-00a0986138f7 """
    ...
    @property
    def resource(self):
        return XcConsistencyGroupConsistencyGroupsVolumes
...
class XcConsistencyGroupConsistencyGroupsVolumes(Resource):

    _schema = XcConsistencyGroupConsistencyGroupsVolumesSchema
