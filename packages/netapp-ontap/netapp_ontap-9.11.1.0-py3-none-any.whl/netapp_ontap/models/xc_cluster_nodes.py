...
__all__ = ["XcClusterNodes", "XcClusterNodesSchema"]
__pdoc__ = {
    "XcClusterNodesSchema.resource": False,
    "XcClusterNodesSchema.opts": False,
    "XcClusterNodes": False,
}


class XcClusterNodesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcClusterNodes object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", unknown=EXCLUDE, data_key="_links")
    r""" The links field of the xc_cluster_nodes. """
    ...
    r""" The cluster_interface field of the xc_cluster_nodes. """

    cluster_interfaces = fields.List(fields.Nested("netapp_ontap.models.node_response_records_management_interfaces.NodeResponseRecordsManagementInterfacesSchema", unknown=EXCLUDE), data_key="cluster_interfaces")
    r""" The cluster_interfaces field of the xc_cluster_nodes. """
    ...
    r""" The controller field of the xc_cluster_nodes. """
...
Example: 2019-04-17T11:49:26-04:00 """
    ...
    r""" The external_cache field of the xc_cluster_nodes. """

    ha = fields.Nested("netapp_ontap.models.xc_cluster_nodes_ha.XcClusterNodesHaSchema", unknown=EXCLUDE, data_key="ha")
    r""" The ha field of the xc_cluster_nodes. """

    hw_assist = fields.Nested("netapp_ontap.models.hw_assist.HwAssistSchema", unknown=EXCLUDE, data_key="hw_assist")
    r""" The hw_assist field of the xc_cluster_nodes. """
    ...
    r""" The location field of the xc_cluster_nodes.
...
Example: rack 2 row 5 """
    ...
    r""" The management_interface field of the xc_cluster_nodes. """

    management_interfaces = fields.List(fields.Nested("netapp_ontap.models.node_response_records_management_interfaces.NodeResponseRecordsManagementInterfacesSchema", unknown=EXCLUDE), data_key="management_interfaces")
    r""" The management_interfaces field of the xc_cluster_nodes. """
...
* member """
    ...
    r""" The metric field of the xc_cluster_nodes. """
    ...
    r""" The metrocluster field of the xc_cluster_nodes. """

    model = fields.Str(data_key="model")
    r""" The model field of the xc_cluster_nodes.

Example: FAS3070 """

    name = fields.Str(data_key="name")
    r""" The name field of the xc_cluster_nodes.

Example: node-01 """

    nvram = fields.Nested("netapp_ontap.models.cluster_nodes_nvram.ClusterNodesNvramSchema", unknown=EXCLUDE, data_key="nvram")
    r""" The nvram field of the xc_cluster_nodes. """
...
Example: Example Corp """
    ...
    r""" The serial_number field of the xc_cluster_nodes.
...
Example: 4048820-60-9 """
    ...
    r""" The service_processor field of the xc_cluster_nodes. """
...
* unknown """
    ...
    r""" The statistics field of the xc_cluster_nodes. """
...
* quad_path_ha """
    ...
    r""" The system_id field of the xc_cluster_nodes.
...
Example: 300536 """
    ...
    r""" The uuid field of the xc_cluster_nodes.
...
Example: 791603000068 """
    ...
    r""" The version field of the xc_cluster_nodes. """

    vm = fields.Nested("netapp_ontap.models.cluster_nodes_vm.ClusterNodesVmSchema", unknown=EXCLUDE, data_key="vm")
    r""" The vm field of the xc_cluster_nodes. """

    @property
    def resource(self):
        return XcClusterNodes
...
class XcClusterNodes(Resource):

    _schema = XcClusterNodesSchema
