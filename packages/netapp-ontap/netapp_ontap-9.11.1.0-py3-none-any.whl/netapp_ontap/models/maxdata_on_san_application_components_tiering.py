...
__pdoc__ = {
    ...
    "MaxdataOnSanApplicationComponentsTieringSchema.opts": False,
    "MaxdataOnSanApplicationComponentsTiering": False,
}


class MaxdataOnSanApplicationComponentsTieringSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
