...
__all__ = ["XcNodeResponseRecords", "XcNodeResponseRecordsSchema"]
__pdoc__ = {
    "XcNodeResponseRecordsSchema.resource": False,
    "XcNodeResponseRecordsSchema.opts": False,
    "XcNodeResponseRecords": False,
}


class XcNodeResponseRecordsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcNodeResponseRecords object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", unknown=EXCLUDE, data_key="_links")
    r""" The links field of the xc_node_response_records. """
    ...
    r""" The cluster_interface field of the xc_node_response_records. """

    cluster_interfaces = fields.List(fields.Nested("netapp_ontap.models.xc_node_management_interfaces.XcNodeManagementInterfacesSchema", unknown=EXCLUDE), data_key="cluster_interfaces")
    r""" The cluster_interfaces field of the xc_node_response_records. """
    ...
    r""" The controller field of the xc_node_response_records. """
...
Example: 2019-04-17T11:49:26-04:00 """
    ...
    r""" The external_cache field of the xc_node_response_records. """

    ha = fields.Nested("netapp_ontap.models.xc_node_response_records_ha.XcNodeResponseRecordsHaSchema", unknown=EXCLUDE, data_key="ha")
    r""" The ha field of the xc_node_response_records. """

    hw_assist = fields.Nested("netapp_ontap.models.hw_assist.HwAssistSchema", unknown=EXCLUDE, data_key="hw_assist")
    r""" The hw_assist field of the xc_node_response_records. """

    is_all_flash_optimized = fields.Boolean(data_key="is_all_flash_optimized")
    r""" Specifies whether the node is all flash optimized. """

    is_all_flash_select_optimized = fields.Boolean(data_key="is_all_flash_select_optimized")
    r""" Specifies whether the node is all flash select optimized. """

    is_capacity_optimized = fields.Boolean(data_key="is_capacity_optimized")
    r""" Specifies whether the node is capacity optimized. """

    is_performance_optimized = fields.Boolean(data_key="is_performance_optimized")
    ...
    r""" The location field of the xc_node_response_records.
...
Example: rack 2 row 5 """
    ...
    r""" The management_interface field of the xc_node_response_records. """

    management_interfaces = fields.List(fields.Nested("netapp_ontap.models.xc_node_management_interfaces.XcNodeManagementInterfacesSchema", unknown=EXCLUDE), data_key="management_interfaces")
    r""" The management_interfaces field of the xc_node_response_records. """
...
* member """
    ...
    r""" The metric field of the xc_node_response_records. """
    ...
    r""" The metrocluster field of the xc_node_response_records. """

    model = fields.Str(data_key="model")
    r""" The model field of the xc_node_response_records.

Example: FAS3070 """

    name = fields.Str(data_key="name")
    r""" The name field of the xc_node_response_records.

Example: node-01 """

    nvram = fields.Nested("netapp_ontap.models.cluster_nodes_nvram.ClusterNodesNvramSchema", unknown=EXCLUDE, data_key="nvram")
    r""" The nvram field of the xc_node_response_records. """
...
Example: Example Corp """
    ...
    r""" The serial_number field of the xc_node_response_records.
...
Example: 4048820-60-9 """
    ...
    r""" The service_processor field of the xc_node_response_records. """
...
* unknown """
    ...
    r""" The statistics field of the xc_node_response_records. """
...
* quad_path_ha """
    ...
    r""" The system_id field of the xc_node_response_records.
...
Example: 300536 """
    ...
    r""" The uuid field of the xc_node_response_records.
...
Example: 791603000068 """
    ...
    r""" The version field of the xc_node_response_records. """

    vm = fields.Nested("netapp_ontap.models.cluster_nodes_vm.ClusterNodesVmSchema", unknown=EXCLUDE, data_key="vm")
    r""" The vm field of the xc_node_response_records. """

    @property
    def resource(self):
        return XcNodeResponseRecords
...
class XcNodeResponseRecords(Resource):

    _schema = XcNodeResponseRecordsSchema
