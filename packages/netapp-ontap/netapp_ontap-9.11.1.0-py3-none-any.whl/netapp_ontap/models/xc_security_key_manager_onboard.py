...
__all__ = ["XcSecurityKeyManagerOnboard", "XcSecurityKeyManagerOnboardSchema"]
__pdoc__ = {
    "XcSecurityKeyManagerOnboardSchema.resource": False,
    "XcSecurityKeyManagerOnboardSchema.opts": False,
    "XcSecurityKeyManagerOnboard": False,
}


class XcSecurityKeyManagerOnboardSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcSecurityKeyManagerOnboard object"""

    enabled = fields.Boolean(data_key="enabled")
    r""" Indicates whether or not the onboard key manager is enabled. """
...
Example: The cluster password of length 32-256 ASCII characters. """
    ...
    @property
    def resource(self):
        return XcSecurityKeyManagerOnboard
...
class XcSecurityKeyManagerOnboard(Resource):

    _schema = XcSecurityKeyManagerOnboardSchema
