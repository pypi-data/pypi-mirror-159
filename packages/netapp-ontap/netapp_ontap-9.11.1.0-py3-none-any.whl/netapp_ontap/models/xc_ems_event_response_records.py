...
__all__ = ["XcEmsEventResponseRecords", "XcEmsEventResponseRecordsSchema"]
__pdoc__ = {
    "XcEmsEventResponseRecordsSchema.resource": False,
    "XcEmsEventResponseRecordsSchema.opts": False,
    "XcEmsEventResponseRecords": False,
}


class XcEmsEventResponseRecordsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcEmsEventResponseRecords object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", unknown=EXCLUDE, data_key="_links")
    r""" The links field of the xc_ems_event_response_records. """

    action = fields.Nested("netapp_ontap.models.ems_alert_action.EmsAlertActionSchema", unknown=EXCLUDE, data_key="action")
    r""" The action field of the xc_ems_event_response_records. """
...
Example: 1 """
    ...
    r""" The message field of the xc_ems_event_response_records. """

    node = fields.Nested("netapp_ontap.resources.node.NodeSchema", unknown=EXCLUDE, data_key="node")
    r""" The node field of the xc_ems_event_response_records. """

    parameters = fields.List(fields.Nested("netapp_ontap.models.xc_ems_event_parameters.XcEmsEventParametersSchema", unknown=EXCLUDE), data_key="parameters")
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    @property
    def resource(self):
        return XcEmsEventResponseRecords
...
class XcEmsEventResponseRecords(Resource):

    _schema = XcEmsEventResponseRecordsSchema
