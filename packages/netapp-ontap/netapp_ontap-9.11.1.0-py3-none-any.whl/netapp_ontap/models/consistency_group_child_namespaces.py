...
* windows """
    ...
    subsystem_map = fields.List(fields.Nested("netapp_ontap.models.consistency_group_namespaces_subsystem_map.ConsistencyGroupNamespacesSubsystemMapSchema", unknown=EXCLUDE), data_key="subsystem_map")
