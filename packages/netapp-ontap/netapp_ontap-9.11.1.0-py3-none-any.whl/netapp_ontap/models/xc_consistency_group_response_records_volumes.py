...
__all__ = ["XcConsistencyGroupResponseRecordsVolumes", "XcConsistencyGroupResponseRecordsVolumesSchema"]
__pdoc__ = {
    "XcConsistencyGroupResponseRecordsVolumesSchema.resource": False,
    "XcConsistencyGroupResponseRecordsVolumesSchema.opts": False,
    "XcConsistencyGroupResponseRecordsVolumes": False,
}


class XcConsistencyGroupResponseRecordsVolumesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcConsistencyGroupResponseRecordsVolumes object"""
...
Example: vol_cs_dept """
    ...
    r""" The provisioning_options field of the xc_consistency_group_response_records_volumes. """

    qos = fields.Nested("netapp_ontap.models.consistency_group_qos.ConsistencyGroupQosSchema", unknown=EXCLUDE, data_key="qos")
    r""" The qos field of the xc_consistency_group_response_records_volumes. """
    ...
    r""" The space field of the xc_consistency_group_response_records_volumes. """
    ...
    r""" The tiering field of the xc_consistency_group_response_records_volumes. """
...
Example: 028baa66-41bd-11e9-81d5-00a0986138f7 """
    ...
    @property
    def resource(self):
        return XcConsistencyGroupResponseRecordsVolumes
...
class XcConsistencyGroupResponseRecordsVolumes(Resource):

    _schema = XcConsistencyGroupResponseRecordsVolumesSchema
