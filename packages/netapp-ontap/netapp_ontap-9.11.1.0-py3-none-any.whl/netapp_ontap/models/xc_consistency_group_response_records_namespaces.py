...
__all__ = ["XcConsistencyGroupResponseRecordsNamespaces", "XcConsistencyGroupResponseRecordsNamespacesSchema"]
__pdoc__ = {
    "XcConsistencyGroupResponseRecordsNamespacesSchema.resource": False,
    "XcConsistencyGroupResponseRecordsNamespacesSchema.opts": False,
    "XcConsistencyGroupResponseRecordsNamespaces": False,
}


class XcConsistencyGroupResponseRecordsNamespacesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the XcConsistencyGroupResponseRecordsNamespaces object"""
...
* windows """
    ...
    r""" The provisioning_options field of the xc_consistency_group_response_records_namespaces. """

    subsystem_map = fields.List(fields.Nested("netapp_ontap.models.xc_consistency_group_response_records_consistency_groups_namespaces_subsystem_map.XcConsistencyGroupResponseRecordsConsistencyGroupsNamespacesSubsystemMapSchema", unknown=EXCLUDE), data_key="subsystem_map")
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    @property
    def resource(self):
        return XcConsistencyGroupResponseRecordsNamespaces
...
class XcConsistencyGroupResponseRecordsNamespaces(Resource):

    _schema = XcConsistencyGroupResponseRecordsNamespacesSchema
