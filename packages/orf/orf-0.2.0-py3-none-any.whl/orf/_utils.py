"""
Datasets functions for OrderedForest
"""
...
def make_ordered_regression(n_samples=1000,
    ...
    y_classes : integer
        The number of classes of the outcome variable.
        The default is 3.
    p_cont : integer
    ...
    p_binary : integer
        ...
        The default is 1.
    noise : boolean
        Whether to include a continuous noise variable that does not
        influence the outcome. The default is True.
    ...
    consisting of an ordered outcome variable with `y_classes` classes and
    an array of features of different types. The data-generating process
    ...
    # generate data consisting of 2000 observations and 4 outcome classes
