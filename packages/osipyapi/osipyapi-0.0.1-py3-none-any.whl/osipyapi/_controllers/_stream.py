...
class Stream:
    ...
    @stream_api.endpoint('/{web_id}/channel')
    @staticmethod
    def get_channel(
        web_id: str,
    ...
    @stream_api.endpoint('/{web_id}/end')
    @staticmethod
    def get_end(
        web_id: str,
    ...
    @stream_api.endpoint('/{web_id}/interpolated')
    @staticmethod
    ...
    @stream_api.endpoint('/{web_id}/summary')
    @staticmethod
    def get_summary(
        web_id: str,
        start_time: datetime = None,
    ...
    @stream_api.endpoint('/{web_id}/value')
    @staticmethod
    def get_value(
        web_id: str,
        time: datetime,
