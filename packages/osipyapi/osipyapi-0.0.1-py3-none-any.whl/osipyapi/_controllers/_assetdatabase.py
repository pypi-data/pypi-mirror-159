...
from ._base import assetdatabase_api as api
...
class AssetDatabase:
    ...
    @api.endpoint('/{web_id}/analysiscategories')
    @staticmethod
    ...
    @api.endpoint('/{web_id}/analysistemplates')
    @staticmethod
    ...
    @api.endpoint('/{web_id}/attributecategories')
    @staticmethod
    ...
    @api.endpoint('/{web_id}/elementcategories')
    @staticmethod
    ...
    @api.endpoint('/{web_id}/elementtemplates')
    @staticmethod
    ...
    @api.endpoint('/{web_id}/enumerationsets')
    @staticmethod
    ...
    @api.endpoint(
        '/{web_id}/eventframes',
        cast=dict(severity=MultiInstQueryParam)
    )
    ...
    @api.endpoint(
        '/{web_id}/security',
        cast=dict(
            security_item=MultiInstQueryParam,
    ...
    @api.endpoint('/{web_id}/tablecategories')
    @staticmethod
