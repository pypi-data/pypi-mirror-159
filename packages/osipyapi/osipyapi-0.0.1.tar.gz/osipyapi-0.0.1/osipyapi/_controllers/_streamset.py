...
from ._base import streamset_api as api
...
class StreamSet:
    ...
    @api.endpoint('/{web_id}/interpolated')
    @staticmethod
    ...
    @api.endpoint(
        ...
        cast=dict(time=MultiInstQueryParam)
    )
    @staticmethod
    ...
    @api.endpoint(
        '/joined',
        cast=dict(subordinate_web_id=MultiInstQueryParam)
    )
    @staticmethod
    def get_joined(
        base_web_id: str,
    ...
    @api.endpoint('/{web_id}/recordedattime')
    @staticmethod
