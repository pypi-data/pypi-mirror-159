"""Test rayvision_dayan_log core functions."""
import logging
...
def test_catch_setup_logger_failed(mocker):
    ...
    """
    mock_config = mocker.patch("rayvision_dayan_log.core.get_default_log_config")
    mock_config.return_value = {}
    init_logger("test_logger")
    assert "rayvision_dayan_log" in logging.root.manager.loggerDict
