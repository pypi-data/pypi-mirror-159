...
class CfnDetector(
    ...
    class CFNDataSourceConfigurationsProperty:
        def __init__(
            self,
            *,
            kubernetes: typing.Optional[typing.Union["CfnDetector.CFNKubernetesConfigurationProperty", _IResolvable_a771d0ef]] = None,
    ...
    class CFNKubernetesConfigurationProperty:
        def __init__(
            self,
            *,
            audit_logs: typing.Optional[typing.Union["CfnDetector.CFNKubernetesAuditLogsConfigurationProperty", _IResolvable_a771d0ef]] = None,
        ) -> None:
