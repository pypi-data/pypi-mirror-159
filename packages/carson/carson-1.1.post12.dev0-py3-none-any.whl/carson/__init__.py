...
__description__ = 'An asyncio package to interact with the Tesla JSON web service.'
__license__ = 'MIT'
...
#   2) Not functional
#   3) Probably wrong
# The only reason they are here at all is because you will see data returned
# from Tesla's web service indicating your car has them.
OPTION_CODES = {
    'MDLS': 'Model S',
    'MDLX': 'Model X',
    'MDL3': 'Model 3',
