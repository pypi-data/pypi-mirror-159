...
# main functions
def threedi_nodes_within_vector(vector:gpd.geodataframe.GeoDataFrame, grid:GridH5ResultAdmin):
    """ 
...
def edit_nodes_in_grid(folder_path:str,
    ...
    for node_id in node_ids:
        if method == "interpolated":
            ...
            print("Method incorrect, should be either 'interpolated' or '1d_replacement'")
...
def threedi_result_volume(folder:Folders, results_type:str, revision:str, calculation_step:str):
    """ 
...
if __name__ == "__main__":
    ...
    results_type = "results_1d2d" # can be "0d1d_results", "1d2d_results" or "batch_results"
    revision = "nieuw"
    calculation_step = 1   
