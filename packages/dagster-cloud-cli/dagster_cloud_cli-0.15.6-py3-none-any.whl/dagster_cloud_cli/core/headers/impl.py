    ...
    return merge_dicts(
        {
            ...
            DAGSTER_CLOUD_SCOPE_HEADER: DagsterCloudInstanceScope.ORGANIZATION.value
            if branch_deployments
            else DagsterCloudInstanceScope.DEPLOYMENT.value,
        },
