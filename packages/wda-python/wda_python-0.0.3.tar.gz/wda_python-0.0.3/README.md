...
项目依据[openatx/facebook-wda: Facebook WebDriverAgent Python Client Library (not official) (github.com)](https://github.com/openatx/facebook-wda)做了修改，增加了一些元素操作的方法
...
Implemented apis describe in [https://github.com/facebook/WebDriverAgent/wiki/Queries](https://github.com/facebook/WebDriverAgent/wiki/Queries)
...
Tested with: [https://github.com/appium/WebDriverAgent/tree/v2.16.1](https://github.com/appium/WebDriverAgent/tree/v2.16.1)
...
1. You need to start WebDriverAgent by yourself
   ...
   **New** There is a new tool, which can start WDA without xcodebuild, even you can run in Linux and Windows.
   See: [https://github.com/alibaba/tidevice](https://github.com/alibaba/tidevice)

   Or

   Follow the instructions in [https://github.com/appium/WebDriverAgent](https://github.com/appium/WebDriverAgent)
...
I found a tools named `iproxy` which can forward device port to localhost, it\'s source code is here [https://github.com/libimobiledevice/libusbmuxd](https://github.com/libimobiledevice/libusbmuxd)
...
To see more `Class Chain Queries` examples, view [https://github.com/facebookarchive/WebDriverAgent/wiki/Class-Chain-Queries-Construction-Rules](https://github.com/facebookarchive/WebDriverAgent/wiki/Class-Chain-Queries-Construction-Rules)
...
* [https://testerhome.com/topics/5524](https://testerhome.com/topics/5524) By [diaojunxiam](https://github.com/diaojunxian)
