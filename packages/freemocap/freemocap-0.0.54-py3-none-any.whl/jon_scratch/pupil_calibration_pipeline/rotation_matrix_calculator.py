...
class RotationMatrixCalculator:
    ...
    def calculate_head_rotation_matricies(self,
        ...
        head_rotation_data = self.define_basis_vectors(center_point_fr_xyz=head_center_xyz,
    ...
    def calculate_eye_rotation_matricies(self,
                                         eye: str,
                                         normalize_length_by_x: bool = False,
                                         debug: bool = False,
                                         ) -> List[np.ndarray]:
        ...
        eye_socket_rotation_data = self.define_basis_vectors(center_point_fr_xyz=eye_mid_fr_xyz,
    ...
    def define_basis_vectors(self,
                             ...
                             normalize_length_by_x: bool = True) -> RotationDataClass:
        """
    ...
    def show_head_rotation_debug_plot(self, rotation_data: RotationDataClass):
        ...
        for frame_number in range(1200, x_hat_xyz.shape[0]):
            ...
            ax.scatter(z_mediapipe_skeleton_fr_mar_xyz[frame_number, :, 0],
