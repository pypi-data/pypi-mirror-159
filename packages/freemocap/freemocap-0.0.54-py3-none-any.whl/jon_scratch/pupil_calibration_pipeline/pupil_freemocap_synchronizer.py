...
class PupilFreemocapSynchronizer:
    ...
    def synchronize(self, debug: bool = False, vor_frame_start: int = None, vor_frame_end: int = None):
        ...
        end_time_unix = np.min((freemocap_timestamps[-1], right_eye_timestamps[-1], left_eye_timestamps[-1]))
        ...
        synchronized_right_eye_data = PupilLabsDataClass(timestamps=self.synchronized_timestamps,
                                                         ...
                                                         eye_d=0)
        synchronized_left_eye_data = PupilLabsDataClass(timestamps=self.synchronized_timestamps,
        ...
        synchronized_session_data = FreemocapSessionDataClass(timestamps=self.synchronized_timestamps,
    ...
    def clip_eye_data(self):
        ...
        self.right_eye_pupil_center_normal_x_clipped = self.raw_session_data.right_eye_pupil_labs_data.pupil_center_normal_x[
                                                       self.right_eye_start_frame:self.right_eye_end_frame]

        self.right_eye_pupil_center_normal_y_clipped = self.raw_session_data.right_eye_pupil_labs_data.pupil_center_normal_y[
                                                       self.right_eye_start_frame:self.right_eye_end_frame]

        self.right_eye_pupil_center_normal_z_clipped = self.raw_session_data.right_eye_pupil_labs_data.pupil_center_normal_z[
                                                       self.right_eye_start_frame:self.right_eye_end_frame]
        ...
        self.left_eye_pupil_center_normal_x_clipped = self.raw_session_data.left_eye_pupil_labs_data.pupil_center_normal_x[
                                                      self.left_eye_start_frame:self.left_eye_end_frame]

        self.left_eye_pupil_center_normal_y_clipped = self.raw_session_data.left_eye_pupil_labs_data.pupil_center_normal_y[
                                                      self.left_eye_start_frame:self.left_eye_end_frame]
    ...
    def resample_eye_data(self):
        ...
        self.right_eye_pupil_center_normal_x = np.interp(freemocap_timestamps, right_eye_timestamps,
                                                         self.right_eye_pupil_center_normal_x_clipped)
        self.right_eye_pupil_center_normal_y = np.interp(freemocap_timestamps, right_eye_timestamps,
                                                         self.right_eye_pupil_center_normal_y_clipped)
        self.right_eye_pupil_center_normal_z = np.interp(freemocap_timestamps, right_eye_timestamps,
                                                         self.right_eye_pupil_center_normal_z_clipped)
        self.right_eye_theta = np.interp(freemocap_timestamps, right_eye_timestamps,
                                         self.right_eye_theta_clipped)
        self.right_eye_phi = np.interp(freemocap_timestamps, right_eye_timestamps,
                                       self.right_eye_phi_clipped)

        self.left_eye_pupil_center_normal_x = np.interp(freemocap_timestamps, left_eye_timestamps,
                                                        self.left_eye_pupil_center_normal_x_clipped)
        self.left_eye_pupil_center_normal_y = np.interp(freemocap_timestamps, left_eye_timestamps,
                                                        self.left_eye_pupil_center_normal_y_clipped)
        self.left_eye_pupil_center_normal_z = np.interp(freemocap_timestamps, left_eye_timestamps,
                                                        self.left_eye_pupil_center_normal_z_clipped)
        self.left_eye_theta = np.interp(freemocap_timestamps, left_eye_timestamps,
                                        self.left_eye_theta_clipped)
        self.left_eye_phi = np.interp(freemocap_timestamps, left_eye_timestamps,
                                      self.left_eye_phi_clipped)
    ...
    def show_debug_plots(self, vor_frame_start, vor_frame_end):
        ...
        ax1.plot(self.raw_session_data.right_eye_pupil_labs_data.timestamps,
        ...
        ax2.plot(self.raw_session_data.right_eye_pupil_labs_data.timestamps,
        ...
        ax4.plot(self.raw_session_data.left_eye_pupil_labs_data.timestamps,
        ...
        ax1 = fig.add_subplot(411)
        ax1.plot(self.synchronized_timestamps[vor_frame_start:vor_frame_end],
        ...
        ax2 = fig.add_subplot(412)
        ax2.plot(self.synchronized_timestamps[vor_frame_start:vor_frame_end],
        ...
        ax3 = fig.add_subplot(413)
        ax3.plot(self.synchronized_timestamps[vor_frame_start:vor_frame_end],
        ...
        ax4 = fig.add_subplot(414)
        ax4.plot(self.synchronized_timestamps[vor_frame_start:vor_frame_end],
