...
class CalibrationDiagnosticsVisualizer:
    def __init__(self):
        ...
        self.reprojection_error_all_line = self.reprojection_error_plot_widget.plot(self.reprojection_error_all,
                                                                                    pen=(255, 0, 128),
        ...
        self.image_point_original_dottos = self.image_point_remapping_plot_widget.plot(self.image_point_original,
        ...
        self.image_point_remapped_dottos = self.image_point_remapping_plot_widget.plot(self.image_point_remapped,
        ...
        self.origin_x_axis_gl_lineplot_item = gl.GLLinePlotItem(pos=x_axis_line_array,
                                                                color=(1, 0, 0, 1),
                                                                width=1.,
                                                                antialias=True)
        self.origin_y_axis_gl_lineplot_item = gl.GLLinePlotItem(pos=y_axis_line_array,
                                                                color=(0, 1, 0, 1),
                                                                width=1.,
                                                                antialias=True)
        self.origin_z_axis_gl_lineplot_item = gl.GLLinePlotItem(pos=z_axis_line_array,
                                                                color=(0, 0, 1, 1),
                                                                width=1.,
                                                                antialias=True)
    ...
    def update_image_point_remapping_subplot(self, image_point_original_x, image_point_original_y,
        ...
        self.image_point_original_dottos.setData(x=image_point_original_x,
