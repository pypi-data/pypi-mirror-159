...
def resnet18(pretrained=True, **kwargs):
    """Constructs a ResNet-18 hblab_ocr.
    Args:
        pretrained (bool): If True, returns a hblab_ocr pre-trained on ImageNet
    """
...
def resnet34(pretrained=True, **kwargs):
    """Constructs a ResNet-34 hblab_ocr.
    Args:
        pretrained (bool): If True, returns a hblab_ocr pre-trained on ImageNet
    """
...
def resnet50(pretrained=True, **kwargs):
    """Constructs a ResNet-50 hblab_ocr.
    Args:
        pretrained (bool): If True, returns a hblab_ocr pre-trained on ImageNet
    """
...
def deformable_resnet50(pretrained=True, **kwargs):
    """Constructs a ResNet-50 hblab_ocr with deformable conv.
    Args:
        pretrained (bool): If True, returns a hblab_ocr pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 6, 3], dcn=dict(deformable_groups=1), **kwargs)
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet50'], map_location='cuda'), strict=False)
    return model


def resnet101(pretrained=True, **kwargs):
    """Constructs a ResNet-101 hblab_ocr.
    Args:
        pretrained (bool): If True, returns a hblab_ocr pre-trained on ImageNet
    """
...
def resnet152(pretrained=True, **kwargs):
    """Constructs a ResNet-152 hblab_ocr.
    Args:
        pretrained (bool): If True, returns a hblab_ocr pre-trained on ImageNet
    """
