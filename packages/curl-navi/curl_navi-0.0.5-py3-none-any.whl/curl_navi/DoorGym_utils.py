...
__all__ = ['get_inference_args', 'get_training_args', 'eval_print', 'onpolicy_inference', 'mujoco_timestep',
           'onpolicy_main']
...
def get_inference_args():
    """Create arguments for evaluation or inference.
    ...
    Returns:
        The all parameters for evaluation or inference.

    """
    parser = argparse.ArgumentParser(description='DoorGym evaluation and inference')
    parser.add_argument(
...
def onpolicy_inference(
    ...
    """Inference on-policy method

    This function will execute inference or evaluation trained model.
    ...
    Args:
        ...
        evaluation : True is evaluation, False is inference.
