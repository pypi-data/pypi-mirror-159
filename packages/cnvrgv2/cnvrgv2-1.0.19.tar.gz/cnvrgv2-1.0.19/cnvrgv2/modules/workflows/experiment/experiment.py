...
from cnvrgv2.utils.log_utils import (LOGS_TYPE_ERROR, LOGS_TYPE_INFO, LOGS_TYPE_OUTPUT, LOGS_TYPE_WARNING,
                                     timestamp_for_logs)
...
class Experiment(WorkflowInstanceBase):
    ...
    def pull_artifacts(self, wait_until_success=False, poll_interval=10):
        ...
        if self.start_commit:
            downloader = ArtifactsDownloader(self, base_commit_sha1=self.start_commit["sha1"], commit_sha1=self.last_commit)
