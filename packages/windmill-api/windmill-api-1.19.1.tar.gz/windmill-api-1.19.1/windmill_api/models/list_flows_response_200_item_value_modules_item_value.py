...
from ..models.list_flows_response_200_item_value_modules_item_value_language import (
...
class ListFlowsResponse200ItemValueModulesItemValue:
    ...
    language: Union[Unset, ListFlowsResponse200ItemValueModulesItemValueLanguage] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_language, Unset):
            language = ListFlowsResponse200ItemValueModulesItemValueLanguage(_language)
