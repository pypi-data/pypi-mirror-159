...
class ListScriptsResponse200Item:
    ...
    trigger_reco_interval: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        trigger_reco_interval = self.trigger_reco_interval
        ...
        if trigger_reco_interval is not UNSET:
            field_dict["trigger_reco_interval"] = trigger_reco_interval
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        trigger_reco_interval = d.pop("trigger_reco_interval", UNSET)
        ...
        list_scripts_response_200_item = cls(
            ...
            trigger_reco_interval=trigger_reco_interval,
        )
