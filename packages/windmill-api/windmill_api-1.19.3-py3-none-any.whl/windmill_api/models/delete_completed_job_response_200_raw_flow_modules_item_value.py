...
from ..models.delete_completed_job_response_200_raw_flow_modules_item_value_language import (
...
class DeleteCompletedJobResponse200RawFlowModulesItemValue:
    ...
    language: Union[Unset, DeleteCompletedJobResponse200RawFlowModulesItemValueLanguage] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_language, Unset):
            language = DeleteCompletedJobResponse200RawFlowModulesItemValueLanguage(_language)
