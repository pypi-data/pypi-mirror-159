...
from src.minidb.mini_dashboards.minidashboard_base import minidashboard_base
from src.minidb.mini_dashboards.minidashboard_time import minidashboard_time
from src.minidb.mini_dashboards.minidashboard_target import minidashboard_target
...
def mdb(attr: str,
    ...
    df = df or find_table(attr, date, target)
