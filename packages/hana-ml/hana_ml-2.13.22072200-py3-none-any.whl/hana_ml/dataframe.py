...
class ConnectionContext(object):
    ...
    def restart_session(self, connection_id=None):
        """
        This function will ternimate the current session, drop all the temporary tables and start a new one.
...
class DataFrame(object):#pylint: disable=too-many-public-methods
    ...
    def stddev(self):
        """
        Get the stddev value of the columns. It simplies the use of agg function.
