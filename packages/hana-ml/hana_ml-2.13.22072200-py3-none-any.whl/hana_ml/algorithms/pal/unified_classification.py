    ...
    **kwargs : keyword arguments
    ...
    def build_report(self):
        ...
        try:
            ...
            if self.model_[5].filter("NAME='LIFT'").count() > 1000:
                if self.roc_sampling is None and self.other_samplings is None:
                    roc_sampling = Sampling('simple_random_without_replacement', sampling_size=1000)
                    other_samplings = dict(CUMGAINS=Sampling('simple_random_without_replacement', sampling_size=1000),
                                           RANDOM_CUMGAINS=Sampling('simple_random_without_replacement', sampling_size=1000),
                                           PERF_CUMGAINS=Sampling('simple_random_without_replacement', sampling_size=1000),
                                           LIFT=Sampling('simple_random_without_replacement', sampling_size=1000),
                                           RANDOM_LIFT=Sampling('simple_random_without_replacement', sampling_size=1000),
                                           PERF_LIFT=Sampling('simple_random_without_replacement', sampling_size=1000),
                                           CUMLIFT=Sampling('simple_random_without_replacement', sampling_size=1000),
                                           RANDOM_CUMLIFT=Sampling('simple_random_without_replacement', sampling_size=1000),
                                           PERF_CUMLIFT=Sampling('simple_random_without_replacement', sampling_size=1000))
