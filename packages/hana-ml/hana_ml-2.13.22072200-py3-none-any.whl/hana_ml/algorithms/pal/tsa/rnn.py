...
class GRUAttention(PALBase):#pylint: disable=too-many-instance-attributes, too-few-public-methods
    ...
    def predict(self, data, top_k_attributions=None, explain_mode=None):
        ...
        data : DataFrame
            ...
            - Other columsn: Columns for holding the time-series and external data values for all records, arranged in time-order. The columns' data type need to be consistent with that of time-series or external data.
