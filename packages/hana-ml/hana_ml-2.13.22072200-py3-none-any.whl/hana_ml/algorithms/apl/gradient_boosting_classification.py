...
class GradientBoostingClassifier(_GradientBoostingClassifierBase):
    ...
    def build_report(self):
        ...
        try:
            ...
            statistic_table = pd.concat([statistic_table, statistic_per_class_table, target_stats],
                                        ignore_index=True)
...
class GradientBoostingBinaryClassifier(_GradientBoostingClassifierBase):
    ...
    def build_report(self):
        ...
        try:
            ...
            metrics_table = pd.DataFrame(({"NAME": name, "X": i, "Y": row[name]}
            ...
            for curve_name, curve_new_name in cumlift_curves_names.items():
                ...
                metrics_table = pd.concat([metrics_table, curve], ignore_index=True)
