    ...
    **{'APL/ApplyExtraMode': 'First Forecast with Stable Components and Residues and Error Bars'}**.
    ...
    def get_model_components(self):
        ...
        Dictionary or pandas DataFrame
            ...
            If a segment column given, a pandas DataFrame which contains the model components for each segment.
    ...
    def get_performance_metrics(self):
        ...
        Dictionary or pandas DataFrame
            ...
            If a segment column given, a pandas DataFrame which contains the metric values for each segment.
    ...
    def get_horizon_wide_metric(self, metric_name='MAPE'):
        ...
        Float or pandas DataFrame
            ...
            If a segment column given, a pandas DataFrame which contains the average metric value on the forecast horizon for each segment.
        """
    ...
    def _create_forecast_out(self, data, horizon):
        ...
        if extra_mode == 'First Forecast with Stable Components and Residues and Error Bars' and \
            hasattr(self, 'other_train_apl_aliases') and self.other_train_apl_aliases and \
            'APL/DecomposeInfluencers' in self.other_train_apl_aliases and \
            self.other_train_apl_aliases['APL/DecomposeInfluencers'] == 'true':
