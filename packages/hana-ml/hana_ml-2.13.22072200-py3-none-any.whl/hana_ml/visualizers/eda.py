...
def plot_acf(data,
             ...
             ax=None):
    """
    It will plot ACF for two time series data.
...
def plot_moving_average(data, col, rolling_window, key=None, ax=None, compare=True):
    ...
    compare : bool, optional
        If compoare is True, it will plot the data and its moving average. Otherwise, only moving average will be plotted.
...
class EDAVisualizer(Visualizer):
    ...
    def box_plot(self,
        ...
        vert : bool, optional
            ...
            Defaults to False.
        legend : bool, optional
            Display legend if True. Only avaiable for matplotlib.
