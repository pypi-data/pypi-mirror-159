...
#### ping a single CIDR block/IP/hostname: 
```sh
...
hosts.txt file containing mix of CIDR/IP/hostname
```txt
192.168.13.0/24
kevinjin.com
1.1.1.1
...
```
2022-07-07-Not_reachable.txt
2022-07-07-Reachable_RTT.txt
2022-07-07-Reachable.txt
```