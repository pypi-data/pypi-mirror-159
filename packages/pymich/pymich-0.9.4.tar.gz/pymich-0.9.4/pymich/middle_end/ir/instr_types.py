...
class Record(Type):
    def __init__(self, name: str, attribute_names: Sequence[str], attribute_types: Sequence[Type], annotation: Optional[str] = None):
        super().__init__(annotation)
        self.name = name
...
class FunctionPrototype(Type):
    ...
    def __init__(self, arg_type: Type, return_type: Type, annotation: Optional[str] = None):
        super().__init__(annotation)
    ...
    def __eq__(self, o):
        return type(self) == type(o) and self.arg_type == o.arg_type and self.return_type == o.return_type
