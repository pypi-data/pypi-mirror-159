...
class Compiler:
    ...
    def _get_function_prototype(self, f: ast.FunctionDef, e: Env) -> t.FunctionPrototype:
    ...
    def compile_ccall(self, c: ast.Call, e: Env):
        ...
        for i, arg in enumerate(c.args):
            ...
            if type(actual_type) == type(expected_type) == t.Dict and actual_type.key_type == t.Unknown():
                ...
                raise E.FunctionParameterTypeException(expected_type, actual_type, c.args[0].lineno)
    ...
    def compile_fcall(self, f: ast.Call, e: Env):
        ...
        if isinstance(prototype, t.StdlibMethodInstance):
            ...
            if (
                isinstance(e.types[f.func.id].signature.arg_types[0], t.Bytes)
            ):
        ...
        if actual_type != expected_type:
            raise E.FunctionParameterTypeException(expected_type, actual_type, f.args[0].lineno)
