...
/* harmony import */ var _widgets_CodeViewer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./widgets/CodeViewer */ "./lib/widgets/CodeViewer.js");
...
class TransformPollingManager {
    ...
    async startPolling(file_path, current_file_path) {
        ...
        const pollingRef = setInterval(async () => {
            this._count += 1;
            try {
                const response = await (0,_handler__WEBPACK_IMPORTED_MODULE_3__.requestAPI)('CHECK_STATUS', {
                    body: JSON.stringify(dataToSend),
                    method: 'POST'
                });
                if ((response === null || response === void 0 ? void 0 : response.status) === 'finished') {
                    ...
                    const content = new _widgets_CodeViewer__WEBPACK_IMPORTED_MODULE_4__.CodeViewerWidget(close, response.file, this._app, {
    ...
    acceptFile() {
        ...
        const reply = (0,_handler__WEBPACK_IMPORTED_MODULE_3__.requestAPI)('FILE_ACTION', {
            body: JSON.stringify(dataToSend),
            method: 'POST'
        });
        reply
...
//# sourceMappingURL=lib_index_js.043737340670fd5b56ba.js.map