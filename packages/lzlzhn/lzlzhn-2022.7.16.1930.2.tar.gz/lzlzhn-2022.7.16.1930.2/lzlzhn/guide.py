...
def guide(guide_to_print):
    """
    import lzlzhn import guide
    guide.guide()
    """
    print('======================================================================')
    print('欢迎下载我的第三方模块2022.7.16.1930.2版')
    print('Welcome to download my third-party module-2022.7.16.1930.1')
    time.sleep(2)
    if guide_to_print == 'author':
        ...
        print('==========================================================================================')
        print('如果你用的语言是中文请用：')
        print('information_bombardment.information_bombardment("CN")')
        print('')
        print('If you speak English,please use:')
        print('information_bombardment.information_bombardment("EN")')
        print('==========================================================================================')
        time.sleep(3)
