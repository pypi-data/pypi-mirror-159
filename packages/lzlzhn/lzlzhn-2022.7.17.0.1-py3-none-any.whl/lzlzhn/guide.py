...
def guide(guide_to_print):
    ...
    guide.guide('你想要查询的模块名称')
    """
    print('======================================================================')
    print('欢迎下载我的第三方模块2022.7.16.0000.1版')
    print('Welcome to download my third-party module-2022.7.17.0000.1')
    time.sleep(2)
