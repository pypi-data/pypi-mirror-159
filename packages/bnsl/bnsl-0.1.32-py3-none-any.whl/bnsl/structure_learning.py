...
def hc(data, method='standard', score='default', debug=False, alpha=0.3):
    '''
    ...
    if method == 'lw':
                ...
                for vj in candidate[vi]:
                    ...
                    if not cyc_flag and dag not in cache_dag:
                        ...
                        if W not in cache_score[vj][par_cur]:
                            ...
                            cache_score[vj][par_cur][W] = local_score(cache_data[W], cols, score,
                                                                      cache_weight[W])
                        ...
                        if W not in cache_score[vj][par_sea]:
                            ...
                            cache_score[vj][par_sea][W] = local_score(cache_data[W], cols, score,
                                                                      cache_weight[W])
                ...
                for par_vi in parents:
                    ...
                    if not cyc_flag and dag not in cache_dag:
                        ...
                        if W not in cache_score[vi][par_cur_vi]:
                            ...
                            cache_score[vi][par_cur_vi][W] = local_score(cache_data[W], cols, score,
                                                                         cache_weight[W])
                        # compute the local score for the searching graph
                        ...
                        if W not in cache_score[vi][par_sea_vi]:
                            ...
                            cache_score[vi][par_sea_vi][W] = local_score(cache_data[W], cols, score,
                                                                         cache_weight[W])
                    ...
                    if dag not in cache_dag:
                        ...
                        if W not in cache_score[vi][par_cur]:
                            ...
                            cache_score[vi][par_cur][W] = local_score(cache_data[W], cols, score,
                                                                      cache_weight[W])
                        # compute the local score for the searching graph
                        ...
                        if W not in cache_score[vi][par_sea]:
                            ...
                            cache_score[vi][par_sea][W] = local_score(cache_data[W], cols, score,
                                                                      cache_weight[W])
        ...
        cache = {var: {tuple([]): local_score(data, [varnames.index(var)], score, alpha=alpha)} for var in
                 varnames}
