...
class TargetTaggerCollection:
    ...
    def combine_taggers(self, name, calibrated, tagger_subset=None):
        ...
        if tagger_subset is None:
            ...
            assert isinstance(incombination, list), "A list needs to be provided for argument tagger_subset"
            incombination = []
        ...
        if calibrated:
            indeed_calibrated = [t.is_calibrated() is not None for t in incombination]  # Do not forbid combination of calibrated and uncalibrated taggers
