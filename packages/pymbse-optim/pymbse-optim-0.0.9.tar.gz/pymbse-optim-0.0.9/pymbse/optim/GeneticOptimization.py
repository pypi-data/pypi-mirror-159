...
from pymbse.optim.design_variable.DesignVariableFactory import init_design_variables_with_csv
...
class GeneticOptimizationBuilder:
    ...
    def build(cls, config: OptimizationConfig, ip_with_port_cache: str = ''):
        ...
        design_variables = init_design_variables_with_csv(config.design_variables_rel_path)
