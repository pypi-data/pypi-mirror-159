...
class EventProducer(object):
    ...
    def call(self, queue_name, payload):
        ...
        try:
            ...
            # logger.info(f"Queue state is: {queue_state}")
            ...
            logger.info(f"Event Producer Exception is: {e}")
            self.logger_helper(
                self.corr_id,
                queue_name,
                self.service_name,
        ...
        self.logger_helper(
            self.corr_id, queue_name, self.service_name, self.logger, "start", "-"
        )
        ...
        self.logger_helper(
            self.corr_id, queue_name, self.service_name, self.logger, "end", "-"
        )
