...
class FilesystemServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Copy = channel.unary_unary(
                ...
                response_deserializer=filesystem__pb2.CopyResponse.FromString,
                )
...
def add_FilesystemServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Copy': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=filesystem__pb2.CopyResponse.SerializeToString,
            ),
    }
...
class FilesystemService(object):
    ...
    def Copy(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/batchx.filesystem.FilesystemService/Copy',
            filesystem__pb2.CopyRequest.SerializeToString,
            filesystem__pb2.CopyResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
