...
from .extensions import (
    ...
    InsolverCVHPExtension,
    InsolverPDPExtension,
)
...
class InsolverGLMWrapper(
    ...
    _tasks = ["class", "reg"]
    _back_save_dict = {"sklearn": ["pickle", "joblib"], "h2o": ["h2o"]}
    ...
    def __init__(
        ...
        **kwargs,
        ...
        family = family if family is not None else "gaussian"  # TODO
        link = link if link is not None else "family_default" if backend == "h2o" else "auto"  # TODO
        ...
        if backend == "h2o":
            ...
            self.model = H2OGeneralizedLinearEstimator(family=family, link=link, standardize=self.standardize, **kwargs)
            ...
            if task == "class":
                ...
                if isinstance(family, str):
                    ...
                    if family in family_power.keys():
                        ...
                        raise ValueError("Distribution is not supported with sklearn backend.")
            ...
            def __params_pipe(**glm_pars):
                ...
                return Pipeline(
                    [
                        (
                            "scaler",
                            StandardScaler(with_mean=self.standardize, with_std=self.standardize),
                        ),
    ...
    # @staticmethod
    # def _gen_glm_h2o(self):
    #
    #     return H2OGeneralizedLinearEstimator(family=family, link=link, standardize=self.standardize, **kwargs)
    #     self._h2o_init(h2o_init_params)
    #     self.model =
    #
    # def _gen_glm_sklearn(self):
    #
    #
    #     elif backend == 'sklearn':
    #         if isinstance(family, str):
