...
class COCOAnnotationBuilder(AnnotationBuilder):
    ...
    def __init__(
        ...
        self.coco_classes_id_dict: Dict[
            int, str
        ] = self.mapper.get_coco_classes_id_dict(categories=coco_categories)
    ...
    def __get_coco_annotations(
        ...
        for _coco_annotation in self.coco_annotations:
            ...
            coco_class_name = self.coco_classes_id_dict[
                int(_coco_annotation["category_id"])
            ]
            ...
            (
                ...
                occluded,
                content,
            ) = self.__get_attributes_from_coco_annotation(
                coco_annotation=_coco_annotation
            )
            ...
            if len(coco_polygon) > 0:
                ...
                polygon = self.__create_polygon_from_coco_polygon(
                    coco_polygon=coco_polygon
                )
