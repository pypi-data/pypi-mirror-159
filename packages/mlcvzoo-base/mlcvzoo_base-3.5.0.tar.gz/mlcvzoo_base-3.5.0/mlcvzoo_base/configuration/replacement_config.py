...
class ReplacementConfig(BaseConfigClass):
    ...
    PROJECT_ROOT_DIR: str = related.StringField(
        default=DEFAULT_MAP[PROJECT_ROOT_DIR_KEY]
    )

    # Root directory of all configuration files
    CONFIG_ROOT_DIR: str = related.StringField(
        default=DEFAULT_MAP[CONFIG_ROOT_DIR_DIR_KEY]
    )
    ...
    BASELINE_MODEL_DIR: str = related.StringField(
        default=DEFAULT_MAP[BASELINE_MODEL_DIR_KEY]
    )
    ...
    INFERENCE_MODEL_DIR: str = related.StringField(
        default=DEFAULT_MAP[INFERENCE_MODEL_DIR_KEY]
    )

    # Main directory for all shared training model/checkpoint files
    TRAINING_MODEL_DIR: str = related.StringField(
        default=DEFAULT_MAP[TRAINING_MODEL_DIR_KEY]
    )
