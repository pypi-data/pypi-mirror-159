...
class CSVAnnotationWriter(AnnotationWriter):
    ...
    def write(self, annotations: List[BaseAnnotation]) -> Optional[str]:
        ...
        # TODO: other encoding needed?

        # TODO: I would like to control the filename of the csv and
        #  avoid that it is different day by day.
        #  For now, at least return it s.th. it can be used programmatically..
