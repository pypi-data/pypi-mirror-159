...
class CVATAnnotationWriter(AnnotationWriter):
    ...
    def annotations_to_xml_tree(
        ...
        for image in images:
            ...
            # add bbox info
            CVATAnnotationWriter._add_box_subtree(
                image, current_annotation, clean_boxes
            )
            ...
            # add tag info
            CVATAnnotationWriter._add_classification_subtree(
                image, current_annotation, clean_tags
            )
    ...
    def _add_box_subtree(
        ...
        for bbox in annotation.bounding_boxes:
            ...
            difficult_tag = ET_xml.SubElement(
                box_tag, "attribute", attrib={"name": "difficult"}
            )
            if difficult:
            ...
            occluded_tag = ET_xml.SubElement(
                box_tag, "attribute", attrib={"name": "occluded"}
            )
            if occluded:
            ...
            content_tag = ET_xml.SubElement(
                box_tag, "attribute", attrib={"name": "content"}
            )
    ...
    def _add_segmentation_subtree(
        ...
        for segmentation in annotation.segmentations:
            ...
            polygon_tag = ET_xml.SubElement(
                sub_tree, "polygon", attrib=segmentation_dict
            )
            ...
            occluded_tag = ET_xml.SubElement(
                polygon_tag, "attribute", attrib={"name": "occluded"}
            )
            if occluded:
                occluded_tag.text = "true"
            else:
            ...
            content_tag = ET_xml.SubElement(
                polygon_tag, "attribute", attrib={"name": "content"}
            )
            content_tag.text = content
