...
class ODEvaluationInputDataConfig(BaseConfigClass):
    ...
    # TODO: is it needed? Or is it enough to use the annotation_handler_config
    # path to root directory, which fits to the content of the given csv file
    # csv_root_dir: str = related.StringField()
