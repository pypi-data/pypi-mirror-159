...
# TODO: write a comment why we need to have an BaseAnnotation object here
...
METRIC_DICT_TYPE = Dict[
    float, Dict[str, Dict[str, ODMetrics]]
...
METRIC_IMAGE_INFO_TYPE = Dict[
    str, Dict[str, MetricImageInfo]
]  # pylint: disable=invalid-name
...
class ODEvaluationComputingData:
    ...
    # Dict[BBoxSizeTypes.BBOX_SIZE_TYPE][CLASS_NAME] = counter
