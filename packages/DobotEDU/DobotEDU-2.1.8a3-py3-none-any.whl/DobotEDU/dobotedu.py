...
class DobotEDU(object):
    def __init__(self, account: str = None, password: str = None):
        ...
        self._py_rpc_client = RPCClient(ip="dev.dobotlab.dobot.cc", port=10005)
        ...
        self.__dobot_objects = [
            self.__magician_api, self.__lite_api, self.__magicbox_api,
            self.__magiciango_api, self.__betago
        ]
        ...
        self.__ai_objects = [
            self.__robot, self.__face, self.__ocr, self.__nlp, self.__speech,
            self.__tmt
        ]
