__author__ = "Vinaya Valsan, Caitlin Rose"
import os
import sys
...
filename = glob(input_dir + "/ll_samples_loudest_highweight_" + namestr + ".txt")[0]
...
skymap[skymap < 0] = 0
skymap = skymap / np.sum(skymap)
np.savetxt(input_dir + "/summary_plots/RapidPE_skymap_" + namestr + ".dat", skymap)
...
plt.savefig(f"{input_dir}/summary_plots/skymap_{namestr}.png")
