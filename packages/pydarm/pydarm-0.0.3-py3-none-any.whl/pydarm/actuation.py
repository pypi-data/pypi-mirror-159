...
class ActuationModel(Model):
    ...
    def actuation_stage_residual(self, frequencies, stage='TST'):
        ...
        Note: this includes the OMC to SUS delay!

        See e.g., T1900169-v5 eq 35
        ...
        A_mn_res = (omc_to_sus_delay_response *
    ...
    def digital_out_to_displacement(self, frequencies):
        ...
        # note that this method returns a transfer function that includes
        # the OMC to SUS delay, so we'll divide it out here
        ...
        omc_to_sus_delay_response = signal.dfreqresp(
            digital_delay_filter(1, 16384), 2.0*np.pi*frequencies/16384)[1]
        A_u_res /= omc_to_sus_delay_response
        A_p_res /= omc_to_sus_delay_response
        A_t_res /= omc_to_sus_delay_response
