...
class DIETClassifier(IntentClassifier, EntityExtractor):
    ...
    defaults = {
        ...
        RANKING_LENGTH: 0,  # 10,  # changed to zero to disable model confidence score normalization
    ...
    def _predict_label(
        ...
        if label_ids.size > 0:
            ...
            # # Ranking length was disabled by removing the limit.
            # # This allows to retrieve model confidence for all intents
