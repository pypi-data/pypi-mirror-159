...
class InstanceRoleApi(BackendApi):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._resource_url = f"instance-roles"

    def get_role(self, uuid) -> InstanceRoleItem:
        response = self._requests.get(f"{self.get_resource_url()}/{uuid}", headers=self.get_auth_header())
    ...
    def create_role(self, role_definition: CreateRoleDefinition) -> CreateRoleResponse:
        ...
        resp = self._requests.post(self.get_resource_url(), data=role_definition.json(),
                                   headers=headers)
