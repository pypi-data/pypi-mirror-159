...
class BodoClient:
    ...
    def __init__(self, auth_api: AuthApi, job_client: JobClient, cluster_client: ClusterClient, instance_role: InstanceRoleClient):
...
def get_bodo_client(auth: APIKeys = None, api_url="https://api.bodo.ai/api", auth_url='https://prod-auth.bodo.ai',
    ...
    instance_role_client = InstanceRoleClient(InstanceRoleApi(auth_api, api_url, RequestWrapper(print_logs)))
