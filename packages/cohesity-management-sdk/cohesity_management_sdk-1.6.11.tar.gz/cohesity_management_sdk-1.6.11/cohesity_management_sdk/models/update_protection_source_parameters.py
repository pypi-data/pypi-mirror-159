...
class UpdateProtectionSourceParameters(object):
    ...
    Attributes:
        ...
        connection_id (long|int): Specifies the Bifrost realm to be
            associated with the source root. Whenever needed, the workflows
            related to this source would then only use Bifrosts from the
            specified realm.
