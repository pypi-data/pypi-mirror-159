...
maxlen = 32
config_path = cfg.BASE_DIR + '/data/chinese_simbert_L-12_H-768_A-12/bert_config.json'
checkpoint_path = cfg.BASE_DIR + '/data/chinese_simbert_L-12_H-768_A-12/bert_model.ckpt'
dict_path = cfg.BASE_DIR + '/data/chinese_simbert_L-12_H-768_A-12/vocab.txt'
print(dict_path)
