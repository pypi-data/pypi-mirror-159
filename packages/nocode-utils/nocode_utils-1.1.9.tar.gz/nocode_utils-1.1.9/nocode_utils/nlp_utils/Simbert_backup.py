...
import numpy as np
from nocode_utils import config as cfg
...
maxlen = 32
config_path = cfg.BASE_DIR + '/data/chinese_simbert_L-4_H-312_A-12/bert_config.json'
checkpoint_path = cfg.BASE_DIR + '/data/chinese_simbert_L-4_H-312_A-12/bert_model.ckpt'
dict_path = cfg.BASE_DIR + '/data/chinese_simbert_L-4_H-312_A-12/vocab.txt'
