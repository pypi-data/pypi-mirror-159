...
class DarknetDetectionModel(
    ...
    def _write_darknet_config(
        ...
        df = DarknetDataFile(
            classes=self.annotation_handler.mapper.num_classes,
    ...
    def train(self) -> None:
        ...
        if (
            ...
            or (
                train_annotation_handler_config is not None
                and train_annotation_handler_config.write_output is None
            )
            or (
                train_annotation_handler_config.write_output is not None
                and train_annotation_handler_config.write_output.darknet_train_set
                is None
            )
        ):
            raise ValueError(
        ...
        annotations: List[
            BaseAnnotation
        ] = self.annotation_handler.parse_from_all_source()
