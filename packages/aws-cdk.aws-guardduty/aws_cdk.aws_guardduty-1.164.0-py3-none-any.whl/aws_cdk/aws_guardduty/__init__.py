...
class CfnDetector(
    ...
    class CFNDataSourceConfigurationsProperty:
        def __init__(
            self,
            *,
            kubernetes: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnDetector.CFNKubernetesConfigurationProperty"]] = None,
    ...
    class CFNKubernetesConfigurationProperty:
        def __init__(
            self,
            *,
            audit_logs: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnDetector.CFNKubernetesAuditLogsConfigurationProperty"]] = None,
        ) -> None:
