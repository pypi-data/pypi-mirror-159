...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, description=None, pulp_created=None, retain_repo_versions=None, pulp_href=None, manifest_signing_service=None, latest_version_href=None, pulp_labels=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
