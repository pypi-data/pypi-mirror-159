...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, versions_href=None, manifest_signing_service=None, latest_version_href=None, pulp_created=None, pulp_href=None, retain_repo_versions=None, name=None, pulp_labels=None, description=None, local_vars_configuration=None):  # noqa: E501
