...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, name=None, pulp_labels=None, description=None, pulp_created=None, versions_href=None, pulp_href=None, retain_repo_versions=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
