...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, manifest_signing_service=None, name=None, pulp_created=None, latest_version_href=None, pulp_href=None, pulp_labels=None, description=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
