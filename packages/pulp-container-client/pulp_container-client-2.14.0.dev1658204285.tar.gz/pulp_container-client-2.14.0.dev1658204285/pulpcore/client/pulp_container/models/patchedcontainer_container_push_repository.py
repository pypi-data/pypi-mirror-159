...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, description=None, pulp_labels=None, manifest_signing_service=None, name=None, retain_repo_versions=None, local_vars_configuration=None):  # noqa: E501
