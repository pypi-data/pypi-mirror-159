...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, pulp_href=None, manifest_signing_service=None, retain_repo_versions=None, description=None, name=None, latest_version_href=None, versions_href=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
