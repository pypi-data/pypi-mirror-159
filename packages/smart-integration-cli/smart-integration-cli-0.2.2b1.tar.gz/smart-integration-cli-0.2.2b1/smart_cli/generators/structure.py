...
class Structure(object):
    ...
    def _generate_services(
        self, file_path: str, name: str, params: Optional[dict] = None
    ):
    ...
    def _gen_file(self, templates_path: str, name: str, params: Optional[dict] = None):
        ...
        if '__init__' in name:
            ...
            return self._generate_services(file_path, name, params)
        else:
            new_file_name = (
                name.replace('base_', '')
                .replace('oauth_', '')
    ...
    def rewrite_basic_files(self, default: bool = True):
        ...
        templates_path = (
            ...
            if default
            else lib_path + '/smart_cli/templates/django_docker_files'
        )
        params = {
    ...
    def _generate_app(
        self,
        folder: str,
        finish_folder: Optional[str] = None,
        ...
        if not template_path:
            ...
            templates_path = lib_path + f'{template_path}{folder}/'
        params = {
            'app_name': folder if not finish_folder else finish_folder,
            'project_name': self.project_name,
        }
