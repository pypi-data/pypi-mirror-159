...
# 上传代码  python37 setup.py sdist upload
# 安装模块  pip install Lugwit_Module
'''
pip2.7 install Lugwit_Module==0.7
pip3.7 install Lugwit_Module==0.7
pip3.9 install Lugwit_Module==0.7
"C:\Program Files\Autodesk\Maya2018\bin\mayapy.exe" -m pip install Lugwit_Module==0.8
'''