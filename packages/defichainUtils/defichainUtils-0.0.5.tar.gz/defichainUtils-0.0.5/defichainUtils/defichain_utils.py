import utils.ParamType as pType
from utils import utils,CustomTxDecode
from utils.CustomTx import DfTx, CustomTxType
...
class TakeLoan(DfTx):
    def __init__(self,vaultId:str,address:str,amounts:list,rpcConnector):
        ...
        self.params = [CustomTxType.TakeLoan,pType.Vault(vaultId),pType.Address(address),pType.Amounts(resAmounts)]

class AddPoolLiquidity(DfTx):
    def __init__(self,amountPerAddress:list[tuple[str,str]],shareAddress:str,rpcConnector):
        ...
        self.params = [CustomTxType.AddPoolLiquidity,pType.AddressesWithAmount(resAddressAmount),pType.Address(shareAddress)]
