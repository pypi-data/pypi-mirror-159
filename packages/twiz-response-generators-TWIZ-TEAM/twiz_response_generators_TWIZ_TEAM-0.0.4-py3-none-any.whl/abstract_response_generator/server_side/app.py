...
class RemoteResponseGenerator(Resource):
    ...
    def _set_response_generator_controller(self, rg_state: Optional[ResponseGeneratorUpdateState] = None,
                                           rg_apl: Optional[ResponseGeneratorAPLBuilder] = None) -> None:
    ...
    def run_response_generator(self) -> Optional[dict]:
        """
