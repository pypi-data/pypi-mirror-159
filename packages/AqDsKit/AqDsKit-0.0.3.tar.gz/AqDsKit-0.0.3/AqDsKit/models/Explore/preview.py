...
from AqDsKit.accessors.db.dbapi import dbIO
...
class DbPreviewer(Previewer):
    def __init__(self, db_conf: baseDbInf, tb: str = None, sql: str = None):
        ...
        if sql:
            ...
            if tb:
                ...
                raise ValueError("At least table name (tb) and sql query (sql) should be specified")
