...
def _comet_logger_implementation(experiment, workflow_uid, timeout):
    ...
    while True:
        ...
        cleared_workflow_manifest = sanitize_environment_variables(
            json.loads(workflow_manifest)
        )
        pipeline_run_detail_dict["pipeline_runtime"]["workflow_manifest"] = json.dumps(
            cleared_workflow_manifest
        )
        ...
        pipeline_state = cleared_workflow_manifest["status"]
