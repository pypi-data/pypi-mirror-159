...
class Streamer(BaseStreamer):
    ...
    def _process_standard_output_message(self, message):
        # type: (StandardOutputMessage) -> None
        self._process_rest_api_send(
            sender=self.rest_api_client.log_experiment_output,
            rest_fail_prompt=STANDARD_OUTPUT_SENDING_ERROR,
            general_fail_prompt="Error sending standard output message",
            experiment_key=self.experiment_key,
...
class OfflineStreamer(BaseStreamer):
    ...
    def __init__(self, tmp_dir, initial_offset, use_http_messages=False):
