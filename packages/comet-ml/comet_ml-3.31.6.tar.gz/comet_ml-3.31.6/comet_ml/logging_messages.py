...
FILENAME_DETAILS_MSG_SENDING_ERROR = "Error sending file name message, got %d %r"
...
STANDARD_OUTPUT_SENDING_ERROR = "Failed to send standard output message, got %d %r"
