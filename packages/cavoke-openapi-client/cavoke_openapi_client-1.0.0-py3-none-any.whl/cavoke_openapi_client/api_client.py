...
from cavoke_openapi_client import rest
from cavoke_openapi_client.configuration import Configuration
from cavoke_openapi_client.exceptions import ApiTypeError, ApiValueError, ApiException
from cavoke_openapi_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.change_role  # this is an instance of the class Endpoint
        api_instance.change_role()  # this invokes api_instance.change_role.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.change_role.callable or self.callable in this class
