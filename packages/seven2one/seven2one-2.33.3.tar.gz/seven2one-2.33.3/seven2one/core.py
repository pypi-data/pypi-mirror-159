...
class TechStack():
    ...
    def __init__(
        ...
        try:
            ...
            logger.add(sys.stdout, format=logger_format, level=logLevel, catch=True, diagnose=logger_diagnose, backtrace=logger_backtrace)
            logger.add(sys.stderr, format='ERROR', level=logLevel, catch=True, diagnose=logger_diagnose, backtrace=logger_backtrace)
        except:
            pass
