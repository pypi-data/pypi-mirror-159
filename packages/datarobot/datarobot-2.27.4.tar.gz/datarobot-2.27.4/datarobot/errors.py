...
class ProjectDeprecationWarning(Warning):
    """
    Raised when a project has been deprecated, for example as part of the
    2022 Python 3 platform migration.
...
warnings.filterwarnings("always", category=ProjectDeprecationWarning)
