...
short_descr = "Data from canopy and soil thermal patterns in vineyards"
...
setup_kwds = dict(
    ...
    url='https://gitlab.com/b326/costa2019',
    license='cc_by_nc',
    zip_safe=False,
