...
class TimeSeries(TimeSeriesMetadata):
    """This class provides the interface of TimeSeries."""

    def __init__(
        self,
        client: TimeSeriesClient[TimeSeries, TimeSeriesMetadata],
        metadata: dict[str, Any] | TimeSeriesMetadata,
    ):
        if isinstance(metadata, TimeSeriesMetadata):
            metadata = metadata.dict()
        super().__init__(**metadata)
        self._client: TimeSeriesClient[TimeSeries, TimeSeriesMetadata] = client
        self._coverages: dict[EnsembleMember, tuple[datetime, datetime]] = {}
    ...
    def update_metadata(self) -> None:
        ...
        """
        self._client.run_sync(self._client.update_time_series, path=self.path, metadata=self.dict())
    ...
    def ensemble_members(
        ...
        **kwargs: Any,
    ) -> Iterable[EnsembleMember]:
        """
        Returns a list of EnsembleMembers.
        ...
        return (
            ensemble
            for ensemble in self._client.iter_over_async(
    ...
    def _localize_datetime(self, dt: datetime | None) -> datetime | None:
        if dt is None:
            return None
    ...
    def write_data_frame(
        ...
        **kwargs: Any,
        ...
        if data_frame.index.tz is None:
            data_frame.index = data_frame.index.tz_localize(self._tzinfo)
    ...
    def read_comments(
        ...
        **kwargs: Any,
        ...
        return (
            comment
            for comment in self._client.iter_over_async(
...
TimeSeriesMetadataT = TypeVar("TimeSeriesMetadataT", bound=TimeSeriesMetadata)
