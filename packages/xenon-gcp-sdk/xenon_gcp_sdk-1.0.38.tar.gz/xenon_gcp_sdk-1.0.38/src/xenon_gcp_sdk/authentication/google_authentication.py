...
BASE_SCOPES = ['https://www.googleapis.com/auth/directory.readonly',
               'https://www.googleapis.com/auth/admin.reports.audit.readonly']
calendar_scope = BASE_SCOPES.append('https://www.googleapis.com/auth/calendar.readonly')
wrong_calendar_scopes = BASE_SCOPES.append('https://www.googleapis.com/auth/calendar')


def get_credentials(user_identifier, delegated=False):
    scopes = wrong_calendar_scopes if user_identifier.organization_id == '5be9861a-2883-4db1-86a0-49da48838c14' else calendar_scope
