...
class SSDATransformerController(nn.Module, ControllableModel):
    '''
    ...
    def __init__(
        ...
        super(SSDATransformerController, self).__init__()
    ...
    def learn(self, iteratable_data):
        ...
        try:
            ...
            for batch_data_tuple in iteratable_data.generate_learned_samples():
                ...
                loss = downstream_task_loss + pretext_loss
                ...
                if est_flag is False:
                    ...
                    if (iter_n+1) % int(iteratable_data.iter_n / iteratable_data.epochs) == 0:
                        with torch.inference_mode():
                            ...
                            test_loss = test_downstream_task_loss + test_pretext_loss
