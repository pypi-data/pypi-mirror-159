...
if __name__ == '__main__':
    ...
    # authenticate
    cropin_api = CropinAPI("test", "demo_user", "password",env= EnvType.QA)
    ...
    satellite_response = cropin_api.get_satellite_details(boundary_ids='62a19eb3c7ce2f568ad192f9')
    ...
    # plot image download
    download_response = cropin_api.download_image(plot_id='62a19e92c7ce2f568ad192f4', image_name='NDVI',
