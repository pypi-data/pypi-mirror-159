...
if __name__ == '__main__':
    ...
    if args_dict["subcommand_name"] == "FastaByID":
        from toolbiox.src.xuyuxing.tools.seqtools import FastaByID_main
        FastaByID_main(args)

    # FastaByGroup
    elif args_dict["subcommand_name"] == "FastaByGroup":
        from toolbiox.src.xuyuxing.tools.seqtools import FastaByGroup_main
        FastaByGroup_main(args)

    # subfasta
    elif args_dict["subcommand_name"] == "SubFasta":
        from toolbiox.src.xuyuxing.tools.seqtools import subfasta_main
        subfasta_main(args)

    # PreExtractNr
    elif args_dict["subcommand_name"] == "PreExtractNr":
        from toolbiox.src.xuyuxing.tools.seqtools import PreExtractNr_main
        PreExtractNr_main(args)

    # ExtractNr
    elif args_dict["subcommand_name"] == "ExtractNr":
        from toolbiox.src.xuyuxing.tools.seqtools import ExtractNr_main
        ExtractNr_main(args)

    # SeqLength
    elif args_dict["subcommand_name"] == "SeqLength":
        from toolbiox.src.xuyuxing.tools.seqtools import SeqLength_main
        SeqLength_main(args)

    # SplitFasta
    elif args_dict["subcommand_name"] == "SplitFasta":
        from toolbiox.src.xuyuxing.tools.seqtools import SplitFasta_main
        SplitFasta_main(args)

    # AlnStat
    elif args_dict["subcommand_name"] == "AlnStat":
        from toolbiox.src.xuyuxing.tools.seqtools import AlnStat_main
        AlnStat_main(args)

    # FastqByID
    elif args_dict["subcommand_name"] == "FastqByID":
        from toolbiox.src.xuyuxing.tools.seqtools import FastqByID_main
        FastqByID_main(args)

    # PreFastqByID
    elif args_dict["subcommand_name"] == "PreFastqByID":
        from toolbiox.src.xuyuxing.tools.seqtools import PreFastqByID_main
        PreFastqByID_main(args)

    # FastaRename
    elif args_dict["subcommand_name"] == "FastaRename":
        from toolbiox.src.xuyuxing.tools.seqtools import FastaRename_main
        FastaRename_main(args)

    # FilterByLen
    elif args_dict["subcommand_name"] == "FilterByLen":
        from toolbiox.src.xuyuxing.tools.seqtools import FilterByLen_main
        FilterByLen_main(args)

    # FastaToSQL
    elif args_dict["subcommand_name"] == "FastaToSQL":
        from toolbiox.src.xuyuxing.tools.seqtools import FastaToSQL_main
        FastaToSQL_main(args)

    # FastaFormatClean
    elif args_dict["subcommand_name"] == "FastaFormatClean":
        from toolbiox.src.xuyuxing.tools.seqtools import FastaFormatClean_main
        FastaFormatClean_main(args)

    # ReComp
    elif args_dict["subcommand_name"] == "ReComp":
        from toolbiox.src.xuyuxing.tools.seqtools import ReComp_main
        ReComp_main(args)

    # FastqSize
    elif args_dict["subcommand_name"] == "FastqSize":
        from toolbiox.src.xuyuxing.tools.seqtools import FastqSize_main
        FastqSize_main(args)

    elif args_dict["subcommand_name"] == "FastaStats":
        from toolbiox.src.xuyuxing.tools.seqtools import FastaStats_main
        FastaStats_main(args)

    # ReGetContig
    elif args_dict["subcommand_name"] == "ReGetContig":
        from toolbiox.src.xuyuxing.tools.seqtools import ReGetContig_main
        ReGetContig_main(args)

    # GeneStructure
    elif args_dict["subcommand_name"] == "GeneStructure":
        from toolbiox.src.xuyuxing.tools.seqtools import GeneStructure_main
        GeneStructure_main(args)

    # SeqMerge
    elif args_dict["subcommand_name"] == "SeqMerge":
        from toolbiox.src.xuyuxing.tools.seqtools import SeqMerge_main
        SeqMerge_main(args)

    # GCproportion
    elif args_dict["subcommand_name"] == "GCproportion":
        from toolbiox.src.xuyuxing.tools.seqtools import GCproportion_main
        GCproportion_main(args)

    # SeqEntropy
    elif args_dict["subcommand_name"] == "SeqEntropy":
        from toolbiox.src.xuyuxing.tools.seqtools import SeqEntropy_main
