...
try:
    ...
    warnings.warn("not installed lightgbm,please pip install --upgrade lightgbm")
try:
    from mlxtend import __version__ as mlxtend_version
except ImportError:
    warnings.warn("not installed lightgbm,please pip install --upgrade mlxtend")
