...
class AccuracyReporter(Reporter):
    ...
    def preprocess_data(self):
        ...
        str_columns, float_columns, categ_columns, date_columns, int_columns = types
    ...
    def report(self):
        ...
        logger.info(
            f"Corresponding plot pickle files were saved to folder 'model_artifacts/tmp_store/{self.table_name}/draws/'."
        )
