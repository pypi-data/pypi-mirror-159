...
class TSP:
    ...
    def counts(self) -> "pd.DataFrame":
        ...
        (e.g. using :py:meth:`~teaspoon.TSP.monthly` :py:meth:`~teaspoon.TSP.daily`) these numbers
    ...
    def __nly(self, 
        ...
        # make TSP
        tsp = TSP(times=times, depths=self.depths, values=values)
        tsp.__counts = agg_counts
