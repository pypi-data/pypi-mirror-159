...
class HOBO(AbstractReader):
    ...
    properties : HOBOProperties, optional
        A :py:class:`~teaspoon.dataloggers.HOBO.HOBOProperties` object that provides information about how the csv export was configured.. If ``None``, the software will attempt to figure out the configuration properties using :py:meth:`~HOBOProperties.autodetect` , by default ``None``
