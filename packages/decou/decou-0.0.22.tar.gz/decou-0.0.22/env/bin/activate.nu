...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/lvjhn/Projects/General Stuff/Decou (Decorator Management)/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/lvjhn/Projects/General Stuff/Decou (Decorator Management)/env/bin/deactivate.nu'
