...
class Lp:
    ...
    def __init__(self, application_name, service=Launchpad, config=Config):
    ...
    def _get_instance(self):
        ...
        return self._service.login_with(
            ...
            credentials_file=join(self._config.HOME, '.launchpad.credentials'),
        )
    ...
    def __getattr__(self, attr):
        ...
        assert not attr.startswith('_'), "Can't getattr for %s" %(attr)
