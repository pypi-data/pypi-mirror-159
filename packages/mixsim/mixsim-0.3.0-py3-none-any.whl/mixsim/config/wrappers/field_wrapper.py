...
class FieldWrapper(Wrapper[pydantic.Field]):
    """
    ...
    def __init__(self, field: pydantic.Field, parent: Any = None, prefix: str = ""):
        super().__init__(wrapped=field, name=field.name)

        self.field: pydantic.Field = field
        ...
        self._help = field.field_info.description
    ...
    def custom_arg_options(self) -> Dict[str, Any]:
        ...
        *option_strings, **kwargs) method.
        """
        return {}  # TODO no metadata in BaseModel yet.
