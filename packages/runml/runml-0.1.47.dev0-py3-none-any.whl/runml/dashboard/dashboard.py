...
import runml
from runml.model.dashboard import DashboardInfo
from runml.pipeline.pipeline import Pipeline
from runml.pipeline.column_mapping import ColumnMapping
from runml.dashboard.tabs.base_tab import Tab
...
__BASE_PATH = runml.__path__[0]  # type: ignore
...
class Dashboard(Pipeline):
    ...
    def __render(self, template: Callable[[TemplateParams], str]):
        dashboard_id = "runml_dashboard_" + str(uuid.uuid4()).replace("-", "")
