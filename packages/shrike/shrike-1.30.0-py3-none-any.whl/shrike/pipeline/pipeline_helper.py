...
class AMLPipelineHelper:
    ...
    def _apply_synapse_runsettings(
        ...
        **custom_runtime_arguments,
        ...
        """Applies settings for a Synapse component. Will use same configs as for HDI components.
        ...
        if self.module_loader.is_local(module_name):
            raise ValueError(
                "Synapse detonation chamber is not supported yet. Please use signed components."
            )
        else:
            target = (
                target
