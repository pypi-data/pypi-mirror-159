    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cognito-identitypool-alpha==2.31.2.a0",
        "aws_prototyping_sdk.pdk_nag>=0.3.11, <0.4.0",
        "cdk-nag>=2.15.12, <3.0.0",
        "constructs>=10.1.45, <11.0.0",
        "jsii>=1.62.0, <2.0.0",
        "projen>=0.58.29, <0.59.0",
        "publication>=0.0.3"
    ],
    "classifiers": [
