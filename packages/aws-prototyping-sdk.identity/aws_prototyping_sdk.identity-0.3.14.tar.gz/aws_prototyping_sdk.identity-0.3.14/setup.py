    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cognito-identitypool-alpha==2.32.1.a0",
        "aws_prototyping_sdk.pdk_nag>=0.3.13, <0.4.0",
        "cdk-nag>=2.15.16, <3.0.0",
        "constructs>=10.1.49, <11.0.0",
        "jsii>=1.62.0, <2.0.0",
        "projen>=0.58.33, <0.59.0",
        "publication>=0.0.3"
    ],
    "classifiers": [
