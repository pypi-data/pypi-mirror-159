...
class IRdsSanitizedSnapshotter(typing_extensions.Protocol):
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="databaseAccount")
    def database_account(self) -> typing.Optional[builtins.str]:
        '''(experimental) Account of database cluster or instance to snapshot and sanitize.
...
class _IRdsSanitizedSnapshotterProxy:
    ...
    def database_account(self) -> typing.Optional[builtins.str]:
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "databaseAccount"))
