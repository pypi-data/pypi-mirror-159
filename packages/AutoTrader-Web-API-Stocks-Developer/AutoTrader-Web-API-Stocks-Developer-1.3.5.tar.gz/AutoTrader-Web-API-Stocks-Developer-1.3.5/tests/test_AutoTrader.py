...
class TestAutoTrader(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        TestAutoTrader.__API = AutoTrader.create_instance('103883ac-8356-49b6-9c91-f672b372f1c6', AutoTrader.SERVER_URL)
    ...
    def test_read_platform_positions(self):
        ...
        """        
        response = TestAutoTrader.__API.read_platform_positions('FYERS_PM')
    ...
    def test_read_platform_holdings(self):
        ...
        """        
        response = TestAutoTrader.__API.read_platform_holdings('FYERS_PM')
