...
from autotest_frame.core.image.exceptions import MatchResultError, NoModuleError, InputImageError
from autotest_frame.core.image.utils import generate_result
