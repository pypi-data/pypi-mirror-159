...
from autotest_frame.core.image.matching import MatchTemplate
from autotest_frame.core.image.utils import (generate_result, get_keypoint_from_matches, keypoint_distance, rectangle_transform)
from autotest_frame.core.image.exceptions import (NoEnoughPointsError, PerspectiveTransformError, HomographyError, MatchResultError,
                                           InputImageError)
