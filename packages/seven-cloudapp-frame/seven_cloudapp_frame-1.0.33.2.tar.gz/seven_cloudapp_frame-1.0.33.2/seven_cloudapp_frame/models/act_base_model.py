...
@LastEditTime: 2022-07-15 11:41:10
...
class ActBaseModel():
    ...
    def get_act_info_list(self,app_id,act_name,is_del,page_size,page_index,is_cache=True):
        ...
        if is_cache:
            page_list, total = ActInfoModel(context=self.context).get_cache_dict_page_list(field="*", page_index=page_index, page_size=page_size, where=condition, group_by="", order_by=order_by, params=params,dependency_key=DependencyKey.act_info_list(app_id))
        else:
