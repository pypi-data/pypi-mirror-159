...
class Disys_Calib:
    ...
    def __init__(self,path_to_data : str):
        ...
        self.f = open(self.main_path+R"\dati calibrazione\PyOutput.txt",'w')
        try :         
    ...
    def __init__(self,df_input : pd.DataFrame, mainpath, serialNum):
        ...
        self.main_path = []
        self.f = open(mainpath+R"\dati calibrazione\PyOutput.txt",'w')
        try :    
        ...
        print("Disys_Calib initialized : Amount of data {}.".format(n))
        print("Data features {}, labels features {}".format(X_feature_names.values,Y_feature_names.values))
        self.f.write("Disys_Calib initialized : Amount of data {}.\n".format(n))
        self.f.write("Data features {}, labels features {}\n".format(X_feature_names.values,Y_feature_names.values))
