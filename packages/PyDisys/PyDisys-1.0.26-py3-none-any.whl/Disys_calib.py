...
class Disys_Calib:
    ...
    def __init__(self,path_to_data : str):
        ...
        self.originalstdo = sys.stdout
        self.originalstde = sys.stderr
        ...
        try :         
            ...
            print("Error : files not found. Input path may be not correct.")
            return 
    ...
    def __init__(self,df_input : pd.DataFrame, mainpath, serialNum):
        ...
        try :    
            ...
            print("Error : data not found. Check the names!")
            return 
