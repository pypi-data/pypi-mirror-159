...
def image_position_overlays(background: Any, overlays: Sequence[Any], initialPositions: Optional[Sequence[Optional[Dict[str, Any]]]] = None, key=None, **kwargs: Any) -> Optional[ImagePositionOverlaysResult]:
