...
def send_customizable_mail(receiver_mail:str,
                              test_mail:str,
                              from_email:str,
                              from_name:str,
                              template:str,
                              global_vars:list=list(),
                              files_attachments:list=list()):
    ...
    try:
        for file in files_attachments:
            ...
            attachments.append({'content': file_str, 'name': file, 'type': 'application/pdf'})
    except:
