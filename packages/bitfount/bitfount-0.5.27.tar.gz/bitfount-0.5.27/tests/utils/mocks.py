...
class GRPCStubMock(MessageServiceStub):
    ...
    async def SetupTaskMailboxes(
        self, data: BitfountTasks, metadata: Sequence[Tuple[str, Any]], **kwargs: Any
    ) -> CommunicationDetails:
    ...
    async def AcknowledgeMessage(
        self, data: Acknowledgement, metadata: Sequence[Tuple[str, Any]], **kwargs: Any
    ) -> SuccessResponse:
    ...
    async def StartTraining(self, *args: Any, **kwargs: Any) -> NoReturn:
        """Deprecated."""
        raise NotImplementedError("Deprecated in favor of SetupTaskMailboxes")
