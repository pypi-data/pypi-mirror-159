...
from tests.integration.utils import get_patched_authentication_code_nb
...
def _perform_notebook_replacements(
    ...
    if nb_num in (3, 5, 8, 9, 10):
        ...
        if nb_num != 5:
            nb = _replace_in_notebook_source_code(
                ...
                "load_from_file('../tests/integration/resources/schemas/census_income_schema.yaml')\n"  # noqa: B950
        ...
        if nb_num == 5:
            ...
            nb = _replace_in_notebook_source_code(
                ...
                "schema = BitfountSchema.load_from_file('../tests/integration/resources/schemas/census_income_schema.yaml')\n"  # noqa: B950
    ...
    # - Change pod name to be unique
        ...
        if nb_num == 1:
            # We use the pod from tutorial 1 twice in tutorial 5,
    ...
    # - Change pod name to be the unique pod created
        ...
        nb = _replace_in_notebook_source_code(
            CENSUS_INCOME_YAML_POD_NAME, census_income_pod_name, nb
        )
...
class TestTutorials:
    ...
    def cleanup(self) -> Generator[None, None, None]:
        ...
        try:
            ...
            Path("tutorials/MyCustomModel.py").unlink(missing_ok=True)
    ...
    def second_census_income_pod(
        ...
        """Second census_income pod used for Tutorial 3."""
    ...
    def test_tutorial_4(
        ...
        """Test modeller can train on census income pod using yaml config."""
