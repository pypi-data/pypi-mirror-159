define("jupyter-divewidgets", ["@jupyter-widgets/base"], (__WEBPACK_EXTERNAL_MODULE__jupyter_widgets_base__) => { return /******/ (() => { // webpackBootstrap
...
// Distributed under the terms of the Modified BSD License.
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.JSXGraphView = exports.JSXGraphModel = void 0;
...
class JSXGraphModel extends base_1.DOMWidgetModel {
    defaults() {
        return Object.assign(Object.assign({}, super.defaults()), { _model_name: 'JSXGraphModel', _view_name: 'JSXGraphView', _model_module: version_1.MODULE_NAME, _model_module_version: version_1.MODULE_VERSION, _view_module: version_1.MODULE_NAME, _view_module_version: version_1.MODULE_VERSION });
    }
}
exports.JSXGraphModel = JSXGraphModel;
JSXGraphModel.serializers = Object.assign({}, base_1.DOMWidgetModel.serializers);
class JSXGraphView extends base_1.DOMWidgetView {
    render() {
        ...
        this.model.widget_manager.resolveUrl(this.model.get('mathjax_url')).then(url => {
            this.mathjaxURL = url;
            this._setOutput();
        });
...
exports.JSXGraphView = JSXGraphView;
