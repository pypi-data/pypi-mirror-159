...
class LinearLabelModel(_AbstractStoichiometricModel):
    ...
    @staticmethod
    def _unpack_stoichiometries(*, stoichiometries: Dict[str, int]) -> Tuple[Dict[str, int], Dict[str, int]]:
    ...
    def add_reaction(self, rate_name: str, stoichiometry: Dict[str, int], labelmap: List[int]) -> None:
        ...
        self.add_reaction_from_substrates_and_products(rate_name, substrates, products, labelmap)
    ...
    def add_reaction_from_substrates_and_products(
        ...
        subs = [j for i in substrates for j in self.isotopomers[i]]
        prods = [j for i in products for j in self.isotopomers[i]]
