...
def _get_kwargs(
    *,
    ...
    url = "{}/users/mfa".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, CheckUserMfaResponse200]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, CheckUserMfaResponse200]]:
    return Response(
