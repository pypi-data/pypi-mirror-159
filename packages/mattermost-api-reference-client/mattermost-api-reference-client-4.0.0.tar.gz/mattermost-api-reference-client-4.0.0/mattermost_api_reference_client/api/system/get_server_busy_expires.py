...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, ServerBusy]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, ServerBusy]]:
    return Response(
