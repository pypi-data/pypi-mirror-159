...
def _get_kwargs(
    *,
    ...
    url = "{}/license/renewal".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, LicenseRenewalLink]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, LicenseRenewalLink]]:
    return Response(
...
def sync_detailed(
    *,
    client: Client,
) -> Response[Union[Any, LicenseRenewalLink]]:
...
def sync(
    *,
    client: Client,
) -> Optional[Union[Any, LicenseRenewalLink]]:
    """Request the license renewal link
