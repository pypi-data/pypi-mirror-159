...
def _get_kwargs(
    *,
    ...
    url = "{}/config/environment".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, EnvironmentConfig]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, EnvironmentConfig]]:
    return Response(
