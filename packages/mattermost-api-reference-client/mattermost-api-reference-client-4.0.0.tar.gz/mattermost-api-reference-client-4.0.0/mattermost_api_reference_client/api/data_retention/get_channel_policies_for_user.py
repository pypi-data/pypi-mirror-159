...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/users/{user_id}/data_retention/channel_policies".format(client.base_url, user_id=user_id)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, RetentionPolicyForChannelList]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, RetentionPolicyForChannelList]]:
    return Response(
