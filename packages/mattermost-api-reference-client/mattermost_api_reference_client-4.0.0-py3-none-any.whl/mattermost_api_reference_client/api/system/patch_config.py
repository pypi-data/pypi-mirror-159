...
def _get_kwargs(
    *,
    ...
    url = "{}/config/patch".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, Config]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, Config]]:
    return Response(
