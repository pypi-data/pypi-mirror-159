...
def _get_kwargs(
    *,
    ...
    url = "{}/emoji/search".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, List[Emoji]]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, List[Emoji]]]:
    return Response(
