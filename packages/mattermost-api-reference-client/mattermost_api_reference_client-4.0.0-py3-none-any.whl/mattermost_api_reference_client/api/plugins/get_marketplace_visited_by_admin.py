...
def _get_kwargs(
    *,
    ...
    url = "{}/plugins/marketplace/first_admin_visit".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, System]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, System]]:
    return Response(
