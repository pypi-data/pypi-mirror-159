...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, List[OrderedSidebarCategories]]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, List[OrderedSidebarCategories]]]:
    return Response(
