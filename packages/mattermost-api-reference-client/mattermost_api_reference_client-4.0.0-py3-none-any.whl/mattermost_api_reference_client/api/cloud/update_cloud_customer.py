...
from ...models.update_cloud_customer_json_body import UpdateCloudCustomerJsonBody
...
def _get_kwargs(
    *,
    ...
    url = "{}/cloud/customer".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, CloudCustomer]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, CloudCustomer]]:
    return Response(
