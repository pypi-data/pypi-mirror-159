...
from hestia_earth.validation.validators.transformation import (
    ...
    validate_first_transformation_fields,
...
def test_validate_first_transformation_fields_invalid():
    with open(f"{fixtures_folder}/first-transformation-fields/invalid.json") as f:
        data = json.load(f)
    assert validate_first_transformation_fields(data.get('nodes')) == {
        'level': 'error',
...
def test_validate_first_transformation_input_invalid():
    with open(f"{fixtures_folder}/first-transformation-input/invalid.json") as f:
        cycle = json.load(f)
    assert validate_first_transformation_input(cycle, cycle.get('transformations')) == {
        'level': 'error',
