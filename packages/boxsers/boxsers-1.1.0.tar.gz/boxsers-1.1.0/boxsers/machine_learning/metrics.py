...
def eval_confmatrix(y_true, y_pred, normalize='true', class_names=None, title=None,
...
def eval_classifreport(y_true, y_pred, digits=4, print_report=True, class_names=None, save_path=None):
