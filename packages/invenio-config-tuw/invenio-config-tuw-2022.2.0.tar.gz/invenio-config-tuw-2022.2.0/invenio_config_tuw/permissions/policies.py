...
class TUWRecordPermissionPolicy(RDMRecordPermissionPolicy):
    ...
    can_manage             = [TrustedRecordOwners(), CommunityAction("curate"), SystemProcess()]                     # noqa
    can_curate             = can_manage                                                   + secret_links["edit"]     # noqa
    can_review             = can_curate + [SubmissionReviewer()]                                                     # noqa
    can_preview            = can_manage + [SubmissionReviewer()]                          + secret_links["preview"]  # noqa
    can_view               = can_manage + [SubmissionReviewer(), CommunityAction("view")] + secret_links["view"]     # noqa
    ...
    can_create             = [TrustedUsers(), SystemProcess()]                                                      # noqa
    ...
    can_publish            = [TrustedPublisherRecordOwners(), SystemProcess()]  # noqa
