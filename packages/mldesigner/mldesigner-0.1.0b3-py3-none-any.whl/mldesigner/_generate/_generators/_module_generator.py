...
SUPPORTED_COMPONENT_TYPES = ["command", "parallel"]
...
class ModuleGenerator:
    ...
    def __init__(
        ...
        self._ref_generator = ComponentReferenceGenerator(
            name_to_components=name_to_components, working_dir=working_dir
        )
    ...
    def generate(self, target_dir: Path):
        ...
        if target_module_folder.exists():
            if self._force_regenerate:
                shutil.rmtree(target_module_folder, ignore_errors=True)
