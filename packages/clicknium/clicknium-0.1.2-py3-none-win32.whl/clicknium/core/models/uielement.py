    ...
    def get_property(
        ...
        """
            ...
            Parameters:
                ...
                name[Required]: property name, different UI elements may support different properties. For general properties, please refer to [Property List](./doc/automation/property.md).  
