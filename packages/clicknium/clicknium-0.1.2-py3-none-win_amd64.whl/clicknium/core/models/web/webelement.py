    ...
    def set_property(
        ...
        """
            ...
            Parameters:
                ...
                name[Required]: property name, different ui elements may support different property list, for general property list, please refer to https://www.clicknium.com/documents/automation/property
