...
T = TypeVar("T", bound="AnalysisFile")
...
class AnalysisFile:
    ...
    def __repr__(self):
        ...
        return "AnalysisFile({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        upload_status = (
            get_upload_status() if "uploadStatus" in d else cast(Union[Unset, FileStatusUploadStatus], UNSET)
        )
        ...
        analysis_file.additional_properties = d
