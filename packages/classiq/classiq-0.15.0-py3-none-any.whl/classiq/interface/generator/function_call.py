...
from classiq.interface.generator.function_param_list import Mcx
...
class FunctionCall(BaseModel):
    ...
    power: pydantic.PositiveInt = pydantic.Field(
    ...
    def create_name(cls, name: str, values: Dict[str, Any]):
        if name is not None:
    ...
    def parse_function_params(
        cls, function_params: f_params.FunctionParams, values: Dict[str, Any]
    ):
    ...
    def _validate_input_names(
        ...
        (
            ...
            inputs.keys(), params, f_params.input_io(is_inverse), control_states
        )
        error_msg = []
    ...
    def validate_inputs(cls, inputs: IOType, values) -> Dict[IOName, WireName]:
        ...
        cls._validate_input_names(
            ...
            inputs=inputs,
            is_inverse=is_inverse,
            control_states=values.get("control_states"),
        )
        return inputs
    ...
    def _validate_power(
        cls, power: pydantic.PositiveInt, values: Dict[str, Any]
    ...
    def control(
        ...
        return FunctionCall(
            ...
            is_inverse=self.is_inverse,
            control_states=self.control_states + [control_state],
        )
