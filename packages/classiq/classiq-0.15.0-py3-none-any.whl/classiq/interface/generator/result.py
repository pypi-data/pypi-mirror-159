...
class TranspiledCircuitData(BaseModel):
    qasm: str
    depth: int
...
class GeneratedCircuit(BaseModel):
    ...
    input_qubit_mapping: IOQubitMapping = pydantic.Field(default_factory=dict)
    output_qubit_mapping: IOQubitMapping = pydantic.Field(default_factory=dict)
