...
from classiq.interface.generator.function_call import IOName as IOName
...
class FunctionHandler(abc.ABC, metaclass=abc.ABCMeta):
    ...
    def apply(self, function_name: Union[str, FunctionData, QuantumFunction], in_wires: Optional[Union[Dict[str, QregOrWire], QuantumRegister]] = ..., out_wires: Optional[Union[Dict[str, QregOrWire], QuantumRegister]] = ..., is_inverse: bool = ..., control_states: Optional[Union[ControlState, Iterable[ControlState]]] = ..., should_control: bool = ..., power: int = ..., call_name: Optional[str] = ...) -> Dict[str, Wire]: ...
