...
class ParamsMapper(object):
    ...
    _key_for_all_requests={
            ...
            "file_content_info":{"type":DICTIONARY_LIST_TYPE,"has_default":True,"default":[]}
            ...
            #++++++++++++++++++++++++++++++ Association Rules ++++++++++++++++++++++++++++++#
            "min_support":{"type":int,"has_default":True,"default":None},
            "min_conf":{"type":int,"has_default":False},
            "max_set_size":{"type":int,"has_default":True,"default":100},
            "left_columns": {"type": list,"has_default":True,"default":[]},
            "right_column": {"type": str,"has_default":True,"default":None},
            "right_values": {"type": list,"has_default":True,"default":"all"},
            "group_column": {"type": str,"has_default":True,"default":None},

            ########################*******  for EDA service  ********########################
            ########################*******                   ********########################
            "algorithm_type":{"type":str,"has_default":False}
            
            #++++++++++++++++++++++++++++++ Explore Features for train ++++++++++++++++++++++++++++++#
            "algorithm_type": {"type":str,"has_default":False},

            #++++++++++++++++++++++++++++++ Explore column visualization data ++++++++++++++++++++++++++++++#
            
            "label":{"type":any,"has_default":True,"default":None}
            
            #++++++++++++++++++++++++++++++ features exploration data ++++++++++++++++++++++++++++++#
            "statistic_type":{"type":str,"has_default":True,"default":"hist"}
            
            #++++++++++++++++++++++++++++++ outlier percentage ++++++++++++++++++++++++++++++#
            
            "outlier_percentage":{"type":float,"has_default":False}
            "number_of_neighboors":{"type":float,"has_default":False}
            
            #++++++++++++++++++++++++++++++     For merge      ++++++++++++++++++++++++++++++#
            "root_file": {"type": dict,"has_default":False},
            "merge_files": {"type": DICTIONARY_LIST_TYPE,"has_default":False},
            "link_columns": {"type": DICTIONARY_LIST_TYPE,"has_default":False},
            "display_columns": {"type": DICTIONARY_LIST_TYPE,"has_default":False},
            
            #++++++++++++++++++++++++++++++     For join      ++++++++++++++++++++++++++++++#
            "query_files":{"type":DICTIONARY_LIST_TYPE,"has_default":False}
            "select_columns":{"type"list,"has_default":False}
            ...
            #++++++++++++++++++++++++++++++ Custom Functions ++++++++++++++++++++++++++++++#
            "column": {"type": "String"},
            "template_guid": {"type": "DirectoryPath"},
            "return_type": {"type": "String"},
            "cutom_function_code": {"type": "String"},
            "custom_function_keys": {"type": "List"},
            "custom_functino_values": {"type": "List"}
...
class RequestParser():
    ...
    def ReadListFiles(self):
        ...
        if len(passedFilesData)==0:
            return {"message":"pass files","code":422}
